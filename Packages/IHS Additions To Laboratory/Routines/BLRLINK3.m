BLRLINK3 ; IHS/HQT/MJL - CONT. OF BLR - IHS LABORATORY VISIT CREATION ; 03-Oct-2016 10:53 ; MKK
 ;;5.2;IHS LABORATORY;**1010,1011,1014,1015,1018,1021,1022,1024,1025,1027,1028,1029,1030,1031,1033,1034,1037,1039**;NOV 01, 1997;Build 38
 ;
EP ; EP
...
RESETLOI ; EP - Reset LOINC
 ...
 S:+LOINC<1 LOINC=""     ; IHS/MSC/MKK - LR*5.3*1039
 ;
 Q:$L(LOINC)  ; If LOINC exists, skip reset -- IHS/MSC/MKK - LR*5.2*1033
 ;
 K APCDALVR("APCDTLNC")
 ;
 ; ----- BEGIN IHS/MSC/MKK - LR*5.2*1037 -- Check to see if it's in 9009022
 S LOINC=+$$GET1^DIQ(9009022,BLRLOGDA,"LOINC CODE","I")
 ; I $L(LOINC) D  Q
 I $L(LOINC),+LOINC D  Q     ; IHS/MSC/MKK - LR*5.2*1039
 . S BLRLOINC=LOINC
 ...
 S LOINC=$G(^LAB(60,TIEN,1,+SITESPEC,95.3))      ; IHS/MSC/MKK - LR*5.2*1037
 ;
 ...
 . S APCDALVR("APCDTLNC")="`"_LOINC
 . S BLRLOINC=LOINC
 . S:+$G(BLRLOGDA) $P(^BLRTXLOG(BLRLOGDA,13),"^",10)=LOINC
 ; ----- END IHS/MSC/MKK - LR*5.2*1039
 ;
 Q
 ;
