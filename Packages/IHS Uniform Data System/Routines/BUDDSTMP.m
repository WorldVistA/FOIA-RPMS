BUDDSTMP ; IHS/CMI/LAB - CREATE SEARCH TEMPLATE FOR PGEN (PATIENT) REPORTS ;
...
SETRECS ;EP - Set Entries into Template
 ;
 S BUDDFN=0 F  S BUDDFN=$O(^XTMP("BUDVL",BUDJOB,BUDDTH,"PATIENTS",BUDDFN)) Q:BUDDFN'=+BUDDFN  D
 .I '$D(^XTMP("BUDVL",BUDJOB,BUDDTH)) W !!,"NO DATA TO REPORT.",! D PAUSE^BUDDUPVL W:$D(IOF) @IOF
