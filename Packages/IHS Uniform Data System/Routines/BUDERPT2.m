BUDERPT2 ;IHS/CMI/LAB - UDS REPORT;
...
EN1 ;
 ...
 I '$G(BUDXXXXX) D
 .S DIR(0)="S^1:Indian/Alaskan Native (Classification 01);2:Not Indian Alaskan/Native (Not Classification 01);3:All (both Indian/Alaskan Natives and Non 01)"_$S($$HL^BUDERPT1():";4:Homeless Patients",1:"")
 ...
 I $D(DIRUT) D EOJ Q
 I Y D EOJ Q
 ;S XBRP="PRINT^BUDERPTP",XBRC="PROC^BUDERPTC",XBRX="EOJ^BUDERPT2",XBNS="BUD"
 ;D ^XBDBQUE
 ;D EOJ
 D PT^BUDERPTE
 I BUDROT="" G EN1
...
DRIVER ;
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BUDERPT2",XBRX="EOJ^BUDERPT2",XBNS="BUD"
 D ^XBDBQUE
 Q
NODEV1 ;
 D PROC^BUDERPTC
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BUDERPT2",ZTDTH="",ZTDESC="UDS 17 REPORT" D ^%ZTLOAD D EOJ Q
 Q
