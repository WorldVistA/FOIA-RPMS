...
T52 ;EP
 S BUDP=0,BUDX2L=35
 I BUDROT="P",'$D(^XTMP("BUDERPT1",BUDJ,BUDH,"T5",BUDX2L)) D T52H W !!,"No Uncategorized Provider visits to report." Q
 I BUDROT="D",'$D(^XTMP("BUDERPT1",BUDJ,BUDH,"T5",BUDX2L)) D T52H D S(""),S("No Uncategorized Provider visits to report.") Q
 D T52H
 S BUDX2L=35,BUDX2L2=0,BUDY=$O(^BUDETFIV("B",BUDX2L,0)),BUDY=$P(^BUDETFIV(BUDY,0),U,2)
...
T5W ;
 ...
 I BUDROT="P" W ?51,$P(^DPT(DFN,0),U,2),?55,$$AGE^AUPNPAT(DFN,BUDCCAD),?60,$E($P($$RACE^BUDERPTC(DFN),U,4),1,15)," (",$P($$RACE^BUDERPTC(DFN),U,3),")"
 ...
 ...S X=X_U_$E($P($$RACE^BUDERPTC(DFN),U,4),1,15)_" ("_$P($$RACE^BUDERPTC(DFN),U,3)_")"
...
T51 ;EP
 S BUDNEWR=1
 I BUDROT="D" D T51DH
 S BUDX2L="" F  S BUDX2L=$O(^XTMP("BUDERPT1",BUDJ,BUDH,"T51",BUDX2L)) Q:BUDX2L=""!(BUDQUIT)  D
 .S BUDX2L2="" F  S BUDX2L2=$O(^XTMP("BUDERPT1",BUDJ,BUDH,"T51",BUDX2L,BUDX2L2)) Q:BUDX2L2=""!(BUDQUIT)  D
 ...
 ..S BUDPROV="" F  S BUDPROV=$O(^XTMP("BUDERPT1",BUDJ,BUDH,"T51",BUDX2L,BUDX2L2,BUDPROV)) Q:BUDPROV=""!(BUDQUIT)  D
 ...I BUDROT="P",$Y>(IOSL-3) D T51H Q:BUDQUIT  W !!,"Line ",BUDX2LL,"   ",BUDY
 ...I BUDROT="P" W !,BUDPROV,?35,^XTMP("BUDERPT1",BUDJ,BUDH,"T51",BUDX2L,BUDX2L2,BUDPROV)
 ...I BUDROT="D" S X=BUDPROV_U_^XTMP("BUDERPT1",BUDJ,BUDH,"T51",BUDX2L,BUDX2L2,BUDPROV) D S(X)
 .Q
 I BUDROT="P" W !
 Q
T51H ;
...
T3A ;EP
 S BUDP=0
 D T3H Q:BUDQUIT
 S BUDAGE="" F  S BUDAGE=$O(^XTMP("BUDERPT1",BUDJ,BUDH,"3A",BUDAGE)) Q:BUDAGE'=+BUDAGE!(BUDQUIT)  D
 .S BUDSEX="" F  S BUDSEX=$O(^XTMP("BUDERPT1",BUDJ,BUDH,"3A",BUDAGE,BUDSEX)) Q:BUDSEX=""!(BUDQUIT)  D
 ..S BUDCCOM="" F  S BUDCCOM=$O(^XTMP("BUDERPT1",BUDJ,BUDH,"3A",BUDAGE,BUDSEX,BUDCCOM)) Q:BUDCCOM=""!(BUDQUIT)  D
 ...S DFN="" F  S DFN=$O(^XTMP("BUDERPT1",BUDJ,BUDH,"3A",BUDAGE,BUDSEX,BUDCCOM,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ...
 ....S BUDV=0 F  S BUDV=$O(^XTMP("BUDERPT1",BUDJ,BUDH,"3A",BUDAGE,BUDSEX,BUDCCOM,DFN,BUDV)) Q:BUDV'=+BUDV!(BUDQUIT)  D
 .....I BUDROT="P",$Y>(IOSL-3) D T3H Q:BUDQUIT
