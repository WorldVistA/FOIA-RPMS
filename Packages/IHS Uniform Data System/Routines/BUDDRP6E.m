BUDDRP6E ; IHS/CMI/LAB - UDS REPORT TABLE 6B ;
 ;;11.0;IHS/RPMS UNIFORM DATA SYSTEM;;JAN 18, 2017;Build 66
 ;
REST6B ;EP
 I $Y>(IOSL-13) D HEADER^BUDDRPTP Q:BUDQUIT  D T6BH
 ...
 ;F
 I $Y>(IOSL-13) D HEADER^BUDDRPTP Q:BUDQUIT  D T6BH
 W $$CTR("SECTION F - PREVENTATIVE CARE AND SCREENING: BODY MASS INDEX (BMI)"),!,$$CTR("SCREENING AND FOLLOW-UP",80),!
 D LINE
 ...
 W ?5,"Percentage of ",?23,"|",?45,"|",?65,"|",!
 W ?5,"patients aged 18",?23,"|",?45,"|",?65,"|",!
 W ?5,"and older with  ",?23,"|",?30,$$C($G(BUDSECTF("PTS"))),?45,"|",?50,$$C($G(BUDSECTF("PTS"))),?65,"|",?70,$$C($G(BUDSECTF("PLAN"))),!
 W ?5,"(1) BMI documented",?23,"|",?45,"|",?65,"|",!
 W ?5,"and (2) follow-up",?23,"|",?45,"|",?65,"|",!
 W ?5,"plan documented if",?23,"|",?45,"|",?65,"|",!
 W ?5,"BMI is outside ",?23,"|",?45,"|",?65,"|",!
 W ?5,"normal parameters",?23,"|",?45,"|",?65,"|",!
 D LINE
G1 ;G
 I $Y>(IOSL-13) D HEADER^BUDDRPTP Q:BUDQUIT  D T6BH
 ...
 W ?5,"and if identified",?23,"|",?45,"|",?65,"|",!
 W ?5,"to be a tobacco ",?23,"|",?30,$$C($G(BUDSECG1("PTS"))),?45,"|",?50,$$C($G(BUDSECG1("PTS"))),?65,"|",?70,$$C($G(BUDSECG1("ABM"))),!
 W ?5,"user (2) received",?23,"|",?45,"|",?65,"|",!
 W ?5,"cessation",?23,"|",?45,"|",?65,"|",!
 W ?5,"counseling",?23,"|",?45,"|",?65,"|",!
 W ?5,"intervention",?23,"|",?45,"|",?65,"|",!
 D LINE
H ;SECTION H
 I $Y>(IOSL-17) D HEADER^BUDDRPTP Q:BUDQUIT  D T6BH
 ...
 W ?5,"prescribed ",?23,"|",?45,"|",?65,"|",!
 W ?5,"medication during",?23,"|",?45,"|",?65,"|",!
 W ?5,"the measurement ",?23,"|",?45,"|",?65,"|",!
 W ?5,"period",?23,"|",?45,"|",?65,"|",!
 D LINE
I ;SECTION I
 I $Y>(IOSL-17) D HEADER^BUDDRPTP Q:BUDQUIT  D T6BH
 ...
 W ?5,"Percentage of",?23,"|",?45,"|",?65,"|",!
 W ?5,"patients aged 18",?23,"|",?45,"|",?65,"|",!
 W ?5,"and older with a",?23,"|",?30,$$C($G(BUDSECTI("PTS"))),?45,"|",?50,$$C($G(BUDSECTI("PTS"))),?65,"|",?70,$$C($G(BUDSECTI("CAD"))),!
 W ?5,"diagnosis of CAD",?23,"|",?45,"|",?65,"|",!
 W ?5,"who were ",?23,"|",?45,"|",?65,"|",!
 W ?5,"prescribed a",?23,"|",?45,"|",?65,"|",!
 W ?5,"lipid lowering",?23,"|",?45,"|",?65,"|",!
 W ?5,"therapy",?23,"|",?45,"|",?65,"|",!
 D LINE
J ;J
 I $Y>(IOSL-20) D HEADER^BUDDRPTP Q:BUDQUIT  D T6BH
 W $$CTR("SECTION J - ISCHEMIC VASCULAR DISEASE (IVD): ASPIRIN OR ANOTHER ANTITHROMBOTIC"),!
 D LINE
 ...
 W "ANTITHROMBOTIC",?23,"|",?25,"PCI PROCEDURE",?45,"|",?47,"",?65,"|",?67,"ASPIRIN OR",!
 W "",?23,"|",?25,"",?45,"|",?47,"",?65,"|",?67,"OTHER",!
 W "",?23,"|",?25,"",?45,"|",?47,"",?65,"|",?67,"ANTI-",!
 W "",?23,"|",?25,"",?45,"|",?47,"",?65,"|",?67,"THROMBOTIC",!
 ...
 W ?5,"Percentage of",?23,"|",?45,"|",?65,"|",!
 W ?5,"patients aged 18",?23,"|",?45,"|",?65,"|",!
 W ?5,"and older with a",?23,"|",?30,$$C($G(BUDSECTJ("PTS"))),?45,"|",?50,$$C($G(BUDSECTJ("PTS"))),?65,"|",?70,$$C($G(BUDSECTJ("IVD"))),!
 W ?5,"diagnosis of IVD",?23,"|",?45,"|",?65,"|",!
 W ?5,"or AMI, CABG, or ",?23,"|",?45,"|",?65,"|",!
 W ?5,"PCI procedure ",?23,"|",?45,"|",?65,"|",!
...
K ;I
 ...
 D LINE
L ;
 I $Y>(IOSL-23) D HEADER^BUDDRPTP Q:BUDQUIT  D T6BH
...
M ;
 I $Y>(IOSL-23) D HEADER^BUDDRPTP Q:BUDQUIT  D T6BH
 W $$CTR("SECTION M - PREVENTATIVE CARE: SCREENING FOR CLINICAL DEPRESSION "),!,$$CTR("AND FOLLOW-UP PLAN"),!
 D LINE
 W "PREVENTATIVE",?23,"|",?26,"",?45,"|",?65,"|",?67,"NUMBER OF",!
 W "CARE: SCREENING",?23,"|",?26,"",?45,"|",?65,"|",?67,"PATIENTS",!
 W "FOR CLINICAL",?23,"|",?26,"",?45,"|",?47,"CHARTS",?65,"|",?67,"SCREENED FOR",!
 ...
 W ?5,"Percentage of",?23,"|",?45,"|",?65,"|",!
 W ?5,"patients aged 12",?23,"|",?45,"|",?65,"|",!
 W ?5,"and older who ",?23,"|",?45,"|",?65,"|",!
 W ?5,"were (1) screened",?23,"|",?45,"|",?65,"|",!
 W ?5,"for depression",?23,"|",?45,"|",?65,"|",!
 W ?5,"with a standard-",?23,"|",?45,"|",?65,"|",!
 W ?5,"ized tool and, if",?23,"|"
 W ?30,$$C($G(BUDSECTM("PTS"))),?45,"|",?50,$$C($G(BUDSECTM("PTS"))),?65,"|",?70,$$C($G(BUDSECTM("DEP"))),!
 W ?5,"screening was",?23,"|",?45,"|",?65,"|",!
 W ?5,"positive, (2) had",?23,"|",?45,"|",?65,"|",!
 W ?5,"a follow-up plan",?23,"|",?45,"|",?65,"|",!
 W ?5,"documented",?23,"|",?45,"|",?65,"|",!
 D LINE
N ;
 I $Y>(IOSL-23) D HEADER^BUDDRPTP Q:BUDQUIT  D T6BH
 ...
 W ?5,"Percentage of",?23,"|",?45,"|",?65,"|",!
 W ?5,"children aged 6",?23,"|",?45,"|",?65,"|",!
 W ?5,"through 9 years,",?23,"|",?45,"|",?65,"|",!
