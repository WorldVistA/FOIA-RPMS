...
EN ;EP
EN1 ;
 I $G(BUDT6B) W !,"Table 6B:" D PRENATT^BUDHRP6B
 I $G(BUDT7) W !,"Table 7:" D PRENATT^BUDHRP7
 S BUDSITE=""
 I '$G(BUDTSCTC) S BUDTSCTC=1
...
Y D YEAR
 ...
 I '$G(BUDXXXXX) D
 .S DIR(0)="S^1:Indian/Alaskan Native (Classification 01);2:Not Indian Alaskan/Native (Not Classification 01);3:All (both Indian/Alaskan Natives and Non 01)"_$S($$HL():";4:Homeless Patients",1:"")
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BUDHRPT1",ZTDTH="",ZTDESC="UDS 18 REPORT" D ^%ZTLOAD D EOJ Q
 Q
M ;EP - called from option
 ...
 W !!?5,"1   Patient Zip Code"
 W !?5,"2   Table 3A: Patients by Age and Sex Assigned at Birth"
 W !?5,"3   Table 3B: Demographic Characteristics"
 ...
 W !?5,"8   Table 6B: Quality of Care Measures"
 ...
 .I Z=12 S (BUDT3A,BUDT3B,BUDT4,BUDT5,BUDT6,BUDTZ,BUDT5L1,BUDT6B,BUDT7,BUDT9,BUDT9D)=1,BUDTSCTC=10
 .I Z=2 S BUDT3A=1,BUDTSCTC=BUDTSCTC+1
 .I Z=3 S BUDT3B=1,BUDTSCTC=BUDTSCTC+1
 .I Z=4 S BUDT4=1,BUDTSCTC=BUDTSCTC+1
 .I Z=5 S BUDT5=1,BUDT5L1=1,BUDTSCTC=BUDTSCTC+2
 .I Z=6 S BUDT5=1,BUDTSCTC=BUDTSCTC+1 I Y[5 S BUDTSCTC=BUDTSCTC-1
 .I Z=7 S BUDT6=1,BUDTSCTC=BUDTSCTC+1
 .I Z=1 S BUDTZ=1,BUDTSCTC=BUDTSCTC+1
 .I Z=8 S BUDT6B=1,BUDTSCTC=BUDTSCTC+1
 .I Z=9 S BUDT7=1,BUDTSCTC=BUDTSCTC+1
 .I Z=10 S BUDT9=1,BUDTSCTC=BUDTSCTC+1
 .I Z=11 S BUDT9D=1
 G EN1
 ;
PNC ;
...
T4 ;EP - entry point for Table 3A only
 D EOJ
 S BUDT4=1,BUDTSCTC=1
 D GENI
 D T4I
 G EN1
TZ ;EP - entry point for Table zip only
 D EOJ
 S BUDTZ=1,BUDTSCTC=1
 D GENI
 D TZAI
 G EN1
TZAI ;intro for table Z
 W !!,"Patients by Zip Code"
 W !,"The Patient Zip Code table reports the number of patients by their"
 W !,"most recent (last) zip code as entered in patient registration and "
 W !,"their primary health insurance source as of the last visit during"
 W !,"the report period."
 Q
T3AI ;intro for table 3A
 W !!,"TABLE 3A:  PATIENTS BY AGE AND BY SEX ASSIGNED AT BIRTH"
 W !,"This report will produce UDS Table 3A, an itemization of patients by age"
 W !,"and sex assigned at birth.  Patients must have at least one visit during "
 W !,"the selected reporting period.  Age is calculated as of June 30th of the"
 W !,"year you select.",!
 Q
T4I ;intro for table 4
 ...
 W !,"Age is calculated as of June 30th of the year you select."
 W !
 Q
T3B ;EP
 D EOJ
 S BUDT3B=1,BUDTSCTC=1
 D GENI
 D T3BI
 G EN1
T3BI ;
 W !!,"TABLE 3B:  DEMOGRAPHIC CHARACTERISTICS"
 W !,"This report will produce UDS Table 3B, an itemization of users"
 W !,"by Demographic Characteristics."
 W !,"Patients must have at least one visit during the selected reporting"
 W !,"period.",!
 Q
T5 ;EP
 D EOJ
 S BUDT5=1,BUDTSCTC=1
 D GENI
 D T5I
 G EN1
T5I ;
...
T51 ;EP
 D EOJ
 S BUDT5=1,BUDT5L1=1,BUDTSCTC=1
 D GENI
 D T51I
 G EN1
T51I ;
...
T6 ;EP - entry point for Table 6A only
 D EOJ
 S BUDT6=1,BUDTSCTC=1
 D GENI
 D T6I
 G EN1
T6I ;intro for table 6
 W !!,"TABLE 6A:  SELECTED DIAGNOSES AND SERVICES RENDERED"
 W !,"This report will produce UDS Table 6A which itemizes visits and patients",!,"by selected diagnoses and services provided regardless of primacy.",!
 Q
 ;
T9D ;EP
 D EOJ
 S BUDT9D=1,BUDTSCTC=1
 D GENI
 S BUDDIR=$$GETDIR()
 D T9DI
 G EN1
...
QUARTER ;
 ...
 S BUDXXBD=$E(BUDBD,1,3)_"0101",BUDXXED=$E(BUDED,1,3)_"1231"
...
GENI ;general introductions
 ...
 W !?4,"- the patient must NOT have a gender (sex assigned at birth) of 'Unknown'"
 Q:'$D(BUDXXXXX)
 W !
