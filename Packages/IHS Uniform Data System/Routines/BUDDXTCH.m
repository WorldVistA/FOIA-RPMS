BUDDXTCH ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY04 GPRA REPORT 19 Dec 2016 3:12 PM ; 
 ;;11.0;IHS/RPMS UNIFORM DATA SYSTEM;;JAN 18, 2017;Build 66
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2016 UDS Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BUDDTXCH",XBNS="",XBRX="XIT^BUDDTXCH"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
 D HOME^%ZIS
 K BUDQUIT
 W !,"Checking for Taxonomies to support the 2016 UDS Report...",!
 NEW A,BUDX,I,Y,Z,J
 K A
