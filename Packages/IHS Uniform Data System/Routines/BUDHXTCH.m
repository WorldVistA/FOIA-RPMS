BUDHXTCH ;IHS/CMI/LAB - UDS TAXONOMY CHECK;
 ;;13.0;IHS/RPMS UNIFORM DATA SYSTEM;;OCT 12, 2018;Build 90
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2018 UDS Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BUDHTXCH",XBNS="",XBRX="XIT^BUDHTXCH"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
 D HOME^%ZIS
 K BUDQUIT
 W !,"Checking for Taxonomies to support the 2018 UDS Report...",!
 NEW A,BUDX,I,Y,Z,J
 K A
