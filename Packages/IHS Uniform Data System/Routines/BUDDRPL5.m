BUDDRPL5 ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B ;
...
T4IPPL ;EP
 ...
 D T4IPPH Q:BUDQUIT
 I '$D(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4IPPL")) D  Q
...
T4IPPL1 ;
 ...
 S BUDTOT=0
 S BUDINCI="" F  S BUDINCI=$O(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4IPPL",BUDINCI)) Q:BUDINCI=""!(BUDQUIT)  D
 .S BUDINC="" F  S BUDINC=$O(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4IPPL",BUDINCI,BUDINC)) Q:BUDINC=""!(BUDQUIT)  D T4IPPL2
 Q
T4IPPL2 ;
 S BUDSTOT=0
 I BUDROT="P" W !,"Income as Percent of Poverty Level: ",BUDINC,!
 I BUDROT="D" D S("Income as Percent of Poverty Level: "_BUDINC)
 S BUDCCOM="" F  S BUDCCOM=$O(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4IPPL",BUDINCI,BUDINC,BUDCCOM)) Q:BUDCCOM=""!(BUDQUIT)  D
 .S BUDSEX="" F  S BUDSEX=$O(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4IPPL",BUDINCI,BUDINC,BUDCCOM,BUDSEX)) Q:BUDSEX=""!(BUDQUIT)  D
 ..S BUDAGE="" F  S BUDAGE=$O(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4IPPL",BUDINCI,BUDINC,BUDCCOM,BUDSEX,BUDAGE)) Q:BUDAGE=""!(BUDQUIT)  D
 ...S DFN=0 F  S DFN=$O(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4IPPL",BUDINCI,BUDINC,BUDCCOM,BUDSEX,BUDAGE,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
...
T4PMIS ;EP
 S BUDP=0,BUDQUIT=0,BUDTOT=0
 D T4PMIH Q:BUDQUIT
 I '$D(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4PMIS")) D  Q
 .I BUDROT="P" W !!,"No patients to report." Q
 .I BUDROT="D" D S(""),S(""),S("No patients to report.")
 D T4PMIS1
...
T4PMIS1 ;
 ...
 S BUDTOT=0
 S BUDINCI="" F  S BUDINCI=$O(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4PMIS",BUDINCI)) Q:BUDINCI=""!(BUDQUIT)  D
 .S BUDINC="" F  S BUDINC=$O(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4PMIS",BUDINCI,BUDINC)) Q:BUDINC=""!(BUDQUIT)  D T4PMIS2
 Q
T4PMIS2 ;
 S BUDSTOT=0
 ...
 S BUDAGE="" F  S BUDAGE=$O(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4PMIS",BUDINCI,BUDINC,BUDAGE)) Q:BUDAGE=""!(BUDQUIT)  D
 .S BUDCCOM="" F  S BUDCCOM=$O(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4PMIS",BUDINCI,BUDINC,BUDAGE,BUDCCOM)) Q:BUDCCOM=""!(BUDQUIT)  D
 ..S BUDSEX="" F  S BUDSEX=$O(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4PMIS",BUDINCI,BUDINC,BUDAGE,BUDCCOM,BUDSEX)) Q:BUDSEX=""!(BUDQUIT)  D
 ...S DFN=0 F  S DFN=$O(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4PMIS",BUDINCI,BUDINC,BUDAGE,BUDCCOM,BUDSEX,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
...
T4CHAR ;EP
 S BUDP=0,BUDQUIT=0,BUDTOT=0
 D T4CHAH Q:BUDQUIT
 I '$D(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4CHAR")) D  Q
 .I BUDROT="P" W !!,"No patients to report." Q
...
T4CHAR1 ;
 ...
 S BUDTOT=0
 S BUDINCI="" F  S BUDINCI=$O(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4CHAR",BUDINCI)) Q:BUDINCI=""!(BUDQUIT)  D
 .S BUDINC="" F  S BUDINC=$O(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4CHAR",BUDINCI,BUDINC)) Q:BUDINC=""!(BUDQUIT)  D T4CHAR2
 Q
T4CHAR2 ;
 S BUDSTOT=0
 I BUDROT="P" W !,"Special Characteristics: ",BUDINC,!
 I BUDROT="D" D S("Special Characteristics: "_BUDINC)
 S BUDAGE="" F  S BUDAGE=$O(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4CHAR",BUDINCI,BUDINC,BUDAGE)) Q:BUDAGE=""!(BUDQUIT)  D
 .S BUDCCOM="" F  S BUDCCOM=$O(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4CHAR",BUDINCI,BUDINC,BUDAGE,BUDCCOM)) Q:BUDCCOM=""!(BUDQUIT)  D
 ..S BUDSEX="" F  S BUDSEX=$O(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4CHAR",BUDINCI,BUDINC,BUDAGE,BUDCCOM,BUDSEX)) Q:BUDSEX=""!(BUDQUIT)  D
 ...S DFN=0 F  S DFN=$O(^XTMP("BUDDRPT1",BUDJ,BUDH,"T4CHAR",BUDINCI,BUDINC,BUDAGE,BUDCCOM,BUDSEX,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
