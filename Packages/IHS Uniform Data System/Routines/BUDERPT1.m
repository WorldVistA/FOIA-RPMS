BUDERPT1 ;IHS/CMI/LAB - UDS REPORT PRINT;
...
EN ;EP
EN1 ;
 I $G(BUDT6B) W !,"Table 6B:" D PRENATT^BUDERP6B
 I $G(BUDT7) W !,"Table 7:" D PRENATT^BUDERP7
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BUDERPT1",ZTDTH="",ZTDESC="UDS 17 REPORT" D ^%ZTLOAD D EOJ Q
 Q
