BUDHRPP2 ;IHS/CMI/LAB - UDS REPORT PRINT;
...
T4 ;EP
 S BUDPG=0
 S BUDTABI=$O(^BUDHCNTL("B","TABLE 4 LINE LABELS",0))
 D HEADER^BUDHRPTP Q:BUDQUIT  D T4SH
 ;print out each line
 ;
 I $Y>(IOSL-6) D HEADER^BUDHRPTP Q:BUDQUIT  D T4SH
 W !!,"Characteristic",?60,"Number of Patients"
 W !,BUD80L
 W !,"Income as Percent of Poverty Guideline",?60,"Number of Patients",!?66,"(a)"
 W !,BUD80L
 F BUDX=1,2,3,4,5,6 Q:BUDQUIT  D
 .I $Y>(IOSL-3) D HEADER^BUDHRPTP Q:BUDQUIT  D T4SH
 .S BUDY=$O(^BUDHCNTL(BUDTABI,11,"B",BUDX,0))
 .W !?2,BUDX,".",?7,$P(^BUDHCNTL(BUDTABI,11,BUDY,0),U,2),?63,$$C(BUDT4V(BUDX))
 .W !,BUD80L
 I $Y>(IOSL-20) D HEADER^BUDHRPTP Q:BUDQUIT  D T4SH
 ...
 .I $Y>(IOSL-2) D HEADER^BUDHRPTP Q:BUDQUIT  D T4SH
 .S BUDY=$O(^BUDHCNTL(BUDTABI,11,"B",BUDX,0))
 .W !?2,BUDX,".",?7,$P(^BUDHCNTL(BUDTABI,11,BUDY,0),U,2)
 .I $P(^BUDHCNTL(BUDTABI,11,BUDY,0),U,3)]"" W !?7,$P(^BUDHCNTL(BUDTABI,11,BUDY,0),U,3)
 .W ?50,$$C($P(BUDT4V(BUDX),U,1)),?65,$$C($P(BUDT4V(BUDX),U,2))
 .W !,BUD80L
 D HEADER^BUDHRPTP Q:BUDQUIT
 D T4SH
 ;W !,BUD80L
 W !,?50,"Other"
 W !,?50,"Public"
 W !,?2,"Managed Care Utilization",?50,"Including"
 W !,?30,"Medicaid",?40,"Medicare",?50,"Non-",?60,"Private",?70,"TOTAL"
 W !?50,"Medicaid"
 W !,?50,"CHIP"
 ...
 .I $Y>(IOSL-3) D HEADER^BUDHRPTP Q:BUDQUIT  D T4SH
 .S BUDY=$O(^BUDHCNTL(BUDTABI,11,"B",BUDX,0))
 .W !?2,BUDX,".",?7,$P(^BUDHCNTL(BUDTABI,11,BUDY,0),U,2),!,?7,$P(^BUDHCNTL(BUDTABI,11,BUDY,0),U,3) ;,?50,$$C($P(BUDT4V(BUDX),U,1)),?65,$$C($P(BUDT4V(BUDX),U,2))
 .W !,BUD80L
 I $Y>(IOSL-25) D HEADER^BUDHRPTP Q:BUDQUIT  D T4SH
 ...
 .S BUDY=$O(^BUDHCNTL(BUDTABI,11,"B",BUDX,0))
 .W !?2,BUDX,".",?7,$P(^BUDHCNTL(BUDTABI,11,BUDY,0),U,2)
 .W:$P(^BUDHCNTL(BUDTABI,11,BUDY,0),U,3)]"" !?7,$P(^BUDHCNTL(BUDTABI,11,BUDY,0),U,3)
 .W:$P($G(^BUDHCNTL(BUDTABI,11,BUDY,1)),U,1)]"" !?7,$P(^BUDHCNTL(BUDTABI,11,BUDY,1),U,1)
 .W ?63,$$C(BUDT4V(BUDX))
 .W !,BUD80L
 W !
 Q
...
T9 ;EP
 S BUDPG=0
 D HEADER^BUDHRPTP Q:BUDQUIT  D T9SH
 ;print out each line
 ;
 I $Y>(IOSL-9) D HEADER^BUDHRPTP Q:BUDQUIT  D T9SH
 W !,BUD80L
...
4 ;
 ...
 ;W !,BUD80L
7 ;
 I $Y>(IOSL-13) D HEADER^BUDHRPTP Q:BUDQUIT  D T9SH
 W !,BUD80L
...
13 ;
 ...
 W !,BUD80L
PAGE2 ;
 D HEADER^BUDHRPTP Q:BUDQUIT  D T92SH
 ;print out each line
 ;
 I $Y>(IOSL-9) D HEADER^BUDHRPTP Q:BUDQUIT  D T92SH
 W !,BUD80L
 W !?5,"Medicaid Non-Managed",!,"1.   Care"
 W !,BUD80L
 W !?5,"Medicaid Managed Care",!,"2a.  (capitated)"
...
24 ;
 ...
 ;W !,BUD80L
27 ;
 I $Y>(IOSL-13) D HEADER^BUDHRPTP Q:BUDQUIT  D T92SH
 W !,BUD80L
 W !?5,"Other Public including"
 W !,"7.   Non-Medicaid CHIP (Non"
 W !?5,"Managed Care)"
...
213 ;
 ...
 W !,BUD80L
PAGE3 ;
 D HEADER^BUDHRPTP Q:BUDQUIT  D T93SH
 ;print out each line
 ;
 I $Y>(IOSL-9) D HEADER^BUDHRPTP Q:BUDQUIT  D T93SH
 W !,BUD80L
 W !?5,"Medicaid Non-Managed",!,"1.   Care"
 W !,BUD80L
 W !?5,"Medicaid Managed Care",!,"2a.  (capitated)"
...
34 ;
 ...
 ;W !,BUD80L
37 ;
 I $Y>(IOSL-13) D HEADER^BUDHRPTP Q:BUDQUIT  D T93SH
 W !,BUD80L
 W !?5,"Other Public including"
 W !,"7.   Non-Medicaid CHIP (Non"
 W !?5,"Managed Care)"
