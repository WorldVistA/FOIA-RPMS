BUDERP6E ; IHS/CMI/LAB - UDS REPORT TABLE 6B ;
 ;;12.0;IHS/RPMS UNIFORM DATA SYSTEM;;NOV 22, 2017;Build 75
 ;
REST6B ;EP
 I $Y>(IOSL-13) D HEADER^BUDERPTP Q:BUDQUIT  D T6BH
...
G1 ;G
 ...
 D LINE
H ;SECTION H
 I $Y>(IOSL-17) D HEADER^BUDERPTP Q:BUDQUIT  D T6BH
...
K ;I
 ...
 D LINE
L ;
 I $Y>(IOSL-23) D HEADER^BUDERPTP Q:BUDQUIT  D T6BH
