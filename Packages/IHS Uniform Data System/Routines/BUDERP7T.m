BUDERP7T ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 7 ;
...
DMR2L ;EP
 ...
 D DMR2H Q:BUDQUIT
 I '$D(^XTMP("BUDERP7",BUDJ,BUDH,"DMR2")) S X="No patients to report." W:BUDROT="P" !!,X D:BUDROT="D" S(),S(X) Q
 D DMR2L1
...
DMR2L1 ;
 ...
 S BUDTOT=0
 S BUDRACE="" F  S BUDRACE=$O(^XTMP("BUDERP7",BUDJ,BUDH,"DMR2",BUDRACE)) Q:BUDRACE=""!(BUDQUIT)  D
 .S BUDETH="" F  S BUDETH=$O(^XTMP("BUDERP7",BUDJ,BUDH,"DMR2",BUDRACE,BUDETH)) Q:BUDETH=""!(BUDQUIT)  D DMR2L2
 Q
DMR2L2 ;
 S BUDSTOT=0
 ...
 S BUDCCOM="" F  S BUDCCOM=$O(^XTMP("BUDERP7",BUDJ,BUDH,"DMR2",BUDRACE,BUDETH,BUDCCOM)) Q:BUDCCOM=""!(BUDQUIT)  D
 .S BUDA="" F  S BUDA=$O(^XTMP("BUDERP7",BUDJ,BUDH,"DMR2",BUDRACE,BUDETH,BUDCCOM,BUDA)) Q:BUDA=""!(BUDQUIT)  D
 ..S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUDERP7",BUDJ,BUDH,"DMR2",BUDRACE,BUDETH,BUDCCOM,BUDA,BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 ...S DFN=0 F  S DFN=$O(^XTMP("BUDERP7",BUDJ,BUDH,"DMR2",BUDRACE,BUDETH,BUDCCOM,BUDA,BUDNAME,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ...
 ....S BUDALL=^XTMP("BUDERP7",BUDJ,BUDH,"DMR2",BUDRACE,BUDETH,BUDCCOM,BUDA,BUDNAME,DFN)
 ....S BUDPPV=$P(BUDALL,"^",1)
