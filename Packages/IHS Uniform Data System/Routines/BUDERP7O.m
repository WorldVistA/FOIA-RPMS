BUDERP7O ;IHS/CMI/LAB - UDS REPORT T7;
...
DMRACE1 ;EP - called from taskman
 ...
 ;S BUDQUIT=0
 D HEADER^BUDERPTP Q:BUDQUIT  D T7H^BUDERP71
 ...
 D LINE^BUDERP71
 I $Y>(IOSL-3) D HEADER^BUDERPTP Q:BUDQUIT  D T7H^BUDERP71
 W ?69,"|",!
...
DMRACE2 ;EP - second page of sections a,b
 D HEADER^BUDERPTP Q:BUDQUIT  D T7H1^BUDERP71
 ...
 D LINE4^BUDERP71
 I $Y>(IOSL-16) D HEADER^BUDERPTP Q:BUDQUIT  D T7H1^BUDERP71
 W ?69,"|",!
 ...
 D LINE5^BUDERP71
 I $Y>(IOSL-3) D HEADER^BUDERPTP Q:BUDQUIT  D T7H1^BUDERP71
