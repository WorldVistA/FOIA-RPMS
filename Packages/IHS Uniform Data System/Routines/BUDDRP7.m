BUDDRP7 ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B 12 Dec 2016 6:51 AM 30 Dec 2016 8:19 PM 27 Aug 2016 12:41 PM 21 Jan 2016 2:52 PM ; 
...
DRIVER ;
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BUDDRP7",XBRX="EOJ^BUDDRP7",XBNS="BUD"
 D ^XBDBQUE
 Q
NODEV1 ;
 D PROC^BUDDRP7
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BUDDRP7",ZTDTH="",ZTDESC="UDS 16 REPORT TABLE 7" D ^%ZTLOAD D EOJ Q
 Q
EOJ ;
 D EN^XBVK("BUD")
 Q
...
PROC ;EP - called from taskman
 S BUDJ=$J,BUDH=$H
 S ^XTMP("BUDDRP7B",0)=$$FMADD^XLFDT(DT,14)_"^"_DT_"^BUD TABLE 7 LISTS"
...
GENI ;general introductions
 ...
 W !,"of care indicators during the time period January 1 - December 31, 2016."
