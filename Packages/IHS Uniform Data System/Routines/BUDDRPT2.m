BUDDRPT2 ; IHS/CMI/LAB - UDS REPORT DRIVER 01 Dec 2016 6:00 PM ; 
...
EN1 ;
 S BUDSITE=""
 W ! S DIC="^BUDDSITE(",DIC(0)="AEMQ",DIC("A")="Enter your site: " D ^DIC
 I Y=-1 D EOJ Q
 S BUDSITE=+Y
 ...
 I $D(DIRUT) D EOJ Q
 I Y D EOJ Q
 ;S XBRP="PRINT^BUDDRPTP",XBRC="PROC^BUDDRPTC",XBRX="EOJ^BUDDRPT2",XBNS="BUD"
 ;D ^XBDBQUE
 ;D EOJ
 D PT^BUDDRPTE
 I BUDROT="" G EN1
...
DRIVER ;
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BUDDRPT2",XBRX="EOJ^BUDDRPT2",XBNS="BUD"
 D ^XBDBQUE
 Q
NODEV1 ;
 D PROC^BUDDRPTC
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BUDDRPT2",ZTDTH="",ZTDESC="UDS 16 REPORT" D ^%ZTLOAD D EOJ Q
 Q
...
T3AI ;intro for table 3A
 ...
 W !,"Age is calculated as of June 30th of the report year."
 Q
