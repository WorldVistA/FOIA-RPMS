BUDDRP7G ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B ;
...
DMRACE1 ;EP - called from taskman
 ...
 ;S BUDQUIT=0
 D HEADER^BUDDRPTP Q:BUDQUIT  D T7H^BUDDRP7F
 ...
 D LINE^BUDDRP7F
 I $Y>(IOSL-3) D HEADER^BUDDRPTP Q:BUDQUIT  D T7H^BUDDRP7F
 W ?69,"|",!
...
DMRACE2 ;EP - second page of sections a,b
 D HEADER^BUDDRPTP Q:BUDQUIT  D T7H1^BUDDRP7F
 ...
 D LINE^BUDDRP7F
 I $Y>(IOSL-16) D HEADER^BUDDRPTP Q:BUDQUIT  D T7H1^BUDDRP7F
 W ?69,"|",!
 ...
 D LINE1^BUDDRP7F
 I $Y>(IOSL-3) D HEADER^BUDDRPTP Q:BUDQUIT  D T7H1^BUDDRP7F
