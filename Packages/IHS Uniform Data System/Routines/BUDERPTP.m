BUDERPTP ;IHS/CMI/LAB - UDS REPORT PRINT;
...
PL ;
 ...
 I $G(BUDT9D) D WDEL^BUDERPTD
 D EOJ
 Q
 ;
EOJ ;
 K ^TMP($J)
 K ^XTMP("BUDERPT1",BUDJ,BUDH)
 K ^XTMP("BUDERPT9DEL",BUDJ,BUDH)
 Q
T9 ;
 D T9^BUDERPP2
 Q
...
TZ ;
 ...
 ;GET TOTAL
 S BUDZ="" F  S BUDZ=$O(^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP",BUDZ)) Q:BUDZ=""  D
 .S BUDY=^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP",BUDZ)
 .S BUDZTOT=BUDZTOT+BUDY
 .S BUDBTOT=BUDBTOT+$G(^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP",BUDZ,"b"))
 .S BUDCTOT=BUDCTOT+$G(^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP",BUDZ,"c"))
 .S BUDDTOT=BUDDTOT+$G(^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP",BUDZ,"d"))
 .S BUDETOT=BUDETOT+$G(^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP",BUDZ,"e"))
 .S BUDFTOT=BUDFTOT+$G(^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP",BUDZ,"f"))
 ;CALCULATE "OTHER"
 ;RESET BY TOTAL #
 D REOZ
 S BUDYY=0 F  S BUDYY=$O(^XTMP("BUDERPT1",BUDJ,BUDH,"ZIPORDER",BUDYY)) Q:BUDYY=""  D
 .S BUDZ="" F  S BUDZ=$O(^XTMP("BUDERPT1",BUDJ,BUDH,"ZIPORDER",BUDYY,BUDZ)) Q:BUDZ=""!(BUDQUIT)  D
 ..I $Y>(IOSL-4) D HEADER Q:BUDQUIT  D TZSH
 ..S BUDY=^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP",BUDZ)
 ..W !?8,BUDZ
 ..W ?20,$$C(+$G(^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP",BUDZ,"b")))
 ..W ?35,$$C(+$G(^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP",BUDZ,"c")))
 ..W ?50,$$C(+$G(^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP",BUDZ,"d")))
 ..W ?63,$$C(+$G(^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP",BUDZ,"e")))
 ..W ?72,$$C(+$G(^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP",BUDZ,"f")))
 ..W !,BUD80L
 Q:BUDQUIT
 ...
 .W ?20,$$C(+$G(^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP","Unknown Residence","b")))
 .W ?35,$$C(+$G(^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP","Unknown Residence","c")))
 .W ?50,$$C(+$G(^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP","Unknown Residence","d")))
 .W ?63,$$C(+$G(^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP","Unknown Residence","e")))
 .W ?72,$$C(+$G(^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP","Unknown Residence","f")))
...
REOZ ;
 ...
 .;S X=BUDY/BUDZTOT I X<.001 K ^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP",BUDZ) S ^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP","OTHER ZIP CODES")=^XTMP("BUDERPT1",BUDJ,BUDH,"ZIP","OTHER ZIP CODES")+BUDY D
 .S ^XTMP("BUDERPT1",BUDJ,BUDH,"ZIPORDER",(9999999-BUDY),BUDZ)=BUDY
 .D
 ..;now reset the list so the others collate at the end
 ..S BUDINS="" F  S BUDINS=$O(^XTMP("BUDERPT1",BUDJ,BUDH,"Z",BUDZ,BUDINS)) Q:BUDINS=""  D
 ...S BUDCCOM="" F  S BUDCCOM=$O(^XTMP("BUDERPT1",BUDJ,BUDH,"Z",BUDZ,BUDINS,BUDCCOM)) Q:BUDCCOM=""  D
 ....S BUDSEX="" F  S BUDSEX=$O(^XTMP("BUDERPT1",BUDJ,BUDH,"Z",BUDZ,BUDINS,BUDCCOM,BUDSEX)) Q:BUDSEX=""  D
 .....S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUDERPT1",BUDJ,BUDH,"Z",BUDZ,BUDINS,BUDCCOM,BUDSEX,BUDNAME)) Q:BUDNAME=""  D
 ......S DFN=0 F  S DFN=$O(^XTMP("BUDERPT1",BUDJ,BUDH,"Z",BUDZ,BUDINS,BUDCCOM,BUDSEX,BUDNAME,DFN)) Q:DFN'=+DFN  D
 .......S X=0 F  S X=$O(^XTMP("BUDERPT1",BUDJ,BUDH,"Z",BUDZ,BUDINS,BUDCCOM,BUDSEX,BUDNAME,DFN,X)) Q:X'=+X  D
 ........S ^XTMP("BUDERPT1",BUDJ,BUDH,"ZNEW",BUDYY,BUDZ,BUDINS,BUDCCOM,BUDSEX,BUDNAME,DFN,X)=""
 ........K ^XTMP("BUDERPT1",BUDJ,BUDH,"Z",BUDZ,BUDINS,BUDCCOM,BUDSEX,BUDNAME,DFN,X)
 Q
T5 ;print table 5
 ...
 .W !
 .I +BUDL<10 W " "
 .W $$LOW^XLFSTR(BUDL),".",?6,$P(^BUDETFIV(BUDY,0),U,2)
 .I $P(^BUDETFIV(BUDY,0),U,3)]"" W !?6,$P(^BUDETFIV(BUDY,0),U,3)
 ...
 .I $Y>(IOSL-3) D HEADER Q:BUDQUIT  D T5SH
 .W !,$$LOW^XLFSTR(BUDL),".",?6,$P(^BUDETFIV(BUDY,0),U,2) I $P(^BUDETFIV(BUDY,0),U,3)]"" W !?6,$P(^BUDETFIV(BUDY,0),U,3)
 ...
 F BUDL=16,17,"17a" S BUDY=$O(^BUDETFIV("B",BUDL,0)) Q:BUDQUIT  D
 .I $Y>(IOSL-3) D HEADER Q:BUDQUIT  D T5SH
 .W !,$$LOW^XLFSTR(BUDL),".",?6,$P(^BUDETFIV(BUDY,0),U,2) I $P(^BUDETFIV(BUDY,0),U,3)]"" W !?6,$P(^BUDETFIV(BUDY,0),U,3)
 .W ?60,$$C($P(BUDTAB5(BUDL),U,1),0)
 .W ?71,$$C($P(BUDTAB5(BUDL),U,2),2)
...
T518 F BUDL=18 S BUDY=$O(^BUDETFIV("B",BUDL,0)) Q:BUDQUIT  D
 ...
 F BUDL="20A","20A1","20A2","20B","20C" S BUDY=$O(^BUDETFIV("B",BUDL,0)) Q:BUDQUIT  D
 .I $Y>(IOSL-3) D HEADER Q:BUDQUIT  D T5SH
 .W !,$$LOW^XLFSTR(BUDL),".",?6,$P(^BUDETFIV(BUDY,0),U,2)
 .I $P(^BUDETFIV(BUDY,0),U,3)]"" W !?6,$P(^BUDETFIV(BUDY,0),U,3)
 ...
 F BUDL=21 S BUDY=$O(^BUDETFIV("B",BUDL,0)) Q:BUDQUIT  D
 .I $Y>(IOSL-3) D HEADER Q:BUDQUIT  D T5SH
 .W !,$$LOW^XLFSTR(BUDL),".",?8,$P(^BUDETFIV(BUDY,0),U,2) I $P(^BUDETFIV(BUDY,0),U,3)]"" W !?6,$P(^BUDETFIV(BUDY,0),U,3)
 .W ?60,$$C($P(BUDTAB5(BUDL),U,1),0)
 .W ?71,$$C($P(BUDTAB5(BUDL),U,2),0)
 .W !,BUD80L
 F BUDL=22 S BUDY=$O(^BUDETFIV("B",BUDL,0)) Q:BUDQUIT  D
 .I $Y>(IOSL-3) D HEADER Q:BUDQUIT  D T5SH
 .W !,$$LOW^XLFSTR(BUDL),".",?8,$P(^BUDETFIV(BUDY,0),U,2) I $P(^BUDETFIV(BUDY,0),U,3)]"" W !?8,$P(^BUDETFIV(BUDY,0),U,3)
 .W ?60,$$C($P(BUDTAB5(BUDL),U,1),0)
 .W ?71,$$C($P(BUDTAB5(BUDL),U,2),0)
 .W !,BUD80L
 F BUDL="22A","22B","22C" S BUDY=$O(^BUDETFIV("B",BUDL,0)) Q:BUDQUIT  D
 .I $Y>(IOSL-3) D HEADER Q:BUDQUIT  D T5SH
 .W !,$$LOW^XLFSTR(BUDL),".",?6,$P(^BUDETFIV(BUDY,0),U,2)
 .I $P(^BUDETFIV(BUDY,0),U,3)]"" W !?6,$P(^BUDETFIV(BUDY,0),U,3)
 .I $P(^BUDETFIV(BUDY,0),U,4)]"" W !?6,$P(^BUDETFIV(BUDY,0),U,4)
 ...
 .W ?71,$$C($P(BUDTAB5(BUDL),U,2),2)
 .W !,BUD80L
 F BUDL=26,27,"27a","27b","27c",28 S BUDY=$O(^BUDETFIV("B",BUDL,0)) Q:BUDQUIT  D
 .I $Y>(IOSL-3) D HEADER Q:BUDQUIT  D T5SH
 .W !,$$LOW^XLFSTR(BUDL),".",?6,$P(^BUDETFIV(BUDY,0),U,2) I $P(^BUDETFIV(BUDY,0),U,3)]"" W !?6,$P(^BUDETFIV(BUDY,0),U,3)
 ...
 F BUDL="30A","30B","30C" S BUDY=$O(^BUDETFIV("B",BUDL,0)) Q:BUDQUIT  D
 .I $Y>(IOSL-3) D HEADER Q:BUDQUIT  D T5SH
 .W !,$$LOW^XLFSTR(BUDL),".",?6,$P(^BUDETFIV(BUDY,0),U,2) I $P(^BUDETFIV(BUDY,0),U,3)]"" W !?6,$P(^BUDETFIV(BUDY,0),U,3)
 .W ?60,$$C($P(BUDTAB5(BUDL),U,1),2)
 .W ?71,$$C($P(BUDTAB5(BUDL),U,2),2)
 .W !,BUD80L
 I $Y>(IOSL-3) D HEADER Q:BUDQUIT  D T5SH
  F BUDL=31,32 S BUDY=$O(^BUDETFIV("B",BUDL,0)) Q:BUDQUIT  D
 .I $Y>(IOSL-3) D HEADER Q:BUDQUIT  D T5SH
 .W !,$$LOW^XLFSTR(BUDL),".",?6,$P(^BUDETFIV(BUDY,0),U,2) I $P(^BUDETFIV(BUDY,0),U,3)]"" W !?6,$P(^BUDETFIV(BUDY,0),U,3)
 .W ?60,$$C($P(BUDTAB5(BUDL),U,1),2)
 .W ?71,$$C($P(BUDTAB5(BUDL),U,2),2)
...
HEADER2 S BUDPG=BUDPG+1,BUDTPG=$G(BUDTPG)+1
 S X=$$CTR($P(^DIC(4,BUDSITE,0),U),60),$E(X,3)=$P(^VA(200,DUZ,0),U,2),$E(X,10)="UDS 2017",$E(X,70)="Page ",$E(X,75)=BUDPG W !,X
 ;W !?3,$P(^VA(200,DUZ,0),U,2),?8,"UDS 2017",$$CTR($P(^DIC(4,BUDSITE,0),U),80),?70,"Page ",BUDPG
