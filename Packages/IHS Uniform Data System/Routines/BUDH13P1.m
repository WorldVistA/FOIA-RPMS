BUDH13P1 ;IHS/CMI/LAB - environmental check post init;
...
ENV ;
 ...
 I +$$VERSION^XPDUTL("BUD")'=13 D MES^XPDUTL($$CJ^XLFSTR("Version 13.0 of UDS (BUD) is required.  Not installed",80)) D SORRY(2)
 Q
 ;
 ;
PRE ;
