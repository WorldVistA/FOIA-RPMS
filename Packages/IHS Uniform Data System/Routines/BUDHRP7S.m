BUDHRP7S ;IHS/CMI/LAB - UDS REPORT T7 PROCESS;
...
DME3L ;EP
 ...
 D DME3H Q:BUDQUIT
 I '$D(^XTMP("BUDHRP7",BUDJ,BUDH,"DME3")) W !!,"No patients to report." Q
 D DME3L1
...
DME3L1 ;
 ...
 S BUDTOT=0
 S BUDRACE="" F  S BUDRACE=$O(^XTMP("BUDHRP7",BUDJ,BUDH,"DME3",BUDRACE)) Q:BUDRACE=""!(BUDQUIT)  D DME3L2
 Q
DME3L2 ;
 S BUDSTOT=0
 W !,BUDRACE
 S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUDHRP7",BUDJ,BUDH,"DME3",BUDRACE,BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 .S BUDCCOM="" F  S BUDCCOM=$O(^XTMP("BUDHRP7",BUDJ,BUDH,"DME3",BUDRACE,BUDNAME,BUDCCOM)) Q:BUDCCOM=""!(BUDQUIT)  D
 ..S DFN=0 F  S DFN=$O(^XTMP("BUDHRP7",BUDJ,BUDH,"DME3",BUDRACE,BUDNAME,BUDCCOM,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ...
 ...S BUDALL=^XTMP("BUDHRP7",BUDJ,BUDH,"DME3",BUDRACE,BUDNAME,BUDCCOM,DFN)
 ...W ?5,$P(BUDALL,U,2),!
 ...S BUDPPV=$P(BUDALL,"^",1)
