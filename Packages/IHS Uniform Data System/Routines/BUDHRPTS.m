BUDHRPTS ;IHS/CMI/LAB - UDS REPORT PRINT;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BUDHRPTS",ZTDTH="",ZTDESC="UDS 18 REPORT SEARCH TEMPLATE" D ^%ZTLOAD D EOJ Q
 Q
PRINTCP ;
 W !
 S X=$$CTR($P(^DIC(4,BUDSITE,0),U),60),$E(X,3)=$P(^VA(200,DUZ,0),U,2),$E(X,10)="UDS 2018",$E(X,70)="Cover Page" W !,X
...
NRY ;
 ...
 Q
STEMP ;EP
 S X=0 F  S X=$O(^XTMP("BUDHRPT1",BUDJ,BUDH,"3ATEMP",X)) Q:X'=+X  S ^DIBT(BUDSTMP,1,X)=""
 Q
