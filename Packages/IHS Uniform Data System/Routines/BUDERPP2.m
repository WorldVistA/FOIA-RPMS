BUDERPP2 ;IHS/CMI/LAB - UDS REPORT PRINT;
...
T4 ;EP
 S BUDPG=0
 S BUDTABI=$O(^BUDECNTL("B","TABLE 4 LINE LABELS",0))
 D HEADER^BUDERPTP Q:BUDQUIT  D T4SH
 ;print out each line
 ;
 I $Y>(IOSL-6) D HEADER^BUDERPTP Q:BUDQUIT  D T4SH
 ...
 .I $Y>(IOSL-3) D HEADER^BUDERPTP Q:BUDQUIT  D T4SH
 .S BUDY=$O(^BUDECNTL(BUDTABI,11,"B",BUDX,0))
 .W !?2,BUDX,".",?7,$P(^BUDECNTL(BUDTABI,11,BUDY,0),U,2),?63,$$C(BUDT4V(BUDX))
 .W !,BUD80L
 I $Y>(IOSL-22) D HEADER^BUDERPTP Q:BUDQUIT  D T4SH
 ...
 .I $Y>(IOSL-3) D HEADER^BUDERPTP Q:BUDQUIT  D T4SH
 .S BUDY=$O(^BUDECNTL(BUDTABI,11,"B",BUDX,0))
 .W !?2,BUDX,".",?7,$P(^BUDECNTL(BUDTABI,11,BUDY,0),U,2)
 .I $P(^BUDECNTL(BUDTABI,11,BUDY,0),U,3)]"" W !?7,$P(^BUDECNTL(BUDTABI,11,BUDY,0),U,3)
 .W ?50,$$C($P(BUDT4V(BUDX),U,1)),?65,$$C($P(BUDT4V(BUDX),U,2))
 .W !,BUD80L
 D HEADER^BUDERPTP Q:BUDQUIT
 D T4SH
 ;W !,BUD80L
 W !,?50,"Other"
 W !,?50,"Public"
 ...
 .I $Y>(IOSL-3) D HEADER^BUDERPTP Q:BUDQUIT  D T4SH
 .S BUDY=$O(^BUDECNTL(BUDTABI,11,"B",BUDX,0))
 .W !?2,BUDX,".",?7,$P(^BUDECNTL(BUDTABI,11,BUDY,0),U,2),!,?7,$P(^BUDECNTL(BUDTABI,11,BUDY,0),U,3) ;,?50,$$C($P(BUDT4V(BUDX),U,1)),?65,$$C($P(BUDT4V(BUDX),U,2))
 .W !,BUD80L
 I $Y>(IOSL-28) D HEADER^BUDERPTP Q:BUDQUIT  D T4SH
 ...
 .S BUDY=$O(^BUDECNTL(BUDTABI,11,"B",BUDX,0))
 .W !?2,BUDX,".",?7,$P(^BUDECNTL(BUDTABI,11,BUDY,0),U,2)
 .W:$P(^BUDECNTL(BUDTABI,11,BUDY,0),U,3)]"" !?7,$P(^BUDECNTL(BUDTABI,11,BUDY,0),U,3)
 .W:$P($G(^BUDECNTL(BUDTABI,11,BUDY,1)),U,1)]"" !?7,$P(^BUDECNTL(BUDTABI,11,BUDY,1),U,1)
 .W ?63,$$C(BUDT4V(BUDX))
 .W !,BUD80L
 W !
 Q
...
T9 ;EP
 S BUDPG=0
 D HEADER^BUDERPTP Q:BUDQUIT  D T9SH
 ;print out each line
 ;
 I $Y>(IOSL-9) D HEADER^BUDERPTP Q:BUDQUIT  D T9SH
 W !,BUD80L
...
4 ;
 ...
 ;W !,BUD80L
7 ;
 I $Y>(IOSL-13) D HEADER^BUDERPTP Q:BUDQUIT  D T9SH
 W !,BUD80L
...
13 ;
 ...
 W !,BUD80L
PAGE2 ;
 D HEADER^BUDERPTP Q:BUDQUIT  D T92SH
 ;print out each line
 ;
 I $Y>(IOSL-9) D HEADER^BUDERPTP Q:BUDQUIT  D T92SH
 W !,BUD80L
 W !?5,"Medicaid Non-Managed",!,"1.   Care"
 W !,BUD80L
 W !?5,"Medicaid Managed Care",!,"2a.  (capitated)"
...
24 ;
 ...
 ;W !,BUD80L
27 ;
 I $Y>(IOSL-13) D HEADER^BUDERPTP Q:BUDQUIT  D T92SH
 W !,BUD80L
 W !?5,"Other Public including"
 W !,"7.   Non-Medicaid CHIP (Non"
 W !?5,"Managed Care)"
...
213 ;
 ...
 W !,BUD80L
PAGE3 ;
 D HEADER^BUDERPTP Q:BUDQUIT  D T93SH
 ;print out each line
 ;
 I $Y>(IOSL-9) D HEADER^BUDERPTP Q:BUDQUIT  D T93SH
 W !,BUD80L
 W !?5,"Medicaid Non-Managed",!,"1.   Care"
 W !,BUD80L
 W !?5,"Medicaid Managed Care",!,"2a.  (capitated)"
...
34 ;
 ...
 ;W !,BUD80L
37 ;
 I $Y>(IOSL-13) D HEADER^BUDERPTP Q:BUDQUIT  D T93SH
 W !,BUD80L
 W !?5,"Other Public including"
 W !,"7.   Non-Medicaid CHIP (Non"
 W !?5,"Managed Care)"
