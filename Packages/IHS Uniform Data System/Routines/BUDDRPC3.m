BUDDRPC3 ; IHS/CMI/LAB - UDS TABLE 6 11 Dec 2016 10:13 AM ; 
...
ZIPINS(DFN,BUDLASTV) ;EP - ZIP INSURANCE
 NEW BUDHAS
 S BUDHAS=0
 S BUDHAS=$$PI^BUDDRPC2(DFN,$$VD^APCLV(BUDLASTV))
 I BUDHAS=1 Q "e"
 S BUDHAS=$$MCR^BUDDRPC2(DFN,$$VD^APCLV(BUDLASTV))
 I BUDHAS=1 Q "d"
 ;S BUDHAS=$$OPI(DFN,$$VD^APCLV(BUDLASTV),"W")
 ;I BUDHAS=1 D TINS(BUDAGE,"10a") Q
 S BUDHAS=$$RR^AUPNPAT(DFN,$$VD^APCLV(BUDLASTV))
 I BUDHAS=1 Q "c"
 S BUDHAS=$$OPI^BUDDRPC2(DFN,$$VD^APCLV(BUDLASTV))
 I BUDHAS=1 Q "c"
 S BUDHAS=$$OPIC^BUDDRPC2(DFN,$$VD^APCLV(BUDLASTV),"K")
 I BUDHAS=1 Q "c"
 S BUDHAS=$$MCD^BUDDRPC2(DFN,$$VD^APCLV(BUDLASTV),"D")
 I BUDHAS=1 Q "c"
 S BUDHAS=$$MCD^BUDDRPC2(DFN,$$VD^APCLV(BUDLASTV),"K")
 I BUDHAS=1 Q "c"
 ;now check workman's comp and 3rd party liability
 S BUDHAS=$$WC^BUDDRPC2(DFN,BUDBD,BUDED)
 I BUDHAS=1 Q "c"
 S BUDHAS=$$TPL^BUDDRPC2(DFN,BUDBD,BUDED)
 I BUDHAS=1 Q "c"
