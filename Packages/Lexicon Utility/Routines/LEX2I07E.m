LEX2I07E ;IHS/OIT/FCJ - LEX*2.0*1007 Env Check FOR IHS patch 1007
...
CHK ;
 ...
 D HELP^XBHELP("INTROE","LEX2I07E")
 I '$$DIR^XBDIR("E","","","","","",1) D SORRY(2) Q
 I $G(XPDENV)=1 S (XPDDIQ("XPZ1"),XPDDIQ("XPZ2"))=0 D HELP^XBHELP("INTROI","LEX2I07E") I '$$DIR^XBDIR("E","","","","","",1) D SORRY(2)
 Q
 ;
SORRY(X) ;
 KILL DIFQ
