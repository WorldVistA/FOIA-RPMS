LEX2I05E ;IHS/OIT/FCJ - LEX*2.0*1005 Env Check FOR IHS patch 1005
...
CHK ;
 ...
 D HELP^XBHELP("INTROE","LEX2I05E")
 I '$$DIR^XBDIR("E","","","","","",1) D SORRY(2) Q
 I $G(XPDENV)=1 S (XPDDIQ("XPZ1"),XPDDIQ("XPZ2"))=0 D HELP^XBHELP("INTROI","LEX2I05E") I '$$DIR^XBDIR("E","","","","","",1) D SORRY(2)
 Q
 ;
SORRY(X) ;
 KILL DIFQ
...
INTROE ; Intro text during KIDS Environment check.
 ;; Distribution contains VA Lexicon Data only for patches 86-87
 ;; 95-102, 104-105,107-108 and 110.
 ;;
 ;;
 ;;###
 ;
