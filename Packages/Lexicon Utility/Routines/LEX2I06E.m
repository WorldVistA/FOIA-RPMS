LEX2I06E ;IHS/OIT/FCJ - LEX*2.0*1006 Env Check FOR IHS patch 1006
...
CHK ;
 ...
 D HELP^XBHELP("INTROE","LEX2I06E")
 I '$$DIR^XBDIR("E","","","","","",1) D SORRY(2) Q
 I $G(XPDENV)=1 S (XPDDIQ("XPZ1"),XPDDIQ("XPZ2"))=0 D HELP^XBHELP("INTROI","LEX2I06E") I '$$DIR^XBDIR("E","","","","","",1) D SORRY(2)
 Q
 ;
SORRY(X) ;
 KILL DIFQ
...
INTROE ; Intro text during KIDS Environment check.
 ;; Distribution contains VA Lexicon Data only for patch 109,
 ;; FY 2017 second quarter update.
 ;;
 ;;
 ;;###
 ;
