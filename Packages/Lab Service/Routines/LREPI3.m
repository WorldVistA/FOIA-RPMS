LREPI3 ;VA/DALOI/SED-EMERGING PATHOGENS HL7 SEGMENTS ; 17-Oct-2014 09:22 ; MKK
 ;;5.2;LAB SERVICE;**1002,132,175,1018,260,281,320,1030,315,1031,1034**;NOV 1, 1997;Build 188
 ;
...
DG11 Q:+IFN'>0
 ...
 .S:$$DT^XLFDT<ICD10DT ICD9=$O(^ICD9("BA","482.84 ",0))
 .S:$$DT^XLFDT'<ICD10DT ICD9=$O(^ICD9("BA","A48.1 ",0))
 .Q:+ICD9<1
...
PID ;TO BUILD PID SEGMENT
 ...
 ;       If MPIF001 routine exists, use it, otherwise indicate site is not a MPI Node
 S ICN=$S($$EXIST^%R("MPIF001.INT"):$$GETICN^MPIF001(DFN),1:"-1^NO MPI NODE")
 ...
 ; ----- BEGIN IHS/MSC/MKK - LR*5.2*1031
 ;       If SOWKHIRM routine exists, use it
 I $$EXIST^%R("SOWKHIRM.INT")  S:$$HOMELESS^SOWKHIRM(DFN) $P(MSG,HLFS,12)="HOMELESS"
 ; ----- END IHS/MSC/MKK - LR*5.2*1031
...
PV1 ;TO BUILD PV1 SEGMENT
 ...
 .. S LRTMP=$$ICDDX^ICDEX(ICD9N,,,"I",1)    ; IHS/MSC/MKK - LR*5.2*1034
 ..S:'$D(DGCNT) DGCNT=1
 ..S LRDATA="DG1"_HLFS_DGCNT_HLFS_HLFS_$P(LRTMP,U,2)
 ..S LRDATA=LRDATA_LRCS_$P(LRTMP,U,4)_LRCS_"I9"
