LRCAPDAR ;DALOI/FHS/RBN - LAB DSS RESULTS EXTRACT (LAR) ;2/20/15  14:08
 ;;5.2;LAB SERVICE;**1002,1003,143,169,258,307,326,1018,386,385,394,1031,399,1033,420,1039,455,1040**;NOV 1, 1997;Build 35
 ;
...
EN S:$D(ZTQUEUED) ZTREQ="@"
 Q:+$$MODEXIST^BLRUTIL4("ECX")<1  ; IHS/MSC/MKK - LR*5.2*1033 - If ECX doesn't exist, skip
