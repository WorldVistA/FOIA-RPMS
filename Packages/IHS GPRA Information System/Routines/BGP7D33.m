...
OPV(P,EDATE) ;EP
 ...
 K BGPG ;D SETPRC^BGP7UTL1(P,$$DOB^AUPNPAT(P),EDATE,"BGP IPV IZ PROCS",.BGPG)
 ...
 I $$PLTAXND^BGP7DU(P,"BGP OPV EVID DISEASE",EDATE) Q 4_U_"Evid Polio"
 I $$IPLSNOND^BGP7DU(P,"PXRM BGP POLIO",EDATE) Q 4_U_"Evid Polio"
 ...
 ;I $$PLTAX^BGP7DU(P,"BGP OPV CONTRAINDICATONS") Q 4_U_"Contra Polio"
 ;F BGPZ=2,89 S X=$$ANCONT^BGP7D31(P,BGPZ,EDATE) Q:X]""
 ;I X]"" Q 4_U_"Contra Polio"
 F BGPZ=2,10,89,110,120,130,132,146 S X=$$ANNECONT^BGP7D31(P,BGPZ,EDATE) Q:X]""
 I X]"" Q 4_U_"Contra Polio"
 ;now go to Refusals
 ...
 ;F BGPIMM=2,89,10,110,120,130,132,146 S R=$$IMMREF^BGP7D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
...
REF ;
 ...
 I R Q $S(BGPNMI:4,1:3)_U_$S(BGPNMI:"NMI MMR",1:"Ref MMR")
 ;now check Refusals in imm pkg
 S R="" ;F BGPIMM=3,94 S R=$$IMMREF^BGP7D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
 ;I R Q 3_U_"Ref MMR"
MMRC ;K BGPG S %=P_"^LAST DX [BGP MMR CONTRAINDICATIONS;DURING "_$$DOB^AUPNPAT(P)_"-"_EDATE,E=$$START1^APCLDF(%,"BGPG(")
 ...
 ;I $$PLTAX^BGP7DU(P,"BGP MMR CONTRAINDICATIONS") Q 4_U_"Contra MMR"
 F BGPZ=3,94 S X=$$MMRCONT^BGP7D31(P,BGPZ,EDATE) Q:X]""
 I X]"" Q 4_U_"Contra MMR"
MRC ;
 F BGPZ=4 S X=$$ANCONT^BGP7D31(P,BGPZ,EDATE) Q:X]""
...
REFMR ;
 ...
 ;now check Refusals in imm pkg
 ;F BGPIMM=4 I $$IMMREF^BGP7D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE) S BGPMR=3
RMC ;
 F BGPZ=38 S X=$$ANCONT^BGP7D31(P,BGPZ,EDATE) Q:X]""
...
MEX ;
 ...
 ;I $$PLTAX^BGP7DU(P,"BGP MEASLES EVIDENCE") S BGPME=4
 I $$PLTAXND^BGP7DU(P,"BGP MEASLES EVIDENCE",EDATE) S BGPME=4
 I $$IPLSNOND^BGP7DU(P,"PXRM BGP MEASLES",EDATE) S BGPME=4
 I BGPME=0 D
 .S B=$$DOB^AUPNPAT(P),E=EDATE
 .F BGPIMM=5 D
 ..S I=$O(^AUTTIMM("C",BGPIMM,0)) Q:'I
 ...
 F BGPZ=5 S X=$$MMRCONT^BGP7D31(P,BGPZ,EDATE) Q:X]""
 I X]"" S BGPME=4
MUX ;
 ...
 I $$PLTAX^BGP7DU(P,"BGP MUMPS EVIDENCE") S BGPMU=4
 I BGPMU=0 D
 .S B=$$DOB^AUPNPAT(P),E=EDATE
 .F BGPIMM=7 D
 ..S I=$O(^AUTTIMM("C",BGPIMM,0)) Q:'I
 ...
 F BGPZ=7 S X=$$ANCONT^BGP7D31(P,BGPZ,EDATE) Q:X]""
 I X]"" S BGPMU=4
RUBX ;
 ...
 ;I $$PLTAX^BGP7DU(P,"BGP RUBELLA EVIDENCE") S BGPRUB=4
 I $$PLTAXND^BGP7DU(P,"BGP RUBELLA EVIDENCE",EDATE) S BGPRUB=4
 I $$IPLSNOND^BGP7DU(P,"PXRM BGP RUBELLA",EDATE) S BGPRUB=4
 I BGPRUB=0 D
 .S B=$$DOB^AUPNPAT(P),E=EDATE
 .F BGPIMM=6 D
 ..S I=$O(^AUTTIMM("C",BGPIMM,0)) Q:'I
 ...
 F BGPZ=6 S X=$$ANCONT^BGP7D31(P,BGPZ,EDATE) Q:X]""
 I X]"" S BGPRUB=4
