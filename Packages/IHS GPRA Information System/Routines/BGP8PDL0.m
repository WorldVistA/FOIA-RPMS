BGP8PDL0 ; IHS/CMI/LAB - print ind 1 01 Jul 2010 8:03 PM ;
 ;;18.1;IHS CLINICAL REPORTING;;MAY 25, 2018;Build 66
 ;
 ;
IC1 ;EP
 S BGPXXX=$P(^BGPINDR(BGPIC,12),U,6)
 I BGPINDG'="D" D:'$G(BGPSUMON) H1^BGP8PDL1
 I BGPINDG'="D" F BGPPC1=BGPXXX_".1",BGPXXX_".2",BGPXXX_".3" D PI^BGP8PDL1
 I BGPINDG'="D" D:'$G(BGPSUMON) H1^BGP8PDL1
 I BGPINDG'="D" F BGPPC1=BGPXXX_".4",BGPXXX_".5",BGPXXX_".6" D PI^BGP8PDL1
...
I1AGE ;EP
 ...
 S X=^BGPINDR(BGPIC,53,1,0) D S(X,1,1) S X=" " D S(X,1,1) D H3 S X=" " D S(X,1,1)
...
I1AGE1 ;
 S C=C+1
 S BGPF="C-1."_BGPX_".3" S BGPPC=$O(^BGPINDRC("C",BGPF,0))
...
I1AGE2 ;
 S D=D+1
 S BGPF="C-1."_BGPX_".2" S BGPPC=$O(^BGPINDRC("C",BGPF,0))
...
I1AGE3 ;
 S BGPF="C-1."_BGPX_".1" S BGPPC=$O(^BGPINDRC("C",BGPF,0))
...
I1AGE4 ;
 S BGPF="C-1."_BGPX_".4" S BGPPC=$O(^BGPINDRC("C",BGPF,0))
