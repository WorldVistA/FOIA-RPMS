BGP7DCEI ; IHS/CMI/LAB - calculate HEDIS measures ;
...
CALCIND ;EP
 ...
 .K ^TMP($J)
 .I $D(^BGPELIG(BGPIC,1)) X ^BGPELIG(BGPIC,1)
 ...
 .S BGPI=0 F  S BGPI=$O(^BGPELIIG("B",BGPIC,BGPI)) Q:BGPI'=+BGPI  D
 ..S (BGPNUM,BGPDEN)=0
 ..X ^BGPELIIG(BGPI,1)
 ..X ^BGPELIIG(BGPI,2) ;denominator 1 or 0
 ..;set field counter
 ..S BGPNF=$P(^BGPELIIG(BGPI,0),U,9)
 ..S BGPN=$P(^DD(90559.03,BGPNF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
 ..D S(BGPRPT,BGPGBL,N,P,BGPNUM)
 ..S BGPDF=$P(^BGPELIIG(BGPI,0),U,8)
 ..S BGPN=$P(^DD(90559.03,BGPDF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
 ..I BGPDEN'="NO" D S(BGPRPT,BGPGBL,N,P,BGPDEN)
 .K BGPNUMV
 .I $D(BGPLIST(BGPIC)) D STMP^BGP7EUTL
