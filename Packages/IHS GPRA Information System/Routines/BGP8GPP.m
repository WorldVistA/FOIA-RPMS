BGP8GPP ; IHS/CMI/LAB - GUI PP REPORT ;
...
TESTNTL ;
 ...
 S BGPND(4)="",BGPND(3)=""
 S BGPLIST(3)=""
 D EP(.ERR,1,2522,"BGP 18 SEL PATIENT PANEL",338,"D",.BGPND,1,3040000,3000000,1801,"A",.BGPLIST,"","","B",$$NOW^XLFDT)
 W !,ERR
 Q
EP(BGPRET,BGPUSER,BGPDUZ2,BGPOPTN,BGPINDG,BGPIND,BGPQTR,BGPPER,BGPVDT,BGPSEAT,BGPLSTT,BGPLIST,BGPLPRV,BGPLPROV,BGPROT,BGPRTIME,BGPFILE,BGPDNT) ;EP - called from GUI to produce PP REPORT CI05-RPT-LOC-PP
 ...
 ;           so if BGPINDG="S" pass this array
...
EP1 ;
 ...
 I BGPINDG="I" K BGPIND D II^BGP8DL
 I BGPINDG="P" K BGPIND D PI^BGP8DL
 I BGPINDG="A" K BGPIND D AI^BGP8DL
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="LOCPP^BGP8GPP",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA REPORT COM 05" D ^%ZTLOAD
