BGP8PC61 ; IHS/CMI/LAB - measure I2 ; 02 Feb 2018  11:25 AM
 ;;18.1;IHS CLINICAL REPORTING;**1**;MAY 25, 2018;Build 65
 ;
IPV(P) ;
 NEW A42,A730,X,Y,Z,TCVX,TCPT,C,BGPIMMS,D,V,BGPZ
 S TCVX=$O(^ATXAX("B","BGP IPC IPV CVX CODES",0))
 S TCPT=$O(^ATXAX("B","BGP IPC IPV CPT CODES",0))
 ...
 I X]"" Q 1_U_"IPV CONTRA ANAPHYLACTIC/NEOMYCIN"
 S X=$$ANSNIPV(P,A730) I X Q 1_U_"IPV CONTRA ANAPHYLACTIC REACTION"
 Q ""
ANSNIPV(P,EDATE) ;
 ...
 .I S=293117006 S I=1 Q
 .I S=292925004 S I=1 Q
 .I S=292992006 S I=1 Q
 ...
 .I I'=293117006,I'=292925004,I'=292992006,I'=292927007 Q   ;IF IT'S SNOMED, MUST BE THAT ONE
