BGP7GAGS ; IHS/CMI/LAB - AREA NATIONAL GPRA REPORT ;
...
TESTNTL ;
 ...
 S BGPSUL(3)=""
 S BGPSUL(2)=""
 D EP(.ERR,1,2522,"BGP 17 AREA GPRA","A",.BGPSUL,"B",1,$$NOW^XLFDT,1)
 W !,ERR
 Q
...
NT ;
 ...
 D TSKMN
 S BGPRET=BGPGIEN
 S BGPFN=$G(BGPFGNT1)_","_$G(BGPFGNT2)_","_$G(BGPFGNT3)_","_$G(BGPFGNT4)_","_$G(BGPFGNT5)_","_$G(BGPFDEV1)_","_$G(BGPFDEV2)_","_$G(BGPFDEV3)_","_$G(BGPFDEV4)
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="AOAGP^BGP7GAGS",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI AREA GPRA REPORT 15" D ^%ZTLOAD
...
AOAGP ;
 ...
 I BGPRPTT="A",'$G(BGPSUMON) D GNT1^BGP7UTL
 D ENDLOG
 D XIT
 Q
 ;
