BGP7PDL4 ; IHS/CMI/LAB - print ind 1 01 Jul 2010 8:04 PM ;
 ;;17.1;IHS CLINICAL REPORTING;;MAY 10, 2017;Build 29
 ;
 ;
I031 ;EP
 S BGPORXX=$P(^BGPINDG(BGPIC,12),U,6)
 D:'$G(BGPSUMON) H1^BGP7PDL1
 I BGPRTYPE=4,BGPINDG="C" D  Q
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".7.3D",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".8.3D",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".9.3D",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".7.3E",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".8.3E",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".9.3E",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".7.3F",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".8.3F",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".9.3F",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".7.3G",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".8.3G",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".9.3G",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".7.3H",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".8.3H",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".9.3H",0)) D PI1^BGP7PDL1
 F BGPPC1=BGPORXX_".1",BGPORXX_".2",BGPORXX_".3" D PI^BGP7PDL1
 F BGPPC1=BGPORXX_".4",BGPORXX_".5",BGPORXX_".6" D PI^BGP7PDL1
 D I1AGE
 Q
I1AGE ;EP
 ;Q:BGPRTYPE'=4
 ...
 S X=^BGPINDG(BGPIC,53,1,0) D S(X,3,1) S X=" " D S(X,1,1) D H3 S X=" " D S(X,1,1)
...
I1AGE1 ;
 S C=C+1
 S BGPF="031."_BGPX_".1" S BGPPC=$O(^BGPINDGC("C",BGPF,0))
...
I1AGE2 ;
 S D=D+1
 S BGPF="031."_BGPX_".2" S BGPPC=$O(^BGPINDGC("C",BGPF,0))
...
I1AGE3 ;
 S BGPF="031."_BGPX_".3" S BGPPC=$O(^BGPINDGC("C",BGPF,0))
 S BGPNF=$P(^BGPINDGC(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90558.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
...
I1AGE4 ;
 S BGPF="031."_BGPX_".4" S BGPPC=$O(^BGPINDGC("C",BGPF,0))
 S BGPNF=$P(^BGPINDGC(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90558.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
...
I1AGE5 ;
 S BGPF="031."_BGPX_".5" S BGPPC=$O(^BGPINDGC("C",BGPF,0))
 S BGPNF=$P(^BGPINDGC(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90558.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
