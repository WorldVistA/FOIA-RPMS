BGP7LHW ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2010 10:56 PM 13 Dec 2006 7:35 AM ;
 ;;17.1;IHS CLINICAL REPORTING;;MAY 10, 2017;Build 29
 ;
 ;
TESTNTL ;
 S ERR=""
 D EP(.ERR,1,2582,"BGP 17 LOCAL HT/WT",597,0,"B",$$NOW^XLFDT,,0)
 W !,ERR
 Q
...
NT ;
 ...
 S BGPEXCEL=""
 I BGPYWCHW="",BGPEXPT S BGPYWCHW=0  ;$S($P($G(^BGPSITE(DUZ(2),0)),U,11)=0:0,1:1)  LAB/V13
 ...
 S X=BGPFILE
 S BGPGFNM=X
 S DIC="^BGPGUIG(",DIC(0)="L",DIADD=1,DLAYGO=90558.19,DIC("DR")=".02////"_BGPUSER_";.03////"_$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT)_";.05///"_BGPOPTN_";.06///R;.07///"_$G(BGPROT)_";.08///"_BGPFILEN
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP7LHW",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI LOCAL HT/WT FILE" D ^%ZTLOAD Q
 Q
NTLGP ;
 D ^BGP7D1
 K ^TMP($J,"BGPGUI")
