BGP7GDSH ; IHS/CMI/LAB - GPRA DASHBOARD GUI ;
 ;;17.1;IHS CLINICAL REPORTING;;MAY 10, 2017;Build 29
 ;
 ;
TESTDSH ;
 S ERR=""
 D EP(.ERR,1,2582,"BGP 17 NATIONAL DASHBOARD",597,"B",$$NOW^XLFDT,,"LORITESTGUI")
 W !,ERR
 Q
...
NT ;
 ...
 S BGPEXCEL=""
 I $G(BGPDESGP)="" D REPORT^BGP7UTL G NT1
 N DESDDA
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP7GDSH",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL DASHBOARD REPORT" D ^%ZTLOAD
...
NTLGP ;
 ...
 ..K ^TMP($J,"BGPGUI")
 ..S IOM=80,BGPIOSL=55
 ..D GUIR^BGPXBLM("PRINTN^BGP7DP","^TMP($J,""BGPGUI"",")
 ...
 ..Q
P ;
 ;D ^BGP7D1  ;cmi/maw 05/20/2014 commented out as it is already being called at NTLGP+1
 K ^TMP($J,"BGPGUI")
 S IOM=80,BGPIOSL=55
