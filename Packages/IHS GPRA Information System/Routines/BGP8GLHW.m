BGP8GLHW ; IHS/CMI/LAB - CRS 27 Apr 2010 10:56 PM 13 Dec 2006 7:35 AM 05 Oct 2017 9:58 AM ;
 ;;18.1;IHS CLINICAL REPORTING;;MAY 25, 2018;Build 66
 ;
 ;
TESTNTL ;
 S ERR=""
 D EP(.ERR,1,2582,"BGP 18 LOCAL HT/WT",597,"","O","P",$$NOW^XLFDT,"lori ht/wt file")
 W !,ERR
 Q
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLLHW^BGP8GLHW",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI LOCAL HT/WT" D ^%ZTLOAD
...
NTLLHW ;
 ...
 ;D HWSF^BGP8DHW
 ;D KITM^BGP8DHW
 D GUIR^BGPXBLM("PRINT^BGP8DHW","^TMP($J,""BGPGUI"",")
