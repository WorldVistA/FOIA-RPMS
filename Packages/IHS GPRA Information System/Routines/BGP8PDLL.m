BGP8PDLL ; IHS/CMI/LAB - print ind 1 ;
...
I1AGE ;EP
 ...
 S X=^BGPINDR(BGPIC,53,1,0) D S(X,3,1) S X=" " D S(X,1,1) D H3 S X=" " D S(X,1,1)
...
I1AGE3 ;
 ...
 S BGPNF=$P(^BGPINDRC(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90560.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
 S $P(BGPDAC(E),U,7)=$$V^BGP8DP1C(1,BGPRPT,N,P),$P(BGPDAC(E),U,8)=$S($P(BGPDAC(E),U,6):($P(BGPDAC(E),U,7)/$P(BGPDAC(E),U,6)*100),1:"")
 S $P(BGPDAP(E),U,7)=$$V^BGP8DP1C(2,BGPRPT,N,P),$P(BGPDAP(E),U,8)=$S($P(BGPDAP(E),U,6):($P(BGPDAP(E),U,7)/$P(BGPDAP(E),U,6)*100),1:"")
 S $P(BGPDAB(E),U,7)=$$V^BGP8DP1C(3,BGPRPT,N,P),$P(BGPDAB(E),U,8)=$S($P(BGPDAB(E),U,6):($P(BGPDAB(E),U,7)/$P(BGPDAB(E),U,6)*100),1:"")
 Q
 ;
I1AGEP ;
 ...
 F X=1:1:7 S V=$P(BGPDAC(X),U,4) S Y=V D S(Y,,X+1)
 S X="% w/ Alcohol-Related Education" D S(X,1,1)
 F X=1:1:7 S V=$P(BGPDAC(X),U,5) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 ;change demon and display
 S X=" " D S(X,1,2) S X="# Active Clinical w/ Alcohol Screening" D S(X,1,1)
 F X=1:1:7 S V=$P(BGPDAC(X),U,6) S Y=V D S(Y,,X+1)
 S X="" D S(X,1,1)
 S X="# w/ Positive Alcohol Screen" D S(X,1,1)
 F X=1:1:7 S V=$P(BGPDAC(X),U,7) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 S X="% w/ Positive Alcohol Screen" D S(X,1,1)
 F X=1:1:7 S V=$P(BGPDAC(X),U,8) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
PR ;
 D S(" ",1,1)
 ...
 S X=" " D S(X,1,1) S X="# w/ Alcohol-Related Education" D S(X,1,1)
 F X=1:1:7 S V=$P(BGPDAP(X),U,4) S Y=V D S(Y,,X+1)
 S X="% w/ Alcohol-Related Education" D S(X,1,1)
 F X=1:1:7 S V=$P(BGPDAP(X),U,5) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 ;change demon and display
 S X=" " D S(X,1,2) S X="# Active Clinical w/ Alcohol Screening" D S(X,1,1)
 F X=1:1:7 S V=$P(BGPDAP(X),U,6) S Y=V D S(Y,,X+1)
 S X="" D S(X,1,1)
 S X="# w/ Positive Alcohol Screen" D S(X,1,1)
 F X=1:1:7 S V=$P(BGPDAP(X),U,7) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 S X="% w/ Positive Alcohol Screen" D S(X,1,1)
 F X=1:1:7 S V=$P(BGPDAP(X),U,8) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
PB ;
 ;percentage changes
 ...
 S X="w/ Alcohol-Related Education" D S(X,1,1)
 F X=1:1:7 S N=$P(BGPDAC(X),U,5),O=$P(BGPDAP(X),U,5) S Y=$$SB($J((N-O),6,1)) D S(Y,,X+1)
 S X="w/ Positive Alcohol Screen" D S(X,1,1)
 F X=1:1:7 S N=$P(BGPDAC(X),U,8),O=$P(BGPDAP(X),U,8) S Y=$$SB($J((N-O),6,1)) D S(Y,,X+1)
BL ;
 ;S X=^BGPINDR(BGPIC,53,1,0) D S(X,1,1) D H3
 ...
 S X=" " D S(X,1,1) S X="# w/ Alcohol-Related Education" D S(X,1,1)
 F X=1:1:7 S V=$P(BGPDAB(X),U,4) S Y=V D S(Y,,X+1)
 S X="% w/ Alcohol-Related Education" D S(X,1,1)
 F X=1:1:7 S V=$P(BGPDAB(X),U,5) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 ;change demon and display
 S X=" " D S(X,1,2) S X="# Active Clinical w/ Alcohol Screening" D S(X,1,1)
 F X=1:1:7 S V=$P(BGPDAB(X),U,6) S Y=V D S(Y,,X+1)
 S X="" D S(X,1,1)
 S X="# w/ Positive Alcohol Screen" D S(X,1,1)
 F X=1:1:7 S V=$P(BGPDAB(X),U,7) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 S X="% w/ Positive Alcohol Screen" D S(X,1,1)
 F X=1:1:7 S V=$P(BGPDAB(X),U,8) S Y=$$SB($J(V,6,1)) D S(Y,,X+1)
 ;percentage changes
 S X=" " D S(X,1,1) S X="CHANGE FROM BASE YR %" D S(X,1,1)
 S X="w/ Alcohol Screening/Dx/Proc-No Refusals or Pt Ed" D S(X,1,1)
 F X=1:1:7 S N=$P(BGPDAC(X),U,3),O=$P(BGPDAB(X),U,3) S Y=$$SB($J((N-O),6,1)) D S(Y,,X+1)
 S X="w/ Alcohol-Related Education" D S(X,1,1)
 F X=1:1:7 S N=$P(BGPDAC(X),U,5),O=$P(BGPDAB(X),U,5) S Y=$$SB($J((N-O),6,1)) D S(Y,,X+1)
 S X="w/ Positive Alcohol Screen" D S(X,1,1)
 F X=1:1:7 S N=$P(BGPDAC(X),U,8),O=$P(BGPDAB(X),U,8) S Y=$$SB($J((N-O),6,1)) D S(Y,,X+1)
 Q
