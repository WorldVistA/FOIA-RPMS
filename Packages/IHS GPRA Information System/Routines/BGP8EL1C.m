BGP8EL1C ;IHS/CMI/LAB - ELDER;
 ;;18.1;IHS CLINICAL REPORTING;;MAY 25, 2018;Build 66
 ;
 ;
I1AGE ;EP  special age tallies
 S BGPHD1="ACTIVE CLINICAL PATIENTS 55+",BGPHD2="Active Clinical"
 D HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPELIR(BGPIC,53,1,0)  D H3
...
PR ; 
 ...
 W !,"B. # Smokeless Tobacco",!," w/ % of of Total Tobacco Users"
...
BL ;
 I $Y>(BGPIOSL-18) D HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPELIR(BGPIC,53,1,0) D H3
...
V(T,R,N,P) ;EP
 I $G(BGPAREAA) G VA
 I T=1 Q $P($G(^BGPEDLCR(R,N)),U,P)
 I T=2 Q $P($G(^BGPEDLPR(R,N)),U,P)
 I T=3 Q $P($G(^BGPEDLBR(R,N)),U,P)
 Q ""
VA ;
