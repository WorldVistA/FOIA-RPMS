...
CALCIND ;EP
 ...
 .K ^TMP($J)
 .I $D(^BGPELIR(BGPIC,1)) X ^BGPELIR(BGPIC,1)
 ...
 .S BGPI=0 F  S BGPI=$O(^BGPELIIR("B",BGPIC,BGPI)) Q:BGPI'=+BGPI  D
 ..S (BGPNUM,BGPDEN)=0
 ..X ^BGPELIIR(BGPI,1)
 ..X ^BGPELIIR(BGPI,2) ;denominator 1 or 0
 ..;set field counter
 ..S BGPNF=$P(^BGPELIIR(BGPI,0),U,9)
 ..S BGPN=$P(^DD(90561.03,BGPNF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
 ..D S(BGPRPT,BGPGBL,N,P,BGPNUM)
 ..S BGPDF=$P(^BGPELIIR(BGPI,0),U,8)
 ..S BGPN=$P(^DD(90561.03,BGPDF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
