BGP7DPE2 ; IHS/CMI/LAB - calc measures 29 Apr 2010 7:38 PM 14 Nov 2006 5:02 PM 09 Jun 2017 5:18 PM 06 May 2017 1:25 PM ;
...
5 ;EP
 ...
 Q
SET51 ;
 I '$D(^BGPPEDCG(BGPRPT,15,0)) S ^BGPPEDCG(BGPRPT,15,0)="^90558.1215A^0^0"
 S Z=$O(^BGPPEDCG(BGPRPT,15,"B",BGPT,0)) I Z D  Q
 .S $P(^BGPPEDCG(BGPRPT,15,Z,0),U,3)=$P(^BGPPEDCG(BGPRPT,15,Z,0),U,3)+1
 S Z=$P(^BGPPEDCG(BGPRPT,15,0),U,3)+1,$P(^BGPPEDCG(BGPRPT,15,0),U,3)=Z,$P(^BGPPEDCG(BGPRPT,15,0),U,4)=Z
 S ^BGPPEDCG(BGPRPT,15,Z,0)=BGPT_U_BGPT1_U_1
 S ^BGPPEDCG(BGPRPT,15,"B",BGPT,Z)=""
 Q
SET52 ;
 I '$D(^BGPPEDPG(BGPRPT,15,0)) S ^BGPPEDPG(BGPRPT,15,0)="^90558.1315A^0^0"
 S Z=$O(^BGPPEDPG(BGPRPT,15,"B",BGPT,0)) I Z D  Q
 .S $P(^BGPPEDPG(BGPRPT,15,Z,0),U,3)=$P(^BGPPEDPG(BGPRPT,15,Z,0),U,3)+1
 S Z=$P(^BGPPEDPG(BGPRPT,15,0),U,3)+1,$P(^BGPPEDPG(BGPRPT,15,0),U,3)=Z,$P(^BGPPEDPG(BGPRPT,15,0),U,4)=Z
 S ^BGPPEDPG(BGPRPT,15,Z,0)=BGPT_U_BGPT1_U_1
 S ^BGPPEDPG(BGPRPT,15,"B",BGPT,Z)=""
 Q
SET53 ;
 I '$D(^BGPPEDBG(BGPRPT,15,0)) S ^BGPPEDBG(BGPRPT,15,0)="^90558.1515A^0^0"
 S Z=$O(^BGPPEDBG(BGPRPT,15,"B",BGPT,0)) I Z D  Q
 .S $P(^BGPPEDBG(BGPRPT,15,Z,0),U,3)=$P(^BGPPEDBG(BGPRPT,15,Z,0),U,3)+1
 S Z=$P(^BGPPEDBG(BGPRPT,15,0),U,3)+1,$P(^BGPPEDBG(BGPRPT,15,0),U,3)=Z,$P(^BGPPEDBG(BGPRPT,15,0),U,4)=Z
 S ^BGPPEDBG(BGPRPT,15,Z,0)=BGPT_U_BGPT1_U_1
 S ^BGPPEDBG(BGPRPT,15,"B",BGPT,Z)=""
 Q
6 ;EP
 Q:'$D(^AUPNVPED("AC",DFN))  ;no education so don't bother
 K BGPALLED,BGPEDPRV S BGPVALUE=""
...
7 ;EP
 ...
 ..I D="" S D="??"
 ..S BGPPROVS(BGPLEVEL,"PROVS")=$G(BGPPROVS(BGPLEVEL,"PROVS"))_"; "_$$DATE^BGP7UTL($$VD^APCLV($P(^AUPNVPED(Y,0),U,3)))     ;"; "_$$VAL^XBDIQ1(200,R,.01)_"-"_D
 S BGPVALUE=""
...
PTG ;now do patient goals stuff
 ...
 .S BGPT="" F  S BGPT=$O(BGPMET(BGPT)) Q:BGPT=""  S BGPC=BGPMET(BGPT) D SET73^BGP7DPE3 S BGPVALU=BGPVALU_$S($P(BGPVALU,"GM:",2)="":"",1:", ")_$P(BGPMET(BGPT),U,2)
 K BGPMAIN
 D MAINTAIN
 I $D(BGPMAIN) D
 .D S(BGPRPT,BGPGBL,11,27,1)
 .S BGPVALU=BGPVALU_$S(BGPVALU]"":"; GMaint:",1:"GMaint:")
 .S BGPT="" F  S BGPT=$O(BGPMAIN(BGPT)) Q:BGPT=""  S BGPC=BGPMAIN(BGPT) D SET74^BGP7DPE3 S BGPVALU=BGPVALU_$S($P(BGPVALU,"GMaint:",2)="":"",1:", ")_$P(BGPMAIN(BGPT),U,2)
 K BGPNMET
 D NOTMET
 I $D(BGPNMET) D
 .D S(BGPRPT,BGPGBL,11,28,1)
 .S BGPVALU=BGPVALU_$S(BGPVALU]"":"; GNM:",1:"GNM:")
 .S BGPT="" F  S BGPT=$O(BGPNMET(BGPT)) Q:BGPT=""  S BGPC=BGPNMET(BGPT) D SET75^BGP7DPE3 S BGPVALU=BGPVALU_$S($P(BGPVALU,"GNM:",2)="":"",1:", ")_$P(BGPNMET(BGPT),U,2)
...
NOTSET ;
 ...
 ..S $P(BGPNSET(Z),U,2)=$P(BGPNSET(Z),U,2)_$S($P(BGPNSET(Z),U,2)]"":",",1:"")_" "_$$DATE^BGP7UTL(D)_" - "_Z
 Q
MAINTAIN ;
 NEW D,%,X,Y,G
 S X=0,%="",G=0
 ...
 ..S $P(BGPMAIN(Z),U,2)=$P(BGPMAIN(Z),U,2)_$S($P(BGPMAIN(Z),U,2)]"":",",1:"")_" "_$$DATE^BGP7UTL(D)_" - "_Z
 ..Q
 Q
NOTMET ;
 NEW D,%,X,Y,G
 ...
 ..S $P(BGPNMET(Z),U,2)=$P(BGPNMET(Z),U,2)_$S($P(BGPNMET(Z),U,2)]"":",",1:"")_" "_$$DATE^BGP7UTL(D)_" - "_Z
 ..Q
 Q
MET ;
 NEW D,%,X,Y
 ...
 ..S $P(BGPMET(Z),U,2)=$P(BGPMET(Z),U,2)_$S($P(BGPMET(Z),U,2)]"":",",1:"")_" "_$$DATE^BGP7UTL(D)_" - "_Z
 ..Q
 Q
SET ;
 NEW X,Y,Z,%,D
 ...
 ..S $P(BGPSET(Z),U,2)=$P(BGPSET(Z),U,2)_$S($P(BGPSET(Z),U,2)]"":",",1:"")_" "_$$DATE^BGP7UTL(D)_" - "_Z
 Q
SET71 ;
 I BGPTIME=2 D SET71P Q
 I BGPTIME=3 D SET71B Q
 I '$D(^BGPPEDCG(BGPRPT,16,0)) S ^BGPPEDCG(BGPRPT,16,0)="^90558.1216A^0^0"
 S Z=$O(^BGPPEDCG(BGPRPT,16,"B",BGPT,0)) I Z D  Q
 .S $P(^BGPPEDCG(BGPRPT,16,Z,0),U,3)=$P(^BGPPEDCG(BGPRPT,16,Z,0),U,3)+BGPC
 S Z=$P(^BGPPEDCG(BGPRPT,16,0),U,3)+BGPC,$P(^BGPPEDCG(BGPRPT,16,0),U,3)=Z,$P(^BGPPEDCG(BGPRPT,16,0),U,4)=Z
 S ^BGPPEDCG(BGPRPT,16,Z,0)=BGPT_U_BGPT_U_BGPC
 S ^BGPPEDCG(BGPRPT,16,"B",BGPT,Z)=""
 Q
SET71P ;
 I '$D(^BGPPEDPG(BGPRPT,16,0)) S ^BGPPEDPG(BGPRPT,16,0)="^90558.1316A^0^0"
 S Z=$O(^BGPPEDPG(BGPRPT,16,"B",BGPT,0)) I Z D  Q
 .S $P(^BGPPEDPG(BGPRPT,16,Z,0),U,3)=$P(^BGPPEDPG(BGPRPT,16,Z,0),U,3)+1
 S Z=$P(^BGPPEDPG(BGPRPT,16,0),U,3)+1,$P(^BGPPEDPG(BGPRPT,16,0),U,3)=Z,$P(^BGPPEDPG(BGPRPT,16,0),U,4)=Z
 S ^BGPPEDPG(BGPRPT,16,Z,0)=BGPT_U_BGPT_U_1
 S ^BGPPEDPG(BGPRPT,16,"B",BGPT,Z)=""
 Q
SET71B ;
 I '$D(^BGPPEDBG(BGPRPT,16,0)) S ^BGPPEDBG(BGPRPT,16,0)="^90558.1416A^0^0"
 S Z=$O(^BGPPEDBG(BGPRPT,16,"B",BGPT,0)) I Z D  Q
 .S $P(^BGPPEDBG(BGPRPT,16,Z,0),U,3)=$P(^BGPPEDBG(BGPRPT,16,Z,0),U,3)+1
 S Z=$P(^BGPPEDBG(BGPRPT,16,0),U,3)+1,$P(^BGPPEDBG(BGPRPT,16,0),U,3)=Z,$P(^BGPPEDBG(BGPRPT,16,0),U,4)=Z
 S ^BGPPEDBG(BGPRPT,16,Z,0)=BGPT_U_BGPT_U_1
 S ^BGPPEDBG(BGPRPT,16,"B",BGPT,Z)=""
 Q
SET72 ;
 I BGPTIME=2 D SET72P Q
 I BGPTIME=3 D SET72B Q
 I '$D(^BGPPEDCG(BGPRPT,17,0)) S ^BGPPEDCG(BGPRPT,17,0)="^90558.1217A^0^0"
 S Z=$O(^BGPPEDCG(BGPRPT,17,"B",BGPT,0)) I Z D  Q
 .S $P(^BGPPEDCG(BGPRPT,17,Z,0),U,3)=$P(^BGPPEDCG(BGPRPT,17,Z,0),U,3)+BGPC
 S Z=$P(^BGPPEDCG(BGPRPT,17,0),U,3)+BGPC,$P(^BGPPEDCG(BGPRPT,17,0),U,3)=Z,$P(^BGPPEDCG(BGPRPT,17,0),U,4)=Z
 S ^BGPPEDCG(BGPRPT,17,Z,0)=BGPT_U_BGPT_U_BGPC
 S ^BGPPEDCG(BGPRPT,17,"B",BGPT,Z)=""
 Q
SET72P ;
 I '$D(^BGPPEDPG(BGPRPT,17,0)) S ^BGPPEDPG(BGPRPT,17,0)="^90558.1317A^0^0"
 S Z=$O(^BGPPEDPG(BGPRPT,17,"B",BGPT,0)) I Z D  Q
 .S $P(^BGPPEDPG(BGPRPT,17,Z,0),U,3)=$P(^BGPPEDPG(BGPRPT,17,Z,0),U,3)+1
 S Z=$P(^BGPPEDPG(BGPRPT,17,0),U,3)+1,$P(^BGPPEDPG(BGPRPT,17,0),U,3)=Z,$P(^BGPPEDPG(BGPRPT,17,0),U,4)=Z
 S ^BGPPEDPG(BGPRPT,17,Z,0)=BGPT_U_BGPT_U_1
 S ^BGPPEDPG(BGPRPT,17,"B",BGPT,Z)=""
 Q
SET72B ;
 I '$D(^BGPPEDBG(BGPRPT,17,0)) S ^BGPPEDBG(BGPRPT,17,0)="^90558.1417A^0^0"
 S Z=$O(^BGPPEDBG(BGPRPT,17,"B",BGPT,0)) I Z D  Q
 .S $P(^BGPPEDBG(BGPRPT,17,Z,0),U,3)=$P(^BGPPEDBG(BGPRPT,17,Z,0),U,3)+1
 S Z=$P(^BGPPEDBG(BGPRPT,17,0),U,3)+1,$P(^BGPPEDBG(BGPRPT,17,0),U,3)=Z,$P(^BGPPEDBG(BGPRPT,17,0),U,4)=Z
 S ^BGPPEDBG(BGPRPT,17,Z,0)=BGPT_U_BGPT_U_1
 S ^BGPPEDBG(BGPRPT,17,"B",BGPT,Z)=""
 Q
