BGP8DADB ;IHS/CMI/LAB - MEASURE LOGIC;
...
INTRO ;
 D EXIT
 W !,"IHS 2018 Area GPRA Dashboard"
...
TP ;
 ...
 S BGPPED=($E(BGPED,1,3)-1)_$E(BGPED,4,7),BGPDASHP=$E(BGPPED,1,3)_"0000",BGPDASHY=$E(BGPED,1,3)_"0000"
NT ;END TEST STUFF
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP8DADB",ZTDTH="",ZTDESC="GPRA REPORT" D ^%ZTLOAD D HOME^%ZIS D EXIT Q
 Q
 ;
EXIT ;
 D ^%ZISC
 ...
 Q
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP8DADB",XBRX="EXIT^BGP8DADB",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
FY ;calendar year
 ...
 I $D(DIRUT) Q
 I $D(DUOUT) S DIRUT=1 Q
 I Y'=3170000,Y'=3180000 W !,"Must be 2018 or 2019" G F
 S BGPVDT=Y
 I $E(Y,4,7)'="0000" W !!,"Please enter a year only!",! G F
 S BGPPER=BGPVDT
