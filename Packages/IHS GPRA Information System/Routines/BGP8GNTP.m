BGP8GNTP ; IHS/CMI/LAB - BGP 18 DESIGNATED PROVIDER REPORT 27 Apr 2010 10:56 PM 13 Dec 2006 7:35 AM ;
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP8GNTP",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA REPORT 15" D ^%ZTLOAD
