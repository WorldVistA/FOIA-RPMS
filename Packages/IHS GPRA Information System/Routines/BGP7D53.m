BGP7D53 ; IHS/CMI/LAB - measure calc ;
...
IK ;EP
 ...
 S BGPVALUE=$S(BGPD2:"UP",1:"")_$S(BGPD1:",AC",1:"")_"|||"_$S(BGPN1:$P(BGPNV,U,3)_" "_$P(BGPNV,U,2),BGPN2:$P(BGPREF,U,3)_" "_$P(BGPREF,U,2),1:"")
...
CHL(P,BDATE,EDATE) ;EP
 ...
 I $D(BGPG(1)) Q 1_U_$$DATE^BGP7UTL($P(BGPG(1),U))_U_$P(BGPG(1),U,2)
 ;check cpt taxonomy
 S T=$O(^ATXAX("B","BGP CHLAMYDIA CPTS",0))
 I T D  I X Q 1_U_"CPT "_$P(X,U,3)_U_$$DATE^BGP7UTL($P(X,U,2))
 ...
 ...S BGPC=1_U_"Lab Test "_U_$$DATE^BGP7UTL((9999999-D))
 ...Q
 I BGPC Q BGPC
 ...
 ...Q:'$D(^AUPNVMIC(X,0))
 ...I BGPLT,$P(^AUPNVMIC(X,0),U),$D(^ATXLAB(BGPLT,21,"B",$P(^AUPNVMIC(X,0),U))) S BGPC=1_U_"Micro test"_U_$$DATE^BGP7UTL((9999999-D)) Q
 ...Q:'T
 ...S J=$P($G(^AUPNVMIC(X,11)),U,13) Q:J=""
 ...Q:'$$LOINC(J,T)
 ...S R=$P(^AUPNVMIC(X,0),U,4)
 ...S BGPC=1_U_"Micro Test "_U_$$DATE^BGP7UTL((9999999-D))
 ...Q
 Q BGPC
LOINC(A,B) ;
 NEW %
...
REFCHL(P,BDATE,EDATE) ;refusal for chlamydia
 NEW T,BGPT,G,BGPT1
 S T=$$CPTREFT^BGP7UTL1(P,BDATE,EDATE,$O(^ATXAX("B","BGP CHLAMYDIA CPTS",0)),"R")
 I T S T="1^"_"Refused CPT "_$P(T,U,4)_U_$$DATE^BGP7UTL($P(T,U,2)) Q T
 S BGPT=$O(^ATXLAB("B","BGP CHLAMYDIA TESTS TAX",0))
 I BGPT D  I $P(G,U) Q "1^"_"Refused Lab "_U_$$DATE^BGP7UTL($P(G,U,2))
