BGP8PC64 ; IHS/CMI/LAB - measure I2 ; 02 Feb 2018  11:25 AM
 ;;18.1;IHS CLINICAL REPORTING;**1**;MAY 25, 2018;Build 65
 ;
HEPB(P) ;
 NEW A730,X,Y,Z,TCVX,TCPT,C,BGPIMMS,D,V,BGPZ
 S TCVX=$O(^ATXAX("B","BGP IPC HEPB CVX CODES",0))
 S TCPT=$O(^ATXAX("B","BGP IPC HEPB CPT CODES",0))
 ...
 .S X=$$ANHEPB(P,BGPZ,A730)
 I X]"" Q 1_U_"HEPB CONTRA ANAPHYLACTIC/NEOMYCIN"
 S X=$$ANSNHEPB(P,A730) I X Q 1_U_"HEPB CONTRA ANAPHYLACTIC REACTION"
 S X=$$EVIDHEPB(P,A730) I X Q 1_U_"EVIDENCE OF HEPB"
 Q ""
ANSNHEPB(P,EDATE) ;
 ...
 .I S=428321000124101 S I=1 Q
 .I S=34015007 S I=1 Q
 .I S=419447004 S I=1 Q
 .Q
 I I Q I
 ;NOW V POV SNOMED
...
EVIDHEPB(P,EDATE) ;
 ...
 I $$PLTAXND^BGP8DU(P,"BGP IPC HEP B DXS",EDATE,0) Q 1
 I $$IPLSNOND^BGP8DU(P,"PXRM BGP IPC HEP B EVID",EDATE,0) Q 1
 I $$LASTDX^BGP8UTL1(P,"BGP IPC HEP B DXS",$$DOB^AUPNPAT(P),EDATE) Q 1
 ;NOW V POV SNOMED
 ;NOW SNOMED USING ASNC
 S T="PXRM BGP IPC HEP B EVID"
 S G=""
...
MLT ;
 ...
 ...I R'<1.10 S ME=1
 ...Q
 I 'ME Q ""  ;since no HEP B and have to have all 3 might as well quit now
 Q ""
LOINCHEP(A) ;is this a HEP B loinc code
 NEW %
