BGP7DPP ; IHS/CMI/LAB - IHS GPRA 16 SELECTED REPORT DRIVER ALL PATIENTS 29 Apr 2017 8:36 PM ;
 ;;17.1;IHS CLINICAL REPORTING;;MAY 10, 2017;Build 29
 ;
 ;
 W:$D(IOF) @IOF
 W !!,$$CTR("2017 Clinical Performance Measure Report (Selected Measures)",80)
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP7DPP",ZTDTH="",ZTDESC="GPRA 16 REPORT" D ^%ZTLOAD D XIT Q
 Q
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP7DPP",XBRX="XIT^BGP7DPP",XBNS="BGP"
 D ^XBDBQUE
 ;D XIT
 Q
 ;
