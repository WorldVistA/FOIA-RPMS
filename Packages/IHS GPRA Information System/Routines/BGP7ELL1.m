BGP7ELL1 ; IHS/CMI/LAB - print ind 1 20 Jan 2017 4:52 PM ; 
...
PI ;EP
 ...
 ;S BGPPC2=0 F  S BGPPC2=$O(^BGPELIIG("AB",BGPPC1,BGPPC2)) Q:BGPPC2=""  S BGPPC=$O(^BGPELIIG("AB",BGPPC1,BGPPC2,0)) D PI1
 Q
PI1 ;
 ...
 .Q:$G(BGPNODEN)
 .S Y=$$LABELE^BGP7UTL1(BGPPC,BGPRTYPE,BGPPTYPE,"D") D S(Y,1,1)
 ...
 S Y=" " D S(Y,1,1)
 S Y=$$LABELE^BGP7UTL1(BGPPC,BGPRTYPE,BGPPTYPE,"N") D S(Y,1,1)
 D H2^BGP7ELL2
 Q
