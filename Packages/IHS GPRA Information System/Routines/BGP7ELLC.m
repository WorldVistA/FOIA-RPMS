BGP7ELLC ; IHS/CMI/LAB - print ind ;
...
I1AGE ;EP
 ...
 K BGPDAC,BGPDAP,BGPDAB S (C,D,E,F,G,H,I,J,K)=0 F BGPX="CMB.1","CMB.2","CMB.3","CMB.4" D I1AGE1,I1AGE2
 D I1AGEP
 Q
I1AGE1 ;
 S C=C+1
...
CALC(N,O) ;
 ...
 Q Z
H3 ;EP
 S X="Cancer Screening: Mammogram Rates" D S(X,1,1) S Y=" " D S(Y,1,1) S X=BGPHD1 D S(X,1,1) S Y=" " D S(Y,1,1)
