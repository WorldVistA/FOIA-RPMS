...
FLU(P) ;
 ...
 .S X=$$ANFLU(P,BGPZ,A730)
 I X]"" Q 1_U_"FLU CONTRA ANAPHYLACTIC/NEOMYCIN"
 S X=$$ANSNFLU(P,A730) I X Q 1_U_"FLU CONTRA ANAPHYLACTIC REACTION"
 S X=$$DIS(P,A730) I X Q 1_U_"FLU CONTRA DIS IMMUNE SYS"
 S X=$$HIV(P,A730) I X Q 1_U_"FLU CONTRA HIV"
 S X=$$MNLHT(P,A730) I X Q 1_U_"FLU CONTRA NEOPLASM"
 Q ""
ANSNFLU(P,EDATE) ;
 ...
 .I I'=292927007,I'=420113004 Q   ;IF IT'S SNOMED, MUST BE THAT ONE
...
EVIDFLU(P,EDATE) ;
 ...
 I $$IPLSNOND^BGP8DU(P,"PXRM BGP IPC FLU EVID",EDATE,0) Q 1
 I $$LASTDX^BGP8UTL1(P,"BGP IPC VARICELLA DXS",$$DOB^AUPNPAT(P),EDATE) Q 1
 ;NOW V POV SNOMED
 ;NOW SNOMED USING ASNC
 S T="PXRM BGP IPC FLU EVID"
 S G=""
