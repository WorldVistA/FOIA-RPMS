BGP7UTLC ; IHS/CMI/LAB - UTILITIES ;
...
GNT3 ;EP - area export file
 ...
 U IO
 S BGPP=0,BGPY=$O(^BGPCTRL("B","2017",0)),BGPX="",BGPEC=$P(^BGPCTRL(BGPY,0),U,27)
...
GNT4 ;
 ...
 I Y=1 W:'$D(ZTQUEUED) !!,"Cannot open host file." Q
 U IO
 S BGPP=0,BGPY=$O(^BGPCTRL("B","2017",0)),BGPX="",BGPEC=$P(^BGPCTRL(BGPY,0),U,29)
...
GNT5 ;
 ...
 I Y=1 W:'$D(ZTQUEUED) !!,"Cannot open host file." Q
 U IO
 S BGPP=0,BGPY=$O(^BGPCTRL("B","2017",0)),BGPX="",BGPEC=$P(^BGPCTRL(BGPY,0),U,31)
...
DEV ;EP - area export file
 ...
 I Y=1 W:'$D(ZTQUEUED) !!,"Cannot open host file." Q
 U IO
 S BGPP=0,BGPY=$O(^BGPCTRL("B","2017",0)),BGPX="",BGPEC=$P(^BGPCTRL(BGPY,0),U,22)
...
DEV2 ;
 ...
 I Y=1 W:'$D(ZTQUEUED) !!,"Cannot open host file." Q
 U IO
 S BGPP=0,BGPY=$O(^BGPCTRL("B","2017",0)),BGPX="",BGPEC=$P(^BGPCTRL(BGPY,0),U,23)
...
DEV3 ;
 ...
 I Y=1 W:'$D(ZTQUEUED) !!,"Cannot open host file." Q
 U IO
 S BGPP=0,BGPY=$O(^BGPCTRL("B","2017",0)),BGPX="",BGPEC=$P(^BGPCTRL(BGPY,0),U,24)
...
GNT6 ;
 ...
 I Y=1 W:'$D(ZTQUEUED) !!,"Cannot open host file." Q
 U IO
 S BGPP=0,BGPY=$O(^BGPCTRL("B","2017",0)),BGPX="",BGPEC=$P(^BGPCTRL(BGPY,0),U,28)
