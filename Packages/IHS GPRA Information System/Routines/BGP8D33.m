...
OPV(P,EDATE) ;EP
 ...
 ;I $$PLTAX^BGP8DU(P,"BGP OPV CONTRAINDICATONS") Q 4_U_"Contra Polio"
 ;F BGPZ=2,89 S X=$$ANCONT^BGP8D31(P,BGPZ,EDATE) Q:X]""
...
MMRC ;K BGPG S %=P_"^LAST DX [BGP MMR CONTRAINDICATIONS;DURING "_$$DOB^AUPNPAT(P)_"-"_EDATE,E=$$START1^APCLDF(%,"BGPG(")
 ...
 ;I $$PLTAX^BGP8DU(P,"BGP MMR CONTRAINDICATIONS") Q 4_U_"Contra MMR"
...
MEX ;
 ...
 ;I $$PLTAX^BGP8DU(P,"BGP MEASLES EVIDENCE") S BGPME=4
...
MUX ;
 ...
 I $$PLTAX^BGP8DU(P,"BGP MUMPS EVIDENCE") S BGPMU=4
 I BGPMU=0 D
 .S B=$$DOB^AUPNPAT(P),E=EDATE
 .F BGPIMM=7 D
 ..S I=$O(^AUTTIMM("C",BGPIMM,0)) Q:'I
...
RUBX ;
 ...
 ;I $$PLTAX^BGP8DU(P,"BGP RUBELLA EVIDENCE") S BGPRUB=4
