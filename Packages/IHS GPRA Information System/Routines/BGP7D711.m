BGP7D711 ; IHS/CMI/LAB - measure C 30 Jun 2010 12:14 PM ;
...
SPECNUTR(P,BDATE,EDATE) ;EP
 ...
 .I $P(S,U,1)'="-1",$$ICD^BGP7UTL2($P(S,U,1),$O(^ATXAX("B","BGP DIETARY SURVEILLANCE DXS",0)),9) S %=$P(BGPALLED(X),U)_U_T_" SN" Q
...
OTHREL(P,BDATE,EDATE) ;EP
 ...
 S Y="BGPALLED("
 S X=P_"^ALL EDUC;DURING "_$$FMTE^XLFDT(BDATE)_"-"_$$FMTE^XLFDT(EDATE) S E=$$START1^APCLDF(X,Y)
 S SN=$O(^BGPSNOMG("B","OTHER NUTRITION PATIENT ED",0))
 S (X,D)=0,%="",T="" F  S X=$O(BGPALLED(X)) Q:X'=+X!(%]"")  D
 .S T=$P(^AUPNVPED(+$P(BGPALLED(X),U,4),0),U)
 .Q:'T
 .Q:'$D(^AUTTEDT(T,0))
 ...
 .S S=$P(T,"-",1)
 .S S=$$ICDDX^BGP7UTL2(S)
 .I $P(S,U,1)'="-1",$$ICD^BGP7UTL2($P(S,U,1),$O(^ATXAX("B","BGP OTHER REL WT EDUC DXS",0)),9) S %=$P(BGPALLED(X),U)_U_T Q
 .I S="S9449"!(S="S9451")!(S="S9452")!(S="S9470") S %=$P(BGPALLED(X),U)_U_T Q
 .I $P(T,"-",1)]"",$D(^BGPSNOMG(SN,11,"B",$P(T,"-",1))) S %=$P(BGPALLED(X),U)_U_T Q
 I % Q %
 ;NOW CHECK V CPT
  S %=$$CPT^BGP7DU(P,BDATE,EDATE,$O(^ATXAX("B","BGP OTHER REL EDUC CPTS",0)),5)
  Q %
MEDNUTRD(P,BDATE,EDATE) ;EP
 K ^TMP($J)
 NEW E,%,X,Y,D,Z,W,BGPG,BGPC
 K BGPG,BGPC
 S E=+$$CODEN^ICPTCOD(97802),%=$$CPTI^BGP7DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^97802"
 S E=+$$CODEN^ICPTCOD(97803),%=$$CPTI^BGP7DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^97803"
 S E=+$$CODEN^ICPTCOD(97804),%=$$CPTI^BGP7DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^97804"
 S E=+$$CODEN^ICPTCOD("G0270"),%=$$CPTI^BGP7DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^G0270"
 S E=+$$CODEN^ICPTCOD("G0271"),%=$$CPTI^BGP7DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^G0271"
 ;TRAN CODES
 S E=+$$CODEN^ICPTCOD(97802),%=$$TRANI^BGP7DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^97802"
 S E=+$$CODEN^ICPTCOD(97803),%=$$TRANI^BGP7DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)-"^97803"
 S E=+$$CODEN^ICPTCOD(97804),%=$$TRANI^BGP7DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^97804"
 S E=+$$CODEN^ICPTCOD("G0270"),%=$$TRANI^BGP7DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^G0270"
 S E=+$$CODEN^ICPTCOD("G0271"),%=$$TRANI^BGP7DU(P,BDATE,EDATE,E) I %]"" Q $P(%,U,2)_"^G0271"
...
PED(P,BDATE,EDATE,FORE) ;EP
 ...
 .S SN=$O(^BGPSNOMG("B","TOBACCO CESSATION PATIENT ED",0))
 .S (X,D)=0,T="" F  S X=$O(BGPALLED(X)) Q:X'=+X  D
 ..S T=$P(^AUPNVPED(+$P(BGPALLED(X),U,4),0),U)
 ..Q:'T
 ..Q:'$D(^AUTTEDT(T,0))
 ...
 ..I $P(T,"-")]"",$D(^BGPSNOMG(SN,11,"B",$P(T,"-"))) S %=$P(BGPALLED(X),U)_U_T Q
 ...
 ..S S=$P(T,"-",1)
 ..S S=$$ICDDX^BGP7UTL2(S)
 ..I $P(S,U,1)'="-1",$$ICD^BGP7UTL2($P(S,U,1),$O(^ATXAX("B","BGP TOBACCO DXS",0)),9) S %=$P(BGPALLED(X),U)_U_T Q
 ...
 .Q
 ;I G]"" Q G
 S G=$$CPTI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("D1320")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"CPT D1320"
 S G=$$TRANI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("D1320")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"TRAN D1320"
 S G=$$CPTI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD(99406)) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"CPT 99406"
 S G=$$TRANI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD(99406)) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"TRAN 99406"
 S G=$$CPTI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD(99407)) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"CPT 99407"
 S G=$$TRANI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD(99407)) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"TRAN 99407"
 S G=$$CPTI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G0375")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"CPT G0375"
 S G=$$CPTI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G0376")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"CPT G0376"
 S G=$$CPTI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("4000F")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"CPT 4000F"
 S G=$$TRANI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G0375")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"TRAN G0375"
 S G=$$TRANI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G0376")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"TRAN G0376"
 S G=$$TRANI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("4000F")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"TRAN 4000F"
 S G=$$CPTI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("4001F")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"CESSATION MED - CPT 4001F"
 S G=$$TRANI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("4001F")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"TRAN 4001F"
 S G=$$CPTI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G8402")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"CPT G8402"
 S G=$$TRANI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G8402")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"TRAN G8402"
 S G=$$CPTI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G8453")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"CPT G8453"
 S G=$$TRANI^BGP7DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G8453")) I G,$P(BGPLPED,U)<$P(G,U,2) S BGPLPED=$P(G,U,2)_U_"TRAN G8453"
 ...
 .I $$VAPI^BGP7D81(Z,T1) I $P(BGPLPED,U)<$P($P(^AUPNVSIT(V,0),U),".") S BGPLPED=$P($P(^AUPNVSIT(V,0),U),".")_U_"CESSATION MED - "_N
 Q BGPLPED
