BGP7D36 ; IHS/CMI/LAB - measure C 06 Nov 2009 2:03 PM 28 May 2015 4:23 PM ;
...
MEN(P,EDATE) ;EP
 ...
 F BGPZ=32,108,114,136,147 S X=$$ANCONT^BGP7D31(P,BGPZ,EDATE) Q:X]""
 ...
 ;F BGPIMM=32,108,114,136,147 S R=$$IMMREF^BGP7D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
...
HPV(P,EDATE) ;EP
 ...
 ;now check Refusals in imm pkg
 ;F BGPIMM=62,118 S R=$$IMMREF^BGP7D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
 ;I R Q $S(BGPNMI:4,1:3)_U_$S(BGPNMI:"NMI",1:"Ref")_" HPV"
 F BGPZ=62,118,137,165 S X=$$ANCONT^BGP7D31(P,BGPZ,EDATE) Q:X]""
