BGP7D63 ; IHS/CMI/LAB - measure 31 01 Jul 2010 7:47 PM 11 Jun 2017 5:56 PM ;
...
FOB(P,BDATE,EDATE) ;EP
 ...
 I $D(BGPG(1)),$P(BGPLFOB,U,2)<$P(BGPG(1),U,1) S BGPLFOB="POV "_$P(BGPG(1),U,2)_"^"_$P(BGPG(1),U)
 Q BGPLFOB
 ;
LOINC(A,B) ;
 NEW %
