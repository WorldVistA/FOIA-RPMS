BGP8GLTX ; IHS/CMI/LAB - CRS ;
 ;;18.1;IHS CLINICAL REPORTING;;MAY 25, 2018;Build 66
 ;
 ;
TESTCMP ;
 S ERR=""
 D EP(.ERR,1,2522,"BGP 18 LAB TAX REPORT",$$NOW^XLFDT)
 W !,ERR
 Q
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="LTX^BGP8GLTX",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI LAB TAXONOMY REPORT" D ^%ZTLOAD
 D UPLOG^BGP8GUA(BGPGIEN,ZTSK)
 Q
LTX ;
 K ^TMP($J,"BGPGUI")
 S IOM=80,BGPIOSL=55
 D @$S(BGPRT=1:"GPRA^BGP8DLT",BGPRT=7:"ONM^BGP8DLT",BGPRT=2:"CRS^BGP8DLT",BGPRT=4:"ELDER^BGP8DLT",BGPRT=3:"HEDIS^BGP8DLT",BGPRT=5:"CMS^BGP8DLT",BGPRT=8:"IPC^BGP8DLT")  ;cmi/maw added 10/30/2010
 D GUIR^BGPXBLM("PRINT^BGP8DLT","^TMP($J,""BGPGUI"",")
...
XIT ;
 K ^TMP($J)
 ;D EN^XBVK("BGP")  ;done in LABTAXC^BGP8GU
 S:$D(ZTQUEUED) ZTREQ="@"
