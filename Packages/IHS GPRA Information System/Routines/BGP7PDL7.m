BGP7PDL7 ; IHS/CMI/LAB - print ind 1 ;
...
I023 ;EP
 ...
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".8.1E",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".8.2E",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".8.3E",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".9.1E",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".9.2E",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".9.3E",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".10.1E",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".10.2E",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".10.3E",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".8.1F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".8.2F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".8.3F",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".9.1F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".9.2F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".9.3F",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".10.1F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".10.2F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".10.3F",0)) D PI1^BGP7PDL1
 I BGPRTYPE=4,BGPINDG="E" D  Q
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".8.1F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".8.2F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".8.3F",0)) D PI1^BGP7PDL1
 .S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".8.4F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".8.5F",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".9.1F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".9.2F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".9.3F",0)) D PI1^BGP7PDL1
 .S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".9.4F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".9.5F",0)) D PI1^BGP7PDL1
 .S BGPDENP=0 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".10.1F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".10.2F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".10.3F",0)) D PI1^BGP7PDL1
 .S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".10.4F",0)) D PI1^BGP7PDL1 S BGPPC=$O(^BGPINDGC("OR",BGPORXX_".10.5F",0)) D PI1^BGP7PDL1
 F BGPPC1=BGPORXX_".1",BGPORXX_".2",BGPORXX_".3",BGPORXX_".4" D PI^BGP7PDL1
 F BGPPC1=BGPORXX_".5",BGPORXX_".6",BGPORXX_".7" D PI^BGP7PDL1
 ;F BGPPC1=BGPORXX_".4" D PI^BGP7PDL1
 D I1AGE
 Q
I1AGE ;EP
 Q:BGPRTYPE'=4
 ...
 ;S X=^BGPINDG(BGPIC,53,1,0) D S(X,2,1) S X=" " D S(X,1,1) D H3 S X=" " D S(X,1,1)
 S X=" " D S(X,2,1) D H3 S X=" " D S(X,1,1)
 ...
 S X=" " D S(X,1,1) D S(" ",1,1) S X=BGPHD1 D S(X,1,1) D H3
...
I1AGE1 ;
 S C=C+1
 S BGPF="032."_BGPX_".1" S BGPPC=$O(^BGPINDGC("C",BGPF,0))
...
I1AGE2 ;
 S D=D+1
 S BGPF="032."_BGPX_".2" S BGPPC=$O(^BGPINDGC("C",BGPF,0))
...
I1AGE3 ;
 S BGPF="032."_BGPX_".3" S BGPPC=$O(^BGPINDGC("C",BGPF,0))
 ;set 6th piece to numerator and 7th to %
 S BGPNF=$P(^BGPINDGC(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90558.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
 S $P(BGPDAC(D),U,6)=$$V^BGP7DP1C(1,BGPRPT,N,P),$P(BGPDAC(D),U,7)=$S($P(BGPDAC(D),U,4):($P(BGPDAC(D),U,6)/$P(BGPDAC(D),U,4)*100),1:"")
 S $P(BGPDAP(D),U,6)=$$V^BGP7DP1C(2,BGPRPT,N,P),$P(BGPDAP(D),U,7)=$S($P(BGPDAP(D),U,4):($P(BGPDAP(D),U,6)/$P(BGPDAP(D),U,4)*100),1:"")
 S $P(BGPDAB(D),U,6)=$$V^BGP7DP1C(3,BGPRPT,N,P),$P(BGPDAB(D),U,7)=$S($P(BGPDAB(D),U,4):($P(BGPDAB(D),U,6)/$P(BGPDAB(D),U,4)*100),1:"")
I1AGE4 ;
 S BGPF="032."_BGPX_".4" S BGPPC=$O(^BGPINDGC("C",BGPF,0))
 ;set 8th piece to numerator and 9th to %
 S BGPNF=$P(^BGPINDGC(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90558.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
 S $P(BGPDAC(D),U,8)=$$V^BGP7DP1C(1,BGPRPT,N,P),$P(BGPDAC(D),U,9)=$S($P(BGPDAC(D),U,4):($P(BGPDAC(D),U,8)/$P(BGPDAC(D),U,4)*100),1:"")
 S $P(BGPDAP(D),U,8)=$$V^BGP7DP1C(2,BGPRPT,N,P),$P(BGPDAP(D),U,9)=$S($P(BGPDAP(D),U,4):($P(BGPDAP(D),U,8)/$P(BGPDAP(D),U,4)*100),1:"")
 S $P(BGPDAB(D),U,8)=$$V^BGP7DP1C(3,BGPRPT,N,P),$P(BGPDAB(D),U,9)=$S($P(BGPDAB(D),U,4):($P(BGPDAB(D),U,8)/$P(BGPDAB(D),U,4)*100),1:"")
I1AGE5 ;
 G I1AGE6
 S BGPF="032."_BGPX_".5" S BGPPC=$O(^BGPINDGC("C",BGPF,0))
...
I1AGE6 ;
 S BGPF="032."_BGPX_".6" S BGPPC=$O(^BGPINDGC("C",BGPF,0))
...
H3 ;EP
 ...
 S X="Age Distribution" D S(X,3,1) S X=" " D S(X,1,1)
 S Y=" 5-13" D S(Y,1,2)
 S Y="14-17" D S(Y,,3)
 S Y="18-24" D S(Y,,4)
 S Y="25-44" D S(Y,,5)
