BGP8EL1J ; IHS/CMI/LAB - print ind 1 05 Feb 2018 1:41 PM ;
 ;;18.0;IHS CLINICAL REPORTING;;NOV 21, 2017;Build 51
 ;
 ;
I1AGE ;EP  special age tallies
 S BGPHD1="ACTIVE CLINICAL PATIENTS",BGPHD2="Active Clinical Patients"
 D HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPELIR(BGPIC,53,1,0)  D H3
 K BGPDAC,BGPDAP,BGPDAB S (C,D,E,F,G,H,I,J,K)=0 F BGPX="FSD.1","FSD.2","FSD.3","FSD.4" D I1AGE1
 D I1AGEP
MALE ;
 S BGPHD1="MALE ACTIVE CLINICAL PATIENTS 55+",BGPHD2="Male Active Clinical Pts"
 D HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPELIR(BGPIC,53,1,0)  D H3
 K BGPDAC,BGPDAP,BGPDAB S (C,D,E,F,G,H,I,J,K)=0 F BGPX="FSE.1","FSE.2","FSE.3","FSE.4" D I1AGE1
 D I1AGEP
FEMALE ;
 S BGPHD1="FEMALE ACTIVE CLINICAL PATIENTS 55+",BGPHD2="Female Active Clinical Pts"
 D HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPELIR(BGPIC,53,1,0)  D H3
 K BGPDAC,BGPDAP,BGPDAB S (C,D,E,F,G,H,I,J,K)=0 F BGPX="FSF.1","FSF.2","FSF.3","FSF.4" D I1AGE1
 D I1AGEP
 Q
I1AGE1 ;
 ;gather up all #'s
...
I1AGEP ;
 ...
 W !,"# w/ Functional Status",!," Screening"
