BGP8GNTS ; IHS/CMI/LAB - CRS 27 Apr 2010 10:56 PM 13 Dec 2006 7:35 AM ;
 ;;18.1;IHS CLINICAL REPORTING;**1**;MAY 25, 2018;Build 65
 ;
 ;
TESTNTL ;
 S ERR=""
 D EPSUM(.ERR,1,2582,"BGP 18 NATIONAL GPRA RPT SUM",597,0,"B",$$NOW^XLFDT)
 W !,ERR
 Q
EPSUM(BGPRET,BGPUSER,BGPDUZ2,BGPOPTN,BGPTAXI,BGPEXPT,BGPROT,BGPRTIME,BGPMFITI,BGPYWCHW,BGPONEF,BGPSUMON,BGPFILE) ;EP - called from GUI to produce national gpra report (NTL-GP)
 ;  BGPUSER - DUZ
 ;  BGPDUZ2 - DUZ(2)
 ;  BGPOPTN - OPTION NAME
...
EP1 ;
 ...
 S BGPYWCHW=0  ;LAB/V13
 ;I $G(BGPYWCHW)="" S BGPYWCHW=0
...
NT ;
 ...
 S BGPINDG="G"
 S BGPHWNOW=$$NOW^XLFDT()
 S BGPEXCEL=0,BGPSUMON=1
 S BGPYWCHW=0
 ...
 S BGPFILEN="BG"_$$FV^BGP8BAN()_$P(^AUTTLOC(DUZ(2),0),U,10)_"."_BGPRPT_"  in directory "_BGPUF
 S BGPDELT=""
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP8GNTS",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA REPORT 11 SUM" D ^%ZTLOAD
