...
CVD ;EP - called from report execution
 ...
 ;PREGNANCY
 S BGPEXL2=$$PREG^BGP8D7(DFN,BGPBDATE,BGPEDATE,1,1,1,BGPBDATE,BGPEDATE) I BGPEXL2 S BGPN2=1 G SETL    ;V17.1 CMI/LAB ADDED DATES FOR CURRENTLY PREGNANT
 ;BREASTFEEDING
...
CLIVER(P,BD,ED) ;EP - cirrhosis of liver?
 ...
 ;PROBLEM LIST
 NEW X
 S X=$$PLTAXID^BGP8DU(P,"BGP CIRRHOSIS OF LIVER DXS",BD,ED)
 I X Q 1
 S X=$$IPLSNOID^BGP8DU(P,"PXRM BGP CIRRHOSIS",BD,ED)
 I X Q 1
 Q ""
