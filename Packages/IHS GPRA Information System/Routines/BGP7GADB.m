BGP7GADB ; IHS/CMI/LAB - AREA NATIONAL GPRA REPORT ;
...
TESTADSH ;
 ...
 S BGPSUL(1)=""
 S BGPSUL(2)=""
 D EP(.ERR,1,2522,"BGP 17 AREA DSH","A",.BGPSUL,"B",$$NOW^XLFDT,"LORITESTAREADASH")
 W !,ERR
 Q
...
EP1 ;
 ...
 ;S BGPPBD=3120101,BGPPED=3121231,BGPDASHP=$E(BGPPED,1,3)_"0000"
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="AOAGP^BGP7GADB",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA REPORT 11" D ^%ZTLOAD
