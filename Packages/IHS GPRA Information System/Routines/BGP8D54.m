BGP8D54 ; IHS/CMI/LAB - measure calc 02 Jul 2010 8:08 AM ;
...
DVDX ;EP
 ...
 I $D(BGPG(1)) S BGPLDV=1_"^"_$P(BGPG(1),U)_"^Dv Dx "_$P(BGPG(1),U,2)_U_"POV "_$P(BGPG(1),U,2)_U_$$DATE^BGP8UTL($P(BGPG(1),U,1))
 ...
 ..I $E(BGPP,1,2)=43 S BGPC=1,BGPV=1_"^"_(9999999-D)_"^BH "_BGPP_U_"BH POV "_BGPP_U_$$DATE^BGP8UTL((9999999-D)) Q
 ..I $E(BGPP,1,2)=44 S BGPC=1,BGPV=1_"^"_(9999999-D)_"^BH "_BGPP_U_"BH POV "_BGPP_U_$$DATE^BGP8UTL((9999999-D)) Q
 ..I BGPP=995.80 S BGPC=1,BGPV=1_"^"_(9999999-D)_"^BH "_BGPP_U_"BH POV "_BGPP_U_$$DATE^BGP8UTL((9999999-D)) Q
 ..I BGPP=995.81 S BGPC=1,BGPV=1_"^"_(9999999-D)_"^BH "_BGPP_U_"BH POV "_BGPP_U_$$DATE^BGP8UTL((9999999-D)) Q
 ..Q
 I BGPV,$P(BGPLDV,U,2)<$P(BGPV,U,2) S BGPLDV=BGPV
 ;now check pcc problem list
 S T=$O(^ATXAX("B","BGP DV DXS",0))
 S G=$$PLTAXID^BGP8DU(P,"BGP DV DXS",BDATE,EDATE)
 I G S BGPDXPLE=$P(G,U,4),G=1_U_$P(G,U,3)
 I G,$P(BGPLDV,U,2)<$P(G,U,2) S BGPLDV=1_U_$P(G,U,2)_U_"PL"_U_"PL "_$$VAL^XBDIQ1(9000011,BGPDXPLE,.01)_U_$$DATE^BGP8UTL($P(G,U,2))
 S G=$$IPLSNOID^BGP8DU(P,"PXRM BGP IPV DV DX",BDATE,EDATE)
