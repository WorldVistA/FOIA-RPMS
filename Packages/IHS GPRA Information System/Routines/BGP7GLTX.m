BGP7GLTX ; IHS/CMI/LAB - IHS Diabetes Audit 2003 ;
 ;;17.1;IHS CLINICAL REPORTING;;MAY 10, 2017;Build 29
 ;
 ;
TESTCMP ;
 S ERR=""
 D EP(.ERR,1,2522,"BGP 17 LAB TAX REPORT",$$NOW^XLFDT)
 W !,ERR
 Q
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="LTX^BGP7GLTX",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI LAB TAXONOMY REPORT" D ^%ZTLOAD
 D UPLOG^BGP7GUA(BGPGIEN,ZTSK)
 Q
LTX ;
 K ^TMP($J,"BGPGUI")
 S IOM=80,BGPIOSL=55
 D @$S(BGPRT=1:"GPRA^BGP7DLT",BGPRT=7:"ONM^BGP7DLT",BGPRT=2:"CRS^BGP7DLT",BGPRT=4:"ELDER^BGP7DLT",BGPRT=3:"HEDIS^BGP7DLT",BGPRT=5:"CMS^BGP7DLT",BGPRT=8:"EO^BGP7DLT")  ;cmi/maw added 10/30/2010
 D GUIR^BGPXBLM("PRINT^BGP7DLT","^TMP($J,""BGPGUI"",")
...
XIT ;
 K ^TMP($J)
 ;D EN^XBVK("BGP")  ;done in LABTAXC^BGP7GU
 S:$D(ZTQUEUED) ZTREQ="@"
