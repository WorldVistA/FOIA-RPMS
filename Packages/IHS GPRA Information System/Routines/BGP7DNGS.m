BGP7DNGS ; IHS/CMI/LAB - NATL COMP EXPORT 13 Nov 2006 12:31 PM ;
 ;;17.1;IHS CLINICAL REPORTING;;MAY 10, 2017;Build 29
 ;
 ;
 W:$D(IOF) @IOF
 W !,$$CTR("IHS 2017 National GPRA/GPRAMA Report Clinical Performance Summaries",80),!
INTRO ;
 D XIT
 D TERM^VALM0
...
DRIVER ;
 ...
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP7DNGS",XBRX="XIT^BGP7DNGS",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP7DNGS",ZTDTH="",ZTDESC="NATIONAL GPRA/GPRAMA REPORT 11 SUM ONLY" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
