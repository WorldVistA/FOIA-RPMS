BGP8D212 ; IHS/CMI/LAB - measure 6 19 Sep 2014 8:12 AM ;
...
STRC ;EP - called from report execution
 ...
 ;PREGNANCY
 S BGPEXL2=$$PREG^BGP8D7(DFN,BGPBDATE,BGPEDATE,1,1,1,BGPBDATE,BGPEDATE) I BGPEXL2 S BGPN2=1 G ND   ;V17.1 CMI/LAB ADDED DATES FOR CURRENTLY PREGNANT
 ;cirrhosis of liver
...
SETL ;
 ...
 S BGPVALUE=$S(BGPDMD6:"UPDM",1:"")_$S(BGPDMD2:",AD",1:"")_$S(BGPDMD3:",AAD",1:"")_$S($P(BGPCVDL,U,2):" (CHD)",$P(BGPCVDL,U,3):" (LDL)",1:"")_"|||"
