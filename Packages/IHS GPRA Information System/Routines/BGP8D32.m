BGP8D32 ;IHS/CMI/LAB - MEASURE LOGIC;
...
I14 ;EP
 ...
 S (BGPI1,BGPI2,BGPI3,BGPI4,BGPI5,BGPI6,BGPI7,BGPN28,BGPN29,BGPS0N,BGPN30,BGPN31,BGPN32,BGPN33,BGPN34,BGPN40,BGPN41,BGPN42,BGPN43)=0
 ...
 S (B,E,C)=""
 D AGEDATE^BGP8UTL3("19-35",BGPEDATE,.B,.E,.C)
 ...
 K ^TMP($J,"CPT")
 S BGPVAL=$$DTAP^BGP8D34(DFN,BGPEDATE)  ;1 IS had immunizations, 3 is had Refusal, 4 is disease or NMI or Contraindication
 ...
 K ^TMP($J,"CPT")
 S BGPVAL=$$OPV^BGP8D33(DFN,BGPEDATE)
 ...
 S BGPVAL=$$MMR^BGP8D33(DFN,BGPEDATE)
 ...
 I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_$P(BGPVAL,U,2)
 I $P(BGPVAL,U,1) S BGPVALUD=BGPVALUD_$S(BGPVALUD]"":"; ",1:"")_$P(BGPVAL,U,2)
 ;S BGPVAL=$$HIB^BGP8D35(DFN,BGPEDATE)
 ...
 S BGPVAL=$$HIB3^BGP8D38(DFN,BGPEDATE)
 ...
 I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_$P(BGPVAL,U,2)
 I 'BGPN90 D
 .S BGPVAL=$$HIB4^BGP8D38(DFN,BGPEDATE)
 .I $P(BGPVAL,U,1)=1!($P(BGPVAL,U,1)=4) S BGPN90=1  ;any hit
 .I $P(BGPVAL,U,1)=1!($P(BGPVAL,U,1)=4) S BGPR4=1
 .I $P(BGPVAL,U,1)=4 S BGPN92=1
 .I $P(BGPVAL,U,1) S BGPVALUD=BGPVALUD_$S(BGPVALUD]"":"; ",1:"")_$P(BGPVAL,U,2)
 .I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_$P(BGPVAL,U,2)
 S BGPVAL=$$HEP^BGP8D35(DFN,BGPEDATE)
 ...
 I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_$P(BGPVAL,U,2)
 I $P(BGPVAL,U,1) S BGPVALUD=BGPVALUD_$S(BGPVALUD]"":"; ",1:"")_$P(BGPVAL,U,2)
 S BGPVAL=$$VAR^BGP8D35(DFN,BGPEDATE)
 ...
 I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_$P(BGPVAL,U,2)
 I $P(BGPVAL,U,1) S BGPVALUD=BGPVALUD_$S(BGPVALUD]"":"; ",1:"")_$P(BGPVAL,U,2)
 S BGPVAL=$$PNEUMO^BGP8D35(DFN,BGPEDATE,3)
 ...
 S BGPVAL=$$PNEUMO^BGP8D35(DFN,BGPEDATE,4)
 ...
 I $P(BGPVAL,U,1) S BGPVALUD=BGPVALUD_$S(BGPVALUD]"":"; ",1:"")_$P(BGPVAL,U,2)
 I 'BGPN70 D
 .S BGPVAL=$$ROTA3^BGP8D37(DFN,BGPEDATE)
 .I $P(BGPVAL,U,1)=1!($P(BGPVAL,U,1)=4) S BGPN70=1  ;any hit
 ...
 .I $P(BGPVAL,U,1) S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_$P(BGPVAL,U,2)
 .I $P(BGPVAL,U,1) S BGPVALUD=BGPVALUD_$S(BGPVALUD]"":"; ",1:"")_$P(BGPVAL,U,2)
 S BGPVAL=$$INFLU^BGP8D38(DFN,BGPEDATE)
