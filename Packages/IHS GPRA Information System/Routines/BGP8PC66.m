BGP8PC66 ; IHS/CMI/LAB - measure I2 ; 02 Feb 2018  11:25 AM
 ;;18.1;IHS CLINICAL REPORTING;**1**;MAY 25, 2018;Build 65
 ;
PNEUMO(P) ;
 NEW A42,A730,X,Y,Z,TCVX,TCPT,C,BGPIMMS,D,V,BGPZ
 S TCVX=$O(^ATXAX("B","BGP IPC PNEUMO CVX CODES",0))
 S TCPT=$O(^ATXAX("B","BGP IPC PNEUMO CPT CODES",0))
 ...
 I X]"" Q 1_U_"PNEUMO CONTRA ANAPHYLACTIC/NEOMYCIN"
 S X=$$ANSNPNEU(P,A730) I X Q 1_U_"PNEUMO CONTRA ANAPHYLACTIC REACTION"
 Q ""
ANSNPNEU(P,EDATE) ;
 ...
 .I I'=293116002 Q   ;IF IT'S SNOMED, MUST BE THAT ONE
