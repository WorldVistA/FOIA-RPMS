BGP7D722 ; IHS/CMI/LAB - measure MEDS ;
...
STATCON(P,BDATE,EDATE,NMIB,NMIE) ;EP does patient have an STATIN Contra
 ...
 ;
 ;pregnant
 S X=$$PREG^BGP7D7(P,BDATE,EDATE,1,1,,BDATE,EDATE) I X Q 1_U_"Contra pregnant"    ;V17.1 CMI/LAB ADDED DATES FOR CURRENTLY PREGNANT
 ;nmi
 S BGPG=""
