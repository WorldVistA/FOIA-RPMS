...
PROCCY ;current time period
 ...
 S BGPEDATE=BGPED,BGPTIME=1,BGPBDATE=BGPBD,BGPGBL="^BGPGPDCG("
 S BGP365=BGPBDATE
 S BGPACTUP=1
 S BGPACTCL=1
 S BGPACTCB=1
 ...
 .S BGP2DMV=$$V2DM^BGP7D1(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE)
...
PROCPY ;
 ...
 Q:$P(^DPT(DFN,0),U,2)=""
 Q:"FM"'[$P(^DPT(DFN,0),U,2)
 S BGPEDATE=BGPPED,BGPTIME=2,BGPBDATE=BGPPBD,BGPGBL="^BGPGPDPG("
 S BGP365=BGPBDATE
 S BGPACTUP=1
 S BGPACTCL=1
 S BGPACTCB=1
...
PROCBY ;
 ...
 Q:$P(^DPT(DFN,0),U,2)=""
 Q:"FM"'[$P(^DPT(DFN,0),U,2)
 S BGPEDATE=BGPBED,BGPTIME=3,BGPBDATE=BGPBBD,BGPGBL="^BGPGPDBG("
 S BGP365=BGPBDATE
 S BGPACTUP=1
 S BGPACTCL=1
 S BGPACTCB=1
