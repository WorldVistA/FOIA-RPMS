BGP8PDL5 ; IHS/CMI/LAB - print ind 1 01 Jul 2010 8:04 PM ;
...
I1AGEP ;EP
 ...
 S X=" " D S(X,1,1) S X="# w/ Specific Nutrition Educ Provided" D S(X,1,1)
 F X=1:1:5 S V=$P(BGPDAC(X),U,4) S Y=V D S(Y,,X+1)
 S X="% w/ Specific Nutrition Educ Provided" D S(X,1,1)
 ...
 S X=" " D S(X,1,1) S X="# w/ Other Exercise or Nutrition Educ" D S(X,1,1)
 F X=1:1:5 S V=$P(BGPDAC(X),U,8) S Y=V D S(Y,,X+1)
 S X="% w/ Other Exercise or Nutrition Educ" D S(X,1,1)
