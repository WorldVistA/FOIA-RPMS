BGP8DP19 ; IHS/CMI/LAB - print ind 1 03 Jul 2010 7:40 AM ;
...
I1AGE ;EP  special age tallies
 ...
 I '$G(BGPSUMON) D HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPINDR(BGPIC,53,1,0) W:$D(^BGPINDR(BGPIC,53,2,0)) !,^BGPINDR(BGPIC,53,2,0)  D H9^BGP8DPH
...
I1AGEP ;
 ...
 W !,"# w/ Dental Visit-No",!?2,"Refusals (GPRA)"
 S T=23 F X=1:1:7 S V=$P(BGPDAC(X),U,2) W ?T,$$C(V,0,6) S T=T+7
 W !,"% w/ Dental Visit-No",!?2,"Refusals (GPRA)"
 S T=22 F X=1:1:7 S V=$P(BGPDAC(X),U,3) W ?T,$J(V,6,1) S T=T+7
PR ; 
 I $Y>(BGPIOSL-13) D:'$G(BGPSUMON) HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPINDR(BGPIC,53,1,0) W:$D(^BGPINDR(BGPIC,53,2,0)) !,^BGPINDR(BGPIC,53,2,0) D H9^BGP8DPH
...
BL ;
 ;D:'$G(BGPSUMON) HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPINDR(BGPIC,53,1,0) W:$D(^BGPINDR(BGPIC,53,2,0)) !,^BGPINDR(BGPIC,53,2,0) D H9^BGP8DPH
