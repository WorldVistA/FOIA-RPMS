BGP7XTCO ; IHS/CMI/LAB - TAXONOMY CHECK FOR  CRS REPORT ;
 ;;17.1;IHS CLINICAL REPORTING;;MAY 10, 2017;Build 29
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the Other National Measures Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BGP7XTCO",XBNS="",XBRX="XIT^BGP7XTCO"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
 ...
 K BGPQUIT
GUICHK ;EP
 W !,"Checking for Taxonomies to support the Other National Measures Report...",!
 ...
 W !,"In order for the Other National Measures Report to find all necessary data, several",!,"taxonomies must be established.  The following taxonomies are missing or have",!,"no entries:"
