...
I13 ;EP - PN
 ...
 I BGPAGEB>18,BGPAGEB<60,BGPACTUP S BGPND11=1
...
PN ;EP - called from elder
 ...
 .;I BGPAGEB>64 I $P(BGPPNA65,U,3)=1!($P(BGPPNA65,U,3)=3) S BGPN37=1,BGPN28=1E
 ...
 .I BGPN28 S BGPVALUD=BGPVALUD_"(up-to-date)"
...
TD ;new tdap and td stuff for v11.1
 ...
 .S BGPFPRDX=$$FIRSTPDX^BGP7D3C(DFN,$$FMADD^XLFDT(BGPEDATE,-608),BGPEDATE) I BGPFPRDX="" S BGPFPRDX=$P($G(^AUPNREP(DFN,11)),U,2)
 .;GET EDD
 ...
 ..S TE=BGPEDD
 ..S BGPD16=$$LASTVD^BGP7D3C(DFN,TB,TE)
...
UNK ..I G="" S BGPN44=1,BGPTRIM="unk Trimester"
 ...
 ..S G=""
 ..S BGPD16=$$LASTDX^BGP7UTL1(DFN,"BGP PREGNANCY TRI 3 DXS",BGPBDATE,BGPEDATE)
...
LASTTDAP(P,BDATE,EDATE) ;EP
 ...
 Q ""
PREG(P,BDATE,EDATE) ;
 I '$$PREG^BGP7D7(DFN,$$FMADD^XLFDT(EDATE,-608),EDATE,1,1,,BDATE,EDATE) Q ""    ;V17.1 CMI/LAB ADDED DATES FOR CURRENTLY PREGNANT
 Q 1
