BGP7GNT9 ; IHS/CMI/LAB - IHS Diabetes Audit 2003 27 Apr 2010 10:56 PM 13 Dec 2006 7:35 AM ;
 ;;17.1;IHS CLINICAL REPORTING;;MAY 10, 2017;Build 29
 ;
 ;
EP(BGPRET,BGPUSER,BGPDUZ2,BGPOPTN,BGPTAXI,BGPEXPT,BGPROT,BGPRTIME,BGPMFITI,BGPYWCHW,BGPONEF,BGPFILE) ;EP - called from GUI to produce national gpra report (NTL-GP)
 ;  BGPUSER - DUZ
 ;  BGPDUZ2 - DUZ(2)
 ;  BGPOPTN - OPTION NAME
...
EP1 ;
 ...
 S BGPGUI=1
 S IOM=80,BGPIOSL=55
 S BGPRTYPE=1,BGPYRPTH="",BGPNGR09=1
...
NT ;
 ...
 S BGPEXCEL=""
 I BGPEXPT S BGPYWCHW=0  ;$S($P($G(^BGPSITE(DUZ(2),0)),U,11)=0:0,1:1)
 ...
 I $G(BGPEXPT) S BGPFILEN="BG171"_$P(^AUTTLOC(DUZ(2),0),U,10)_"."_BGPRPT_"  in directory "_BGPUF
 S BGPDELT=""
 ;I BGPYWCHW=2 D
 ;.S BGPNOW=$$NOW^XLFDT() S BGPNOW=$P(BGPNOW,".")_"."_$$RZERO^BGP7UTL($P(BGPNOW,".",2),6)
 ;.S BGPFN="CRSHW"_$P(^AUTTLOC(DUZ(2),0),U,10)_$$D^BGP7UTL(BGPBD)_$$D^BGP7UTL(BGPED)_$$D^BGP7UTL(BGPNOW)_"_000001"_".TXT"
 ...
 ;I BGPYWCHW=2 S $P(BGPRET,"~",4)=BGPFN
 Q
 ;
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP7GNT9",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATL GPRA RPT 10 FOR 11" D ^%ZTLOAD
...
NTLGP ;
 ...
 ;I $G(BGPYWCHW)=2 D HWSF^BGP7DNG9
 D ENDLOG
 D XIT
 Q
 ;
