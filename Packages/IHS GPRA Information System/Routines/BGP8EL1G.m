BGP8EL1G ;IHS/CMI/LAB - ELDER CALC;
...
I1AGE7 ;
 ...
 S BGPNF=$P(^BGPELIIR(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90561.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
 S $P(BGPDAC(I),U,14)=$$V(1,BGPRPT,N,P),$P(BGPDAC(I),U,15)=$S($P(BGPDAC(I),U,2):($P(BGPDAC(I),U,14)/$P(BGPDAC(I),U,2)*100),1:"")
 S $P(BGPDAP(I),U,14)=$$V(2,BGPRPT,N,P),$P(BGPDAP(I),U,15)=$S($P(BGPDAP(I),U,2):($P(BGPDAP(I),U,14)/$P(BGPDAP(I),U,2)*100),1:"")
 S $P(BGPDAB(I),U,14)=$$V(3,BGPRPT,N,P),$P(BGPDAB(I),U,15)=$S($P(BGPDAB(I),U,2):($P(BGPDAB(I),U,14)/$P(BGPDAB(I),U,2)*100),1:"")
 Q
I1AGEP ;
 ...
 ;
PR ; 
 I $Y>(BGPIOSL-25) D HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPELIR(BGPIC,53,1,0) D H3
