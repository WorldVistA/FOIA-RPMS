BGP8XTEO ; IHS/CMI/LAB - TAXONOMY CHECK FOR CRS REPORT ;
 ;;18.0;IHS CLINICAL REPORTING;;NOV 21, 2017;Build 51
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2018 Executive Order Report. ",!,"Please enter the device for printing.",!
ZIS ;
...
GUICHK ;EP
 ...
 .Q:'$D(^BGPTAXR(BGPY,12,"B",8))  ;8 IS SET OF CODES FOR EO REPORT
