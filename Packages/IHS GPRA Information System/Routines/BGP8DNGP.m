BGP8DNGP ;IHS/CMI/LAB - NATL RPT PRT;
 ;;18.1;IHS CLINICAL REPORTING;;MAY 25, 2018;Build 66
 ;
 ;
 W:$D(IOF) @IOF
 W !,$$CTR("IHS 2018 National GPRA/GPRAMA Report by Designated Provider",80),!
INTRO ;
 D XIT
 D TERM^VALM0
...
ZIS ;call to XBDBQUE
 ...
 ..W !,"Report Aborted" S DA=BGPRPT,DIK="^BGPGPDPR(" D ^DIK K DIK
 ..W !,"Report Aborted" S DA=BGPRPT,DIK="^BGPGPDBR(" D ^DIK K DIK
 I $D(IO("Q")) G TSKMN
DRIVER ;
 ...
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP8DNGP",XBRX="XIT^BGP8DNGP",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP8DNGP",ZTDTH="",ZTDESC="NATIONAL GPRA/GPRAMA REPORT 11 DP" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
