...
I1A1 ;001.A, 001.B, 001.C
 ...
 Q
I2 ;EP
 I $Y>(BGPIOSL-13) D HEADER^BGP8DPH Q:BGPQUIT  W !!,^BGPELIR(BGPIC,53,1,0)
 D H1^BGP8DPH
...
EFR ;EP
 D H1^BGP8DPH
 S BGPPC0=$P(^BGPELIR(BGPIC,0),U,6)
...
IRAA ;EP
 D H1^BGP8DPH
 F BGPPC1=$P(^BGPELIR(BGPIC,0),U,6)_".1" Q:BGPQUIT  D PI
 D I1AGE^BGP8EL1N
 Q
AWV ;EP
 D H1^BGP8DPH
...
PCV ;EP
 ...
 D HEADER^BGP8DPH Q:BGPQUIT  W !!,^BGPELIR(BGPIC,53,1,0) D H1^BGP8DPH
...
PI ;EP
 S BGPDENP=0
 S BGPPC2=0 F  S BGPPC2=$O(^BGPELIIR("ABC",BGPPC1,BGPPC2)) Q:BGPPC2=""  S BGPPC=$O(^BGPELIIR("ABC",BGPPC1,BGPPC2,0)) D PI1
 Q
PI1 ;
 ...
 .I $Y>(BGPIOSL-13) D HEADER^BGP8DPH Q:BGPQUIT  W !!,^BGPELIR(BGPIC,53,1,0) D H1^BGP8DPH
 .S X=$$LABELE^BGP8UTL1(BGPPC,BGPRTYPE,BGPPTYPE,"D")
 .W !!,$P(X,U,1)
 ...
 D SETN
 ;write header
 I $Y>(IOSL-5) D HEADER^BGP8DPH Q:BGPQUIT  W !!,^BGPELIR(BGPIC,53,1,0) D H1^BGP8DPH
 I $P(^BGPELIIR(BGPPC,0),U,22) W !
