BGP8GADB ; IHS/CMI/LAB - AREA NATIONAL GPRA REPORT ; 04 Apr 2018  4:01 PM
...
TESTADSH ;
 ...
 S BGPSUL(1)=""
 S BGPSUL(2)=""
 D EP(.ERR,1,2522,"BGP 18 AREA DSH","A",.BGPSUL,"B",$$NOW^XLFDT,"LORITESTAREADASH")
 W !,ERR
 Q
EP(BGPRET,BGPUSER,BGPDUZ2,BGPOPTN,BGPRPTT,BGPSUL,BGPROT,BGPRTIME,BGPFILE,BGPVDT) ;EP - called from GUI to produce national gpra report (AO-AGP)
...
EP1 ;
 ...
 S BGPVDT=2018
 S BGPVDT=BGPVDT-1700
 S BGPPER=BGPVDT_"0000"
 I BGPPER="3190000" S BGPNGR09=1
 S BGPRTYPE=1,BGPBEN=1,BGPYRPTH="",BGPDASH=1,BGPDASHY=BGPPER
 ...
 ;S BGPPBD=$P(Y,U,10),BGPPED=$P(Y,U,11),BGPDASHP=$E(BGPPED,1,3)_"0000"
 ...
 ;S BGPPBD=3121001,BGPPED=3121231,BGPDASHP=$E(BGPPED,1,3)_"0000"
...
NT ;
 ...
 D ^XBFMK
 S X=BGPFILE
 ;S BGPFN=$G(BGPFGNT1)_","_$G(BGPFGNT2)_","_$G(BGPFDEV1)_","_$G(BGPFDEV2)_","_$G(BGPFDEV3)
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="AOAGP^BGP8GADB",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA REPORT 11" D ^%ZTLOAD
