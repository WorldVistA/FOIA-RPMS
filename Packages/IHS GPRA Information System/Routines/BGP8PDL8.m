BGP8PDL8 ; IHS/CMI/LAB - print ind 1 ;
...
I1AGEP ;EP
 ...
 S X=" " D S(X,1,1) S X="A. # Smokers" D S(X,1,1)
 ...
 S X=" " D S(X,1,1) S X="B. # Smokeless" D S(X,1,1)
 ...
 S X=" " D S(X,1,1) S X="C. # ENDS Users" D S(X,1,1)
...
PR ; 
 ;S X=^BGPINDR(BGPIC,53,1,0) D S(X,1,1)
 S X=" " D S(X,2,1)
 ;D H3
