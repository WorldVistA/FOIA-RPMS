...
I1AGEP ;
 ...
 S X="% w/ Depression Screening or Mood Disorder DX-No Refusals (GPRA)" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAC(X),U,3) S Y=$$SB^BGP7ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:4 S V=$P(BGPDAC(X),U,5) S Y=$$SB^BGP7ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:4 S V=$P(BGPDAC(X),U,7) S Y=$$SB^BGP7ELL2($J(V,6,1)) D S(Y,,X+1)
 ...
 F X=1:1:4 S V=$P(BGPDAC(X),U,11) S Y=$$SB^BGP7ELL2($J(V,6,1)) D S(Y,,X+1)
PR ; 
 ...
 S X="% w/ Depression Screening or Mood Disorder DX-No Refusals (GPRA)" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAP(X),U,3) S Y=$$SB^BGP7ELL2($J(V,6,1)) D S(Y,,X+1)
 S X=" " D S(X,1,1) S X="A. # screened for depression" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAP(X),U,4) S Y=V D S(Y,,X+1)
 S X="A. % screened for depression w/ % of Total Screened" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAP(X),U,5) S Y=$$SB^BGP7ELL2($J(V,6,1)) D S(Y,,X+1)
 S X=" " D S(X,1,1) S X="B. # w/ Mood Disorder DX" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAP(X),U,6) S Y=V D S(Y,,X+1)
 S X="B. % w/ Mood Disorder DX w/ % of Total Screened" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAP(X),U,7) S Y=$$SB^BGP7ELL2($J(V,6,1)) D S(Y,,X+1)
 S X=" " D S(X,1,1) S X="# w/Depression Education" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAP(X),U,10) S Y=V D S(Y,,X+1)
 S X="% w/Depression Education" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAP(X),U,11) S Y=$$SB^BGP7ELL2($J(V,6,1)) D S(Y,,X+1)
 ;percentage changes
 S X=" " D S(X,1,1) S X="CHANGE FROM PREV YR %" D S(X,1,1)
 S X="w/ Depression Screening or Mood Disorder DX-No Refusals (GPRA)" D S(X,1,1)
 F X=1:1:4 S N=$P(BGPDAC(X),U,3),O=$P(BGPDAP(X),U,3) S Y=$$SB^BGP7ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="A. screened for depression w/ % of Total Screened" D S(X,1,1)
 F X=1:1:4 S N=$P(BGPDAC(X),U,5),O=$P(BGPDAP(X),U,5) S Y=$$SB^BGP7ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="B. w/ Mood Disorder DX w/ % of Total Screened" D S(X,1,1)
 F X=1:1:4 S N=$P(BGPDAC(X),U,7),O=$P(BGPDAP(X),U,7) S Y=$$SB^BGP7ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="w/Depression Education" D S(X,1,1)
 F X=1:1:4 S N=$P(BGPDAC(X),U,11),O=$P(BGPDAP(X),U,11) S Y=$$SB^BGP7ELL2($J((N-O),6,1)) D S(Y,,X+1)
BL ;
 ...
 S X="% w/ Depression Screening or Mood Disorder DX-No Refusals (GPRA)" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAB(X),U,3) S Y=$$SB^BGP7ELL2($J(V,6,1)) D S(Y,,X+1)
 S X=" " D S(X,1,1) S X="A. # screened for depression" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAB(X),U,4) S Y=V D S(Y,,X+1)
 S X="A. % screened for depression w/ % of Total Screened" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAB(X),U,5) S Y=$$SB^BGP7ELL2($J(V,6,1)) D S(Y,,X+1)
 S X=" " D S(X,1,1) S X="B. # w/ Mood Disorder DX" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAB(X),U,6) S Y=V D S(Y,,X+1)
 S X="B. % w/ Mood Disorder DX w/ % of Total Screened" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAB(X),U,7) S Y=$$SB^BGP7ELL2($J(V,6,1)) D S(Y,,X+1)
 S X=" " D S(X,1,1) S X="# w/Depression Education" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAB(X),U,10) S Y=V D S(Y,,X+1)
 S X="% w/Depression Education" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAB(X),U,11) S Y=$$SB^BGP7ELL2($J(V,6,1)) D S(Y,,X+1)
 ;percentage changes
 S X=" " D S(X,1,1) S X="CHANGE FROM BASE YR %" D S(X,1,1)
 S X="w/ Depression Screening or Mood Disorder DX-No Refusals (GPRA)" D S(X,1,1)
 F X=1:1:4 S N=$P(BGPDAC(X),U,3),O=$P(BGPDAB(X),U,3) S Y=$$SB^BGP7ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="A. screened for depression w/ % of Total Screened" D S(X,1,1)
 F X=1:1:4 S N=$P(BGPDAC(X),U,5),O=$P(BGPDAB(X),U,5) S Y=$$SB^BGP7ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="B. w/ Mood Disorder DX w/ % of Total Screened" D S(X,1,1)
 F X=1:1:4 S N=$P(BGPDAC(X),U,7),O=$P(BGPDAB(X),U,7) S Y=$$SB^BGP7ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="w/Depression Education" D S(X,1,1)
 F X=1:1:4 S N=$P(BGPDAC(X),U,11),O=$P(BGPDAB(X),U,11) S Y=$$SB^BGP7ELL2($J((N-O),6,1)) D S(Y,,X+1)
 Q
