...
N1 I $G(BGPEXCEL),'$G(BGPYGPU),BGPRTYPE=1 D
 ...
 I $G(BGPEXCEL),BGPRTYPE=7 D W^BGP8DP("Other National Measures filenames: ",0,1,BGPPTYPE),W^BGP8DP(BGPFONN1,0,1,BGPPTYPE,1,15),W^BGP8DP(BGPFONN2,0,1,BGPPTYPE,1,15),W^BGP8DP(BGPFONN3,0,1,BGPPTYPE,1,15) ;,W^BGP8DP(BGPFONN4,0,1,BGPPTYPE,1,15) D
