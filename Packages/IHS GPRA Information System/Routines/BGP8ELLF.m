BGP8ELLF ; IHS/CMI/LAB - print ind ;
...
I1AGE ;EP
 ...
 K BGPDAC,BGPDAP,BGPDAB S (C,D,E,F,G,H,I,J,K)=0 F BGPX="DVB.1","DVB.2","DVB.3","DVB.4" D I1AGE1,I1AGE2,I1AGE3,I1AGE4
 D I1AGEP
 Q
I1AGE1 ;
 S C=C+1
...
I1AGEP ;
 ...
 S X="A. % w/IPV/DV exam w/ % of Total Screened" D S(X,1,1)
 ...
 S X="B. % w/IPV/DV related DX w/ % of Total Screened" D S(X,1,1)
 ...
 S X="C. % provided IPV/DV education w/ % of Total Screened" D S(X,1,1)
...
PR ; 
 ...
 S X="A. IPV/DV exam w/ % of Total Screened" D S(X,1,1)
 F X=1:1:4 S N=$P(BGPDAC(X),U,5),O=$P(BGPDAP(X),U,5) S Y=$$SB^BGP8ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="B. IPV/DV related DX w/ % of Total Screened" D S(X,1,1)
