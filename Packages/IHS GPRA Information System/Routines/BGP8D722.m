...
ACECONT(P,BDATE,EDATE,NMIB,NMIE,RPBD,PREGBD) ;EP
 ...
 .Q
 I BGPG Q BGPG
 S X=$$PREG^BGP8D7(P,$S($G(PREGBD):PREGBD,$G(RPBD):RPBD,1:NMIB),NMIE,1,1) I X Q 1_U_"Contra pregnant"
...
STATALG(P,BDATE,EDATE,RPB,RPE) ;EP
 ...
 .I $$ICD^BGP8UTL2(I,$O(^ATXAX("B","BGP HX DRUG ALLERGY NEC",0)),9)!($$ICD^BGP8UTL2(I,T,9)),N["STATIN"!(N["STATINS"),N'["NYSTATIN" S BGPC=1_U_$$DATE^BGP8UTL($P(^AUPNPROB(X,0),U,8))_" ADR Problem List "_Y Q  ;_"]" Q
...
STATCON(P,BDATE,EDATE,NMIB,NMIE) ;EP does patient have an STATIN Contra
 ...
 ;
 ;pregnant
 S X=$$PREG^BGP8D7(P,BDATE,EDATE,1,1,,BDATE,EDATE) I X Q 1_U_"Contra pregnant"
 ;nmi
 S BGPG=""
