...
VAR(P,EDATE) ;EP
 ...
 ;I $$PLTAX^BGP8DU(P,"BGP VARICELLA EVIDENCE") Q 4_U_"Evid Vari"
...
I I BGPHEP=2,BGP10743,$G(BGPADOL) Q 1_U_" 3 Hep B"
 ...
 ;I $$PLTAX^BGP8DU(P,"BGP HEP EVIDENCE") Q 4_U_"Evid Hep B"
 ...
 ;I R Q $S(BGPNMI:4,1:3)_U_$S(BGPNMI:"NMI",1:"Ref")_" Hep B"
 F BGPZ=8,42,43,44,45,51,102,104,110,132,146 S X=$$ANCONT^BGP8D31(P,BGPZ,EDATE) Q:X]""  ;cmi/maw 12/17/07 missing edate
...
HIB(P,EDATE) ;EP
 ...
 ;I $$PLTAX^BGP8DU(P,"BGP HIB EVIDENCE") Q 4_U_"Evid Hib"
 ;now go to Refusals
 S B=$$DOB^AUPNPAT(P),E=EDATE,BGPNMI="",R=""
