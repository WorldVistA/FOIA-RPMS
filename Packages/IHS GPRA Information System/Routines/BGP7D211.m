BGP7D211 ; IHS/CMI/LAB - measure 6 19 Sep 2014 8:12 AM ;
...
JVN ;EP
 ...
 I Y S $P(BGPVAL,U,1)="JVN: "_$$DATE^BGP7UTL(D)_" Cl "_R
 ;OPHTHALMOLOGY
 ...
 I Y S $P(BGPVAL,U,2)="Ophth: "_$$DATE^BGP7UTL(D)_" Cl/Prv "_R_"/"_J
 ;I 'Y D
 ...
 .I J'="08",J'=24 Q
 .S Y=1,D=$P(^TMP($J,"A",X),U)
 I Y S $P(BGPVAL,U,3)="Optom: "_$$DATE^BGP7UTL(D)_" Cl/Prv "_R_"/"_J
 Q BGPVAL
DNKA(V) ;EP
 NEW D,N
...
OCPT(V) ;is there a 82570 on this visit?
 ...
 S E=+$$CODEN^ICPTCOD("82570"),%=$$CPTI^BGP7DU(P,D,D,E)
 ...
 S E=+$$CODEN^ICPTCOD("82570"),%=$$TRANI^BGP7DU(P,D,D,E)
 I % Q 1
 Q ""
LOINC(A,B) ;EP 
 NEW %
...
ESRD(P,BDATE,EDATE) ;EP
 NEW X,T,A,B,C
 S X=$$LASTDX^BGP7UTL1(P,"BGP ESRD PMS DXS",BDATE,EDATE)
 ...
 S X=$$PLTAXND^BGP7DU(P,"BGP ESRD PMS DXS",EDATE)
 I X Q X
 S X=$$IPLSNOND^BGP7DU(P,"PXRM END STAGE RENAL DISEASE",EDATE)
 I X Q X
 Q 0
S ;
...
AWV ;EP
 ...
 S BGPN1=$P(BGPVAL,U)
 S BGPVALUE="AC|||" I BGPN1 S BGPVALUE=BGPVALUE_$$DATE^BGP7UTL($P(BGPVAL,U,2))_" CPT "_$P(BGPVAL,U,3)
 K BGPVAL
 Q
 ;
AWV1(P,BDATE,EDATE) ;EP
 ...
 I 'T Q ""
 S X=$$CPT^BGP7DU(P,BDATE,EDATE,T,6)
 I 'X S X=$$TRAN^BGP7DU(P,BDATE,EDATE,T,6)
 Q X
DMPVPL(P,BDATE,EDATE) ;EP - DM ON PL OR 2 DM VISITS EVER
 I '$G(P) Q ""
 I $$PLTAXND^BGP7DU(P,"SURVEILLANCE DIABETES",EDATE) Q 1
 I $$IPLSNOND^BGP7DU(P,"PXRM DIABETES",EDATE) Q 1
 I $$V2DM^BGP7D1(P,BDATE,EDATE) Q 1
 Q ""
