BGP8DPEQ ; IHS/CMI/LAB - IHS gpra print ;
 ...
 ;
7 ;EP
 I $Y>(BGPIOSL-6) D HEADER^BGP8DPEP Q:BGPQUIT  W !,$P(^BGPPEIR(BGPIC,0),U,2)
 D H1^BGP8DPH
 S BGPCYD=$$V^BGP8DPEP(1,BGPRPT,11,29)
 S BGPPRD=$$V^BGP8DPEP(2,BGPRPT,11,29)
 S BGPBLD=$$V^BGP8DPEP(3,BGPRPT,11,29)
 ...
 ..I $Y>(BGPIOSL-3) D HEADER^BGP8DPEP Q:BGPQUIT  W !,$P(^BGPPEIR(BGPIC,0),U,2) D H1^BGP8DPH W !
 ...
 ..D H2^BGP8DPH
 ;not set
 I $Y>(BGPIOSL-6) D HEADER^BGP8DPEP Q:BGPQUIT  W !,$P(^BGPPEIR(BGPIC,0),U,2) D H1^BGP8DPH
 S BGPCYD=$$V^BGP8DPEP(1,BGPRPT,11,29)
 S BGPPRD=$$V^BGP8DPEP(2,BGPRPT,11,29)
 S BGPBLD=$$V^BGP8DPEP(3,BGPRPT,11,29)
 ;I $G(BGPSEAT) W !!,$P(^DIBT(BGPSEAT,0),U,1)," Population"
