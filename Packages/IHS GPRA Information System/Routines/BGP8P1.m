BGP8P1 ; IHS/CMI/LAB - v11.0 patch 1 env routine 08 Dec 2010 3:10 PM ;
...
POST ;EP - called from kids build
 ...
 .I '$D(^BGPGPDCR(BGPX,1.1)) S DA=BGPX,DIK="^BGPGPDCR(" D ^DIK S DA=BGPX,DIK="^BGPGPDPR(" D ^DIK S DA=BGPX,DIK="^BGPGPDBR(" D ^DIK
 Q
