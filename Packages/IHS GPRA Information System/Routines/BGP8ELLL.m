BGP8ELLL ; IHS/CMI/LAB - print ind 05 Feb 2017 9:00 AM ;
...
I1AGEP ;
 ...
 S X="# w/Functional Status screening" D S(X,1,1)
...
CALC(N,O) ;
 ...
 Q Z
H3 ;EP
 S X="Functional Status Screening" D S(X,1,1) S Y=" " D S(Y,1,1) S X=BGPHD1 D S(X,1,1) S Y=" " D S(Y,1,1)
