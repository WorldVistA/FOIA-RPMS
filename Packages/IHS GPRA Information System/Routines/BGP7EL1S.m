BGP7EL1S ; IHS/CMI/LAB - print ind 1 ;
...
PR ; 
 I $Y>(BGPIOSL-13) D HEADER^BGP7DPH Q:BGPQUIT  W !,^BGPELIG(BGPIC,53,1,0) D H3
...
BL ;
 I $Y>(BGPIOSL-18) D HEADER^BGP7DPH Q:BGPQUIT  W !,^BGPELIG(BGPIC,53,1,0) D H3
