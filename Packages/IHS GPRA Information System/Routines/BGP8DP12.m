BGP8DP12 ; IHS/CMI/LAB - print ind 19 AGE DIST ;
 ;;18.1;IHS CLINICAL REPORTING;;MAY 25, 2018;Build 66
 ;
 ;
I1AGE ;EP  special age tallies
 Q:$G(BGPSUMON)
 ;I BGPRTYPE=7 D ^BGP8DP13 Q
...
PR ; 
 I '$G(BGPSUMON) D HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPINDR(BGPIC,53,1,0) W:$D(^BGPINDR(BGPIC,53,2,0)) !,^BGPINDR(BGPIC,53,2,0) D H4^BGP8DPH
