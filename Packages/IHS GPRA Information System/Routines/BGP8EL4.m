BGP8EL4 ; IHS/CMI/LAB - measure 1,2,3,4 05 Apr 2010 1:44 PM ;
...
PALLCARE ;EP 
 ...
 I BGPAGEB>74,BGPAGEB<85 S BGPD4=1
 I BGPAGEB>84 S BGPD5=1
 S BGPVAL=$$PCV^BGP8D24(DFN,BGPBDATE,BGPEDATE)  ;return #visits^list string
 S BGPN1=$P(BGPVAL,U)
 ;S BGPCANCE=$$CANCER^BGP8D24(DFN,BGPBDATE,BGPEDATE)
...
FUNCTION(P,BDATE,EDATE) ;EP
 ...
 .S $P(BGPQ,U,2)=$P(BGPQ,U,2)_$$DATE^BGP8UTL((9999999-Y))_" "_BGPV(Y)_" "
 K BGPV,BGPG
 Q BGPQ
 ;
