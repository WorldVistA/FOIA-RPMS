BGP8D73 ; IHS/CMI/LAB - measure 31 ;
...
CHEL ;EP - called from elder care
 ...
 S BGPLDL=$$LDL^BGP8D2(DFN,$$FMADD^XLFDT(BGPEDATE,-(5*365)),BGPEDATE) ;date^value
 ...
 I BGPVALUE]"" S V=V_"CHOL: "_$$DATE^BGP8UTL($P(BGPVALUE,U,2))_" "_$P(BGPVALUE,U,3)
 I $P(BGPLDL,U) S V=V_$S(BGPVALUE]"":"; ",1:"") S V=V_"LDL: "_$$DATE^BGP8UTL($P(BGPLDL,U,2))_" "_$P(BGPLDL,U,3)
 S BGPVALUE=V
...
CHOL(P,BDATE,EDATE,NORES) ;EP
 ...
 S E=+$$CODEN^ICPTCOD(82465),%=$$CPTI^BGP8DU(P,BDATE,EDATE,E) I %]"" Q 1_U_$P(%,U,2)_"^CPT 82465"
 S E=+$$CODEN^ICPTCOD(82465),%=$$TRANI^BGP8DU(P,BDATE,EDATE,E) I %]"" Q 1_U_$P(%,U,2)_"^TRAN 82465"
 Q ""
 ;
LOINC(A,B) ;
 NEW %
