BGP7GAG9 ; IHS/CMI/LAB - AREA NATIONAL GPRA REPORT ;
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="AOAGP^BGP7GAG9",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI GPRA REPORT 11 FOR 10" D ^%ZTLOAD
