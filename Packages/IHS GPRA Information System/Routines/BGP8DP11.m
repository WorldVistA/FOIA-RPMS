BGP8DP11 ; IHS/CMI/LAB - print ind 1 ;
...
I1AGE ;EP  special age tallies
 ...
 I '$G(BGPSUMON) D HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPINDR(BGPIC,53,1,0) W:$D(^BGPINDR(BGPIC,53,2,0)) !,^BGPINDR(BGPIC,53,2,0)  D H3^BGP8DPH
...
I1AGEP ;
 ...
 W !!,"# w/ DM Dx during",!?2,"Report Period"
 S T=23 F X=1:1:8 S V=$P(BGPDAC(X),U,4) W ?T,$$C(V,0,6) S T=T+7
 W !,"% w/ DM Dx during",!?2,"Report Period"
 S T=22 F X=1:1:8 S V=$P(BGPDAC(X),U,5) W ?T,$J(V,6,1) S T=T+7
PR ; 
 I $Y>(BGPIOSL-13) I '$G(BGPSUMON) D HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPINDR(BGPIC,53,1,0) W:$D(^BGPINDR(BGPIC,53,2,0)) !,^BGPINDR(BGPIC,53,2,0) D H3^BGP8DPH
...
BL ;
 I $Y>(BGPIOSL-13) D:'$G(BGPSUMON) HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPINDR(BGPIC,53,1,0) W:$D(^BGPINDR(BGPIC,53,2,0)) !,^BGPINDR(BGPIC,53,2,0) D H3^BGP8DPH
