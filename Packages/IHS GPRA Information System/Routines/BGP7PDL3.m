...
PI ;EP
 ...
 S BGPPC=$O(^BGPINDGC("OR",BGPPC1,0))
 Q:'$$CHECK^BGP7DP1E(BGPPC)
 ;get numerator value of measure and calc %
 S BGPPC=BGPPC D
 .S BGPDF=$P(^BGPINDGC(BGPPC,0),U,9)
 .;I $P(^BGPINDGC(BGPPC,0),U,4)[".3" S BGPDF=23.503
 .;I $P(^BGPINDGC(BGPPC,0),U,4)[".4" S BGPDF=23.504
...
H .;write header for 1.A.1
 .S X=$P(^BGPINDGC(BGPPC,0),U,15)_" "_$P(^BGPINDGC(BGPPC,0),U,16)_" "_$P(^BGPINDGC(BGPPC,0),U,19) D S(X,1,1)
 .D H2
 Q
H2 ;
