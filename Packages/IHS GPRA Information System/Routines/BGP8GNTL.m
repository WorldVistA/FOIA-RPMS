BGP8GNTL ; IHS/CMI/LAB - CRS 27 Apr 2010 10:56 PM 13 Dec 2006 7:35 AM ;
 ;;18.0;IHS CLINICAL REPORTING;;NOV 21, 2017;Build 51
 ;
 ;
TESTNTL ;
 S ERR=""
 D EP(.ERR,1,2582,"BGP 18 NATIONAL GPRA REPORT",597,0,"B",$$NOW^XLFDT,,0)
 W !,ERR
 Q
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP8GNTL",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATIONAL GPRA REPORT 14" D ^%ZTLOAD
