BGP7DP8 ; IHS/CMI/LAB - print ind H ;
...
I1AGE3 ;
 ...
 S BGPNF=$P(^BGPINDGC(BGPPC,0),U,9)
 S BGPNP=$P(^DD(90558.03,BGPNF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
 S $P(BGPDAC(D),U,7)=$$V^BGP7DP1C(1,BGPRPT,N,P),$P(BGPDAC(D),U,8)=$S($P(BGPDAC(D),U,6):($P(BGPDAC(D),U,7)/$P(BGPDAC(D),U,6)*100),1:"")
 S $P(BGPDAP(D),U,7)=$$V^BGP7DP1C(2,BGPRPT,N,P),$P(BGPDAP(D),U,8)=$S($P(BGPDAP(D),U,6):($P(BGPDAP(D),U,7)/$P(BGPDAP(D),U,6)*100),1:"")
 S $P(BGPDAB(D),U,7)=$$V^BGP7DP1C(3,BGPRPT,N,P),$P(BGPDAB(D),U,8)=$S($P(BGPDAB(D),U,6):($P(BGPDAB(D),U,7)/$P(BGPDAB(D),U,6)*100),1:"")
 Q
I1AGEP ;EP
