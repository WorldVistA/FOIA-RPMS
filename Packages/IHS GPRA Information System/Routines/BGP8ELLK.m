BGP8ELLK ; IHS/CMI/LAB - print ind ;
 ;;18.1;IHS CLINICAL REPORTING;;MAY 25, 2018;Build 66
 ;
 ;
I1AGE ;EP
 S BGPHD1="FEMALE ACTIVE CLINICAL PATIENTS 55+",BGPHD2="Female Active Clinical Pts 55+ w/fracture"
...
I1AGEP ;
 ...
 S X="# w/osteoporosis treatment or testing" D S(X,1,1)
...
CALC(N,O) ;
 ...
 Q Z
H3 ;EP
 S X="Osteoporosis Management" D S(X,1,1) S Y=" " D S(Y,1,1) S X=BGPHD1 D S(X,1,1) S Y=" " D S(Y,1,1)
