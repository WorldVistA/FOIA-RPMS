...
MEX ;
 ...
 ;I $$PLTAX^BGP8DU(P,"BGP MEASLES EVIDENCE") S BGPME=4,BGPMEEV=1
...
MUX ;
 ...
 I $$PLTAX^BGP8DU(P,"BGP MUMPS EVIDENCE") S BGPMU=4,BGPMUEV=1
 I BGPMU=0 D
 .S B=$$DOB^AUPNPAT(P),E=EDATE
 .F BGPIMM=7 D
 ..S I=$O(^AUTTIMM("C",BGPIMM,0)) Q:'I
...
RUBX ;
 ...
 ;I $$PLTAX^BGP8DU(P,"BGP RUBELLA EVIDENCE") S BGPRUB=4,BGPRUEV=1
