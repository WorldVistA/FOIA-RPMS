BGP7ELLE ; IHS/CMI/LAB - print ind 03 Feb 2017 10:05 AM ; 
...
I1AGEP ;
 ...
 F X=1:1:4 S V=$P(BGPDAC(X),U,9) S Y=$$SB^BGP7ELL2($J(V,6,1)) D S(Y,,X+1)
...
PR ; 
 ...
 S X="B. % Smokeless w/ % of Total Tobacco Users" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAP(X),U,9) S Y=$$SB^BGP7ELL2($J(V,6,1)) D S(Y,,X+1)
 S X=" " D S(X,1,1) S X="# ETS/Smk Home w/ % of Total Screened" D S(X,1,1)
 ...
 S X="B. Smokeless w/ % of Total Tobacco Users" D S(X,1,1)
 F X=1:1:4 S N=$P(BGPDAC(X),U,9),O=$P(BGPDAP(X),U,9) S Y=$$SB^BGP7ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="ETS/Smk Home w/ % of Total Screened" D S(X,1,1)
...
BL ;
 ...
 S X="B. % Smokeless w/ % of Total Tobacco Users" D S(X,1,1)
 F X=1:1:4 S V=$P(BGPDAB(X),U,9) S Y=$$SB^BGP7ELL2($J(V,6,1)) D S(Y,,X+1)
 S X=" " D S(X,1,1) S X="# ETS/Smk Home w/ % of Total Screened" D S(X,1,1)
 ...
 S X="B. Smokeless w/ % of Total Tobacco Users" D S(X,1,1)
 F X=1:1:4 S N=$P(BGPDAC(X),U,9),O=$P(BGPDAB(X),U,9) S Y=$$SB^BGP7ELL2($J((N-O),6,1)) D S(Y,,X+1)
 S X="ETS/Smk Home w/ % of Total Screened" D S(X,1,1)
