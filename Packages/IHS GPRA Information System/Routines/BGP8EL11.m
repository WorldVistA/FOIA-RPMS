BGP8EL11 ; IHS/CMI/LAB - print ind 1 20 Jan 2018 4:41 PM ;
...
I1AGE ;EP  special age tallies
 ...
 K BGPDAC,BGPDAP,BGPDAB S (C,D)=0 F BGPX="DPD.1","DPD.2","DPD.3","DPD.4" D I1AGE1,I1AGE2
 D I1AGEP
 Q:BGPQUIT
 S BGPHD1="MALE USER POPULATION 55+",BGPHD2="MALE User Pop"
 D HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPELIR(BGPIC,53,1,0)  D H3
 K BGPDAC,BGPDAP,BGPDAB S (D,C)=0 F BGPX="DPE.1","DPE.2","DPE.3","DPE.4" D I1AGE1,I1AGE2
 D I1AGEP
 Q:BGPQUIT
FEM ;
 S BGPHD1="FEMALE USER POPULATION 55+",BGPHD2="FEMALE User Pop"
 D HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPELIR(BGPIC,53,1,0)  D H3
 K BGPDAC,BGPDAP,BGPDAB S (C,D)=0 F BGPX="DPF.1","DPF.2","DPF.3","DPF.4" D I1AGE1,I1AGE2
 D I1AGEP
 Q
I1AGE1 ;
 ;gather up all #'s
...
I1AGEP ;
 ...
 W !!,"# w/ DM dx during",!," Report Period"
