BGP8DP6 ; IHS/CMI/LAB - print ind H ;
 ;;18.0;IHS CLINICAL REPORTING;;NOV 21, 2017;Build 51
 ;
 ;
IC1 ;EP
 S BGPORXX=$P(^BGPINDR(BGPIC,12),U,6)
 I $Y>(BGPIOSL-16),'$G(BGPSUMON) D HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPINDR(BGPIC,53,1,0) W:$D(^BGPINDR(BGPIC,53,2,0)) !,^BGPINDR(BGPIC,53,2,0)
 D H1^BGP8DPH
 ...
 Q:BGPQUIT
 D:'$G(BGPSUMON) HEADER^BGP8DPH
 F BGPPC1=BGPORXX_".7",BGPORXX_".8",BGPORXX_".9" Q:BGPQUIT  D PI^BGP8DP1C
 Q:BGPQUIT
 D I1AGE
 Q
