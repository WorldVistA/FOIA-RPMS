BGP8GNT9 ; IHS/CMI/LAB - CRS 27 Apr 2010 10:56 PM 13 Dec 2006 7:35 AM ;
...
EP1 ;
 ...
 S BGPBEN=1
 ;ADDED FOR 09 REPORT
 S BGPBD=3181001,BGPED=3190930
 S BGPBBD=3091001,BGPBED=3100930
 S BGPPBD=3171001,BGPPED=3180930
 S BGPPER=3190000,BGPQTR=4,BGPBEN=1
 S BGPNGR09=1
 ;
...
NT ;
 ...
 I $G(BGPEXPT) S BGPFILEN="BG"_$$FV^BGP8BAN()_$P(^AUTTLOC(DUZ(2),0),U,10)_"."_BGPRPT_"  in directory "_BGPUF
 S BGPDELT=""
 ;I BGPYWCHW=2 D
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="NTLGP^BGP8GNT9",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI NATL GPRA RPT 10 FOR 11" D ^%ZTLOAD
