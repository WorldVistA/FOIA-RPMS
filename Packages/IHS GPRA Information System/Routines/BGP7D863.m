BGP7D863 ; IHS/CMI/LAB - measure C ;
...
MEDSPRE(P,BDATE,EDATE) ;EP
 ...
 .Q:Z=""  ;BAD POINTER
 .I $D(^ATXAX(T1,21,"B",Z))!($$VAPI^BGP7D81(Z,T4)) S BGPZ("A")=1 Q
 ...
 .S Z=$P($G(^AUPNVMED(Y,0)),U) ;get drug ien
 .Q:Z=""  ;BAD POINTER
 .I $D(^ATXAX(T1,21,"B",Z))!($$VAPI^BGP7D81(Z,T4)) D
 ..S BGPZ("C")=1
 ;now check for D
 ...
 .S Z=$P($G(^AUPNVMED(Y,0)),U) ;get drug ien
 .Q:Z=""  ;BAD POINTER
 .I $D(^ATXAX(T1,21,"B",Z))!($$VAPI^BGP7D81(Z,T4)) S BGPZ("D")=1
 ;now check for E
 ...
 .S Z=$P($G(^AUPNVMED(Y,0)),U)
 .Q:Z=""  ;BAD POINTER
 .I $D(^ATXAX(T1,21,"B",Z))!($$VAPI^BGP7D81(Z,T4)) S BGPZ("F")=1
 ;now check for G
 ...
 .S Z=$P($G(^AUPNVMED(Y,0)),U)
 .Q:Z=""  ;BAD POINTER
 .I $D(^ATXAX(T1,21,"B",Z))!($$VAPI^BGP7D81(Z,T4)) S BGPZ("G")=1
 ;now check for H
 ...
 .S Z=$P($G(^AUPNVMED(Y,0)),U) ;get drug ien
 .Q:Z=""  ;BAD POINTER
 .I $D(^ATXAX(T1,21,"B",Z))!($$VAPI^BGP7D81(Z,T4)) S BGPZ("H")=1
 ;now check for I
 ...
 .S Z=$P($G(^AUPNVMED(Y,0)),U) ;get drug ien
 .Q:Z=""  ;BAD POINTER
 .I $D(^ATXAX(T1,21,"B",Z))!($$VAPI^BGP7D81(Z,T4)) S BGPZ("I")=1
 ;now check for J
 ...
 .S Z=$P($G(^AUPNVMED(Y,0)),U) ;get drug ien
 .Q:Z=""  ;BAD POINTER
 .I $D(^ATXAX(T1,21,"B",Z))!($$VAPI^BGP7D81(Z,T4)) S BGPZ("J")=1
 ;now check for K
 ...
 .S Z=$P($G(^AUPNVMED(Y,0)),U) ;get drug ien
 .Q:Z=""  ;BAD POINTER
 .I $D(^ATXAX(T1,21,"B",Z))!($$CLASS^BGP7D82(Z,T4))!($$VAPI^BGP7D81(Z,T5)) S BGPZ("K")=1
...
COUNTD ;count # days except for im gold and count hits
 ...
 .S Z=$P($G(^AUPNVMED(Y,0)),U) ;get drug ien
 .Q:Z=""  ;BAD POINTER
 .I $D(^ATXAX(T1,21,"B",Z))!($$VAPI^BGP7D81(Z,T4)) D  Q
 ..S $P(BGPZ("A"),U,2)=$P(BGPZ("A"),U,2)+$$DAYS^BGP7D82(Y,V,EDATE)
 ...
 .Q:Z=""  ;BAD POINTER
 .I $D(^ATXAX(T1,21,"B",Z))!($$VAPI^BGP7D81(Z,T4)) D
 ..S $P(BGPZ("C"),U,2)=$P(BGPZ("C"),U,2)+$$DAYS^BGP7D82(Y,V,EDATE)
 ;now check for D
 S T1=$O(^ATXAX("B","BGP RA LEFLUNOMIDE MEDS",0))
 S T4=$O(^ATXAX("B","BGP RA LEFLUNOMIDE VAPI",0))
 S X=0 F  S X=$O(BGPMEDS1(X)) Q:X'=+X  S V=$P(BGPMEDS1(X),U,5),Y=+$P(BGPMEDS1(X),U,4) D
 ...
 .S Z=$P($G(^AUPNVMED(Y,0)),U) ;get drug ien
 .Q:Z=""  ;BAD POINTER
 .I $D(^ATXAX(T1,21,"B",Z))!($$VAPI^BGP7D81(Z,T4)) S $P(BGPZ("D"),U,2)=$P(BGPZ("D"),U,2)+$$DAYS^BGP7D82(Y,V,EDATE)
 ;now check for E
 S T1=$O(^ATXAX("B","BGP RA METHOTREXATE MEDS",0))
 S T4=$O(^ATXAX("B","BGP RA METHOTREXATE VAPI",0))
 S X=0 F  S X=$O(BGPMEDS1(X)) Q:X'=+X  S V=$P(BGPMEDS1(X),U,5),Y=+$P(BGPMEDS1(X),U,4) D
 ...
 .Q:Z=""  ;BAD POINTER
 .I $D(^ATXAX(T1,21,"B",Z))!($$VAPI^BGP7D81(Z,T4)) D
 ..S $P(BGPZ("E"),U,2)=$P(BGPZ("E"),U,2)+$$DAYS^BGP7D82(Y,V,EDATE)
 ;now check for F
 S T1=$O(^ATXAX("B","BGP RA CYCLOSPORINE MEDS",0))
 S T4=$O(^ATXAX("B","BGP RA CYCLOSPORINE VAPI",0))
 S X=0 F  S X=$O(BGPMEDS1(X)) Q:X'=+X  S V=$P(BGPMEDS1(X),U,5),Y=+$P(BGPMEDS1(X),U,4) D
 ...
 .S Z=$P($G(^AUPNVMED(Y,0)),U) ;get drug ien
 .Q:Z=""  ;BAD POINTER
 .I $D(^ATXAX(T1,21,"B",Z))!($$VAPI^BGP7D81(Z,T4)) S $P(BGPZ("F"),U,2)=$P(BGPZ("F"),U,2)+$$DAYS^BGP7D82(Y,V,EDATE)
 ;now check for G
 S T1=$O(^ATXAX("B","BGP RA ORAL GOLD MEDS",0))
 S T4=$O(^ATXAX("B","BGP RA ORAL GOLD VAPI",0))
 S X=0 F  S X=$O(BGPMEDS1(X)) Q:X'=+X  S V=$P(BGPMEDS1(X),U,5),Y=+$P(BGPMEDS1(X),U,4) D
 ...
 .S Z=$P($G(^AUPNVMED(Y,0)),U) ;get drug ien
 .Q:Z=""  ;BAD POINTER
 .I $D(^ATXAX(T1,21,"B",Z))!($$VAPI^BGP7D81(Z,T4)) S $P(BGPZ("G"),U,2)=$P(BGPZ("G"),U,2)+$$DAYS^BGP7D82(Y,V,EDATE)
 ;now check for H
 S T1=$O(^ATXAX("B","BGP RA MYCOPHENOLATE MEDS",0))
 S T4=$O(^ATXAX("B","BGP RA MYCOPHENOLATE VAPI",0))
 S X=0 F  S X=$O(BGPMEDS1(X)) Q:X'=+X  S V=$P(BGPMEDS1(X),U,5),Y=+$P(BGPMEDS1(X),U,4) D
 ...
 .S Z=$P($G(^AUPNVMED(Y,0)),U) ;get drug ien
 .Q:Z=""  ;BAD POINTER
 .I $D(^ATXAX(T1,21,"B",Z))!($$VAPI^BGP7D81(Z,T4)) S $P(BGPZ("H"),U,2)=$P(BGPZ("H"),U,2)+$$DAYS^BGP7D82(Y,V,EDATE)
 ;now check for I
 S T1=$O(^ATXAX("B","BGP RA PENICILLAMINE MEDS",0))
 S T4=$O(^ATXAX("B","BGP RA PENICILLAMINE VAPI",0))
 S X=0 F  S X=$O(BGPMEDS1(X)) Q:X'=+X  S V=$P(BGPMEDS1(X),U,5),Y=+$P(BGPMEDS1(X),U,4) D
 ...
 .S Z=$P($G(^AUPNVMED(Y,0)),U) ;get drug ien
 .Q:Z=""  ;BAD POINTER
 .I $D(^ATXAX(T1,21,"B",Z))!($$VAPI^BGP7D81(Z,T4)) S $P(BGPZ("I"),U,2)=$P(BGPZ("I"),U,2)+$$DAYS^BGP7D82(Y,V,EDATE)
 ;now check for J
 S T1=$O(^ATXAX("B","BGP RA SULFASALAZINE MEDS",0))
 S T4=$O(^ATXAX("B","BGP RA SULFASALAZINE VAPI",0))
 S X=0 F  S X=$O(BGPMEDS1(X)) Q:X'=+X  S V=$P(BGPMEDS1(X),U,5),Y=+$P(BGPMEDS1(X),U,4) D
 ...
 .S Z=$P($G(^AUPNVMED(Y,0)),U) ;get drug ien
 .Q:Z=""  ;BAD POINTER
 .I $D(^ATXAX(T1,21,"B",Z))!($$VAPI^BGP7D81(Z,T4)) S $P(BGPZ("J"),U,2)=$P(BGPZ("J"),U,2)+$$DAYS^BGP7D82(Y,V,EDATE)
 ;now check for K
 S T1=$O(^ATXAX("B","BGP RA GLUCOCORTICOIDS MEDS",0))
 S T4=$O(^ATXAX("B","BGP RA GLUCOCORTICOIDS CLASS",0))
 S (X,G,M,E)=0,C="" F  S X=$O(BGPMEDS1(X)) Q:X'=+X  S V=$P(BGPMEDS1(X),U,5),Y=+$P(BGPMEDS1(X),U,4) D
 ...
 .S Z=$P($G(^AUPNVMED(Y,0)),U) ;get drug ien
 .Q:Z=""  ;BAD POINTER
 .I $D(^ATXAX(T1,21,"B",Z))!($$CLASS^BGP7D82(Z,T4)) S $P(BGPZ("K"),U,2)=$P(BGPZ("K"),U,2)+$$DAYS^BGP7D82(Y,V,EDATE)
