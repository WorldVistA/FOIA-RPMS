BGP7XTEO ; IHS/CMI/LAB - TAXONOMY CHECK FOR  CRS REPORT ;
 ;;17.1;IHS CLINICAL REPORTING;;MAY 10, 2017;Build 29
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2017 Executive Order Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BGP7XTEO",XBNS="",XBRX="XIT^BGP7XTEO"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
...
GUICHK ;EP
 ...
 .Q:'$D(^BGPTAXG(BGPY,12,"B",8))  ;8 IS SET OF CODES FOR EO REPORT
