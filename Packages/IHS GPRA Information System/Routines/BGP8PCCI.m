BGP8PCCI ;IHS/CMI/LAB - AREA GPRA; ; 02 Feb 2018  11:25 AM
...
CALCIND ;EP
 ...
 .F X=1:1:10 S Y="BGPN"_X K @Y
 .F X=1:1:10 S Y="BGPD"_X K @Y
 .K ^TMP($J)
 .S BGPVALUE=""
 ...
 ..S BGPN=$P(^DD(90560.03,BGPNF,0),U,4),N=$P(BGPN,";"),P=$P(BGPN,";",2)
