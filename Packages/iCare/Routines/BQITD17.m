BQITD17 ;GDIT/HS/ALA-CKD Stage 3 ; 28 Jan 2015  8:41 AM
...
POP(BQARY,TGLOB) ; EP -- By population
 ;
 ;Description
 ;  Finds all patients who meet the criteria for Chronic Kidney Disease Stage 3
 ;Input
 ...
 ; If already ESRD or Stage 5 or Stage 4, then cannot be at Stage 3
 NEW TDFN,TDXNCN
 S TDFN=""
...
PAT(DEF,BTGLOB,BDFN) ; EP -- By patient
 ...
 ;
 ; if the person has already been identified as ESRD, Stage 5, or Stage 4
 NEW I,TEXT
 F I=1:1 S TEXT=$T(TAG+I) Q:TEXT=" Q"  D
 . S TDXNCN=$P(TEXT,";;",2) D
