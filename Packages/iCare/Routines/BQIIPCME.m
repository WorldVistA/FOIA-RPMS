...
RET(DATA,DATE,PLIST) ;EP -- BQI IPC PROV MON EXPORT NDW
 ...
 ;
 K Z
 S HDR="T00050PROVIDER^T00060IPC_MEAS^T00015TDATE^T00030NUMERATOR^T00030DENOMINATOR"
 ;S @DATA@(II)=HDR
 ;S @DATA@(II)=HDR_$C(30)
 ;
 ...
 .. S FDATA=DDATA(PRV,ID)_Z(PRV,ID,DATE)_U
...
RTE(PRV) ;EP
 ...
 . ;
 . S DDATA(PRV,ID)=PRVR_U_MEAS_U_$$DATE(DATE)_U
 . I IID="IPC_PEMP" D  Q
