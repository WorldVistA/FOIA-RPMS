IS00029B ;Compiled from script 'Generated: HL IHS IZV04 V03VXR OUT-O' on FEB 22, 2018
 ;Part 3
 ;Copyright 2018 SAIC
EN S:$TR(L1,$G(SUBDELIM))="" L1="" D SETPIECE^INHU(.LINE,DELIM,11,L1,.CP) S L1=$G(@INV@("PV119")) S:$TR(L1,$G(SUBDELIM))="" L1="" D SETPIECE^INHU(.LINE,DELIM,20,L1,.CP)
