IS00011B ;Compiled from script 'Generated: HL IHS IZV04 OUT-O' on AUG 15, 2018
 ;Part 3
 ;Copyright 2018 SAIC
EN S D0=INDA S Y(1)=$S($D(^AUPN3PPH(D0,0)):^(0),1:"") S X=$P(Y(1),U,9),Y(2)=$G(X) S X=1,Y(3)=$G(X) S X=106,X=$E(Y(2),Y(3),X)
...
G1 S INDA=INDA0 K INDA0
 ...
 ..S @INV@("IN147")=X K DXS,D0
 ..;SET IN149 = INSGX\^INTHL7FT(1,3)\\99\@IN1RRE49
 ..S D0=INDA S X=$G(INA("IN1RRE49",INI(1),INI(2)))
