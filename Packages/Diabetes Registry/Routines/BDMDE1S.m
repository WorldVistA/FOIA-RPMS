...
BMI ;
 ...
 S H=$G(^XTMP("BDMDMDATA",BDMJOB,BDMBTH,"AUDIT",BDMPD,30))
 S W=$G(^XTMP("BDMDMDATA",BDMJOB,BDMBTH,"AUDIT",BDMPD,32))
 S $P(BDMCUML(10,3),U,3)=$P($G(BDMCUML(10,3)),U,3)+1  ;DENOM
 I H]"",W]"" S $P(BDMCUML(10,3),U,2)=$P(BDMCUML(10,3),U,2)+1 ;NUMER
PA ;
 S N=$E($G(^XTMP("BDMDMDATA",BDMJOB,BDMBTH,"AUDIT",BDMPD,44)))
 S P=$E($G(^XTMP("BDMDMDATA",BDMJOB,BDMBTH,"AUDIT",BDMPD,46)))
...
CHD ;
 ...
 S C=$G(^XTMP("BDMDMDATA",BDMJOB,BDMBTH,"AUDIT",BDMPD,28))
