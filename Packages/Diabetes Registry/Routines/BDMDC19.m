BDMDC19 ; IHS/CMI/LAB - 2015 DIABETES AUDIT ;
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**8,9,10,11**;JUN 14, 2007;Build 30
 ;
 ;
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2015 Audit. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BDMDC19",XBNS="",XBRX="XIT^BDMDC19"
 D ^XBDBQUE
 D XIT
 Q
...
GUICHK ;EP
 ...
 W !!,"In order for the 2015 DM AUDIT Report to find all necessary data, several",!,"taxonomies must be established.  The following taxonomies are missing or have",!,"no entries:"
