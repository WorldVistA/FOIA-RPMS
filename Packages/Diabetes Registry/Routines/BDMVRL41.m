...
APCLEXAM ;EP;LAST EXAM
 ...
 .S Z=$$DFE^BDMDE17(DFN,"","","D",1)
 I BDMFU="EYE" D
 .S BDM("FOLLOW-UP TYPE")="EYE EXAM"
 .S Z=$P($$EYE^BDMDE17(DFN,"","","D",1),U,1)
 I BDMFU="DENT" D
 .S BDM("FOLLOW-UP TYPE")="DENTAL EXAM"
 .S Z=$$DENTAL^BDMDE17(DFN,"","","D",1)
 I BDMFU="DEP" D
 .S BDM("FOLLOW-UP TYPE")="DEPRESSION SCR"
 .S Z=$$DEPSCR^BDMDE12(DFN,"","","D",1)
 ;I BDMFU="EKG" D
 ;.S BDM("FOLLOW-UP TYPE")="EKG"
 ;.S Z=$$EKG^BDMDE12(DFN,DT,"D")
...
FLUC ;EP
 ...
 S Z=$$FLU^BDMDE13(DFN,$$DOB^AUPNPAT(DFN),DT,1,"D")
 I Z="" D FUNO^BDMVRL4 Q
 S Z=9999999-Z
 K X2
 D FULAST^BDMVRL4
