...
AS ;EP;TO REVIEW AUDIT STATUS
 ...
 S BDMBTH=$H
 S BDMDMRG=BDMRDA
 S ^XTMP("BDMDMDATA",BDMJOB,BDMBTH,"PATS",DFN)=""
 S ^TMP("BDMDMDATA",BDMJOB,BDMBTH,"PATS",DFN)=""
 D TIME^BDMDE1
 Q:$G(BDMSTP)
 D EN^XBNEW("IAEP^BDMDE1","BDMJOB;BDMBTH;BDMDMRG;BDMADAT;BDMRED;BDMBDAT;BDMRBD")
 Q
 ;
