...
GENDER ;
 ...
 S V=$G(^XTMP("BDMDM17",BDMJOB,BDMBTH,"AUDIT",BDMPD,20))
...
BMI ;
 ...
 ;S V=$G(^XTMP("BDMDM17",BDMJOB,BDMBTH,"AUDIT",BDMPD,112))
...
TBSTAT ;
 ...
 I $E($P(V,"||",2))=1,$E($G(^XTMP("BDMDM17",BDMJOB,BDMBTH,"AUDIT",BDMPD,72)))=1 S $P(BDMCUML(70),U,7)=$P(BDMCUML(70),U,7)+1
 I $E($P(V,"||",2))=2 D
 .S $P(BDMCUML(70),U,9)=$P(BDMCUML(70),U,9)+1
 .S X=$G(^XTMP("BDMDM17",BDMJOB,BDMBTH,"AUDIT",BDMPD,114))
...
TOBACCO ;
 ...
 S V1=$G(^XTMP("BDMDM17",BDMJOB,BDMBTH,"AUDIT",BDMPD,28))
...
ENDS ;
 ...
 S V=$G(^XTMP("BDMDM17",BDMJOB,BDMBTH,"AUDIT",BDMPD,31))
 ...
 S T=$G(^XTMP("BDMDM17",BDMJOB,BDMBTH,"AUDIT",BDMPD,27))  ;TOBACCO USER
...
ASPIRIN ;
 ...
 I $E($G(^XTMP("BDMDM17",BDMJOB,BDMBTH,"AUDIT",BDMPD,116)))'=1 G LIPIDAG  ;not cvd
 S $P(BDMCUML(100),U,2)=$P(BDMCUML(100),U,2)+1  ;total with cvd
 S V=$G(^XTMP("BDMDM17",BDMJOB,BDMBTH,"AUDIT",BDMPD,62))
...
LIPIDAG ;lipid agents
 ...
 S C=0
 I $E($G(^XTMP("BDMDM17",BDMJOB,BDMBTH,"AUDIT",BDMPD,116)))=1 D
 ...
 ;
LIPID ;115
 S V=$G(^XTMP("BDMDM17",BDMJOB,BDMBTH,"AUDIT",BDMPD,61))
...
EXAMS ;
 ...
 S V=$G(^XTMP("BDMDM17",BDMJOB,BDMBTH,"AUDIT",BDMPD,108))
