BDMPG19 ; IHS/CMI/LAB - 2003 DIABETES AUDIT ;
 ;;2.0;IHS DIABETES SYSTEM;**12**;JUN 14, 2007;Build 51
 ;
 ;
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2019 Pre-Diabetes Audit. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BDMPG19",XBNS="",XBRX="XIT^BDMPG19"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
 W:$D(IOF) @IOF
 K BDMQUIT
 W !,"Checking for Taxonomies to support the 2019 Pre-Diabetes Audit...",!
 ...
 W !!,"In order for the 2019 Diabetes Audit to find all necessary data, several",!,"taxonomies must be established.  The following taxonomies are missing, have",!,"no entries or contain a panel test and should not:",!
...
TEXTD ;EP
 ...
 ;;**   2019 Diabetes Audit Report Menu  **
 ;;****************************************
 ;;QUIT
PAGE ;
