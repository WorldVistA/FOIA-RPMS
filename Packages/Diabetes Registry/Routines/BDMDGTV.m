...
PAUSE ;EP
 ...
 Q
HDR ; -- header code
 S VALMHDR(1)="TAXONOMIES TO SUPPORT 2019 DIABETES/PRE-DIABETES AUDIT REPORTING"
...
DISP ;EP - add an item to the selected list - called from a protocol
 ...
 S XBRP="PRINT^BDMDGTV",XBRC="",XBRX="XIT^BDMDGTV",XBNS="BDM"
 D ^XBDBQUE
 D DISPX
 Q
BROWSE ;
 S XBRP="VIEWR^XBLM(""PRINT^BDMDGTV"")"
 S XBRC="",XBRX="XIT^BDMDGTV",XBIOP=0 D ^XBDBQUE
 Q
PHDR ;
 I 'BDMPG G HEAD1
