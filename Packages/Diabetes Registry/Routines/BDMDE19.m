BDMDE19 ; IHS/CMI/LAB - 2017 DIABETES AUDIT ;
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**10,11,12**;JUN 14, 2007;Build 51
 ;
 ;
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2017 Audit. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BDMDE19",XBNS="",XBRX="XIT^BDMDE19"
 D ^XBDBQUE
 D XIT
 Q
...
GUICHK ;EP
 ...
 W !!,"In order for the 2017 DM AUDIT Report to find all necessary data, several",!,"taxonomies must be established.  The following taxonomies are missing or have",!,"no entries:"
