BDMS9B3 ; IHS/CMI/LAB - women's health supplement ; 27 Jan 2011  6:56 AM
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**3,4,5,8,9,10,11**;JUN 14, 2007;Build 30
 ;
...
TD(P,BDMBD,BDMSED,F) ;EP
 ...
 .S G=$$REFUSAL^BDMDF17(P,9999999.14,$O(^AUTTIMM("C",R,0)),$$FMADD^XLFDT(BDMSED,-365),DT,"R")
...
FLUR ;
 ...
 .S G=$$REFUSAL^BDMDF17(P,9999999.14,$O(^AUTTIMM("C",R,0)),D,DT,"R")
 I G Q "Refused "_$P(G,U,3)
