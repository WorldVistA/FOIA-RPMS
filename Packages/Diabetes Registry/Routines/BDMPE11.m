BDMPE11 ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT ;
...
EKG ;need date of last ekg
 ...
 S V=$$EKG^BDMPE12(BDMPE,BDMRED,"I")
 I V]"" D
...
TCHOL ;
 ...
 S V=$$CHOL^BDMDE18(BDMPE,BDMBDAT,BDMADAT,"I")
...
LDL ;
 ...
 S V=$$LDL^BDMDE18(BDMPE,BDMBDAT,BDMADAT,"I")
...
HDL ;
 ...
 S V=$$HDL^BDMDE18(BDMPE,BDMBDAT,BDMADAT,"I")
...
TRIG ;
 ...
 S V=$$TRIG^BDMDE18(BDMPE,BDMBDAT,BDMADAT,"I")
...
FAST ;
 ...
 S V=$$FGLUCOSE^BDMDE18(BDMPE,$P(^DPT(BDMPE,0),U,3),BDMADAT,"I")
...
G75 ;
 ...
 S V=$$G75^BDMDE18(BDMPE,$P(^DPT(BDMPE,0),U,3),BDMADAT,"I")
