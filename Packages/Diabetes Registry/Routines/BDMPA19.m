BDMPA19 ; IHS/CMI/LAB - 2003 DIABETES AUDIT ; 09 Nov 2017  3:45 PM
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**6,11,12**;JUN 14, 2007;Build 51
 ;
 ;
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2013 Pre-Diabetes Audit. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BDMPA19",XBNS="",XBRX="XIT^BDMPA19"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
 W:$D(IOF) @IOF
 K BDMQUIT
 W !,"Checking for Taxonomies to support the 2013 Pre-Diabetes Audit...",!
 ...
 W !!,"In order for the 2013 Diabetes Audit to find all necessary data, several",!,"taxonomies must be established.  The following taxonomies are missing, have",!,"no entries or contain a panel test and should not:",!
...
BANNER ;EP - banner for 2003 audit menu
 S BDMTEXT="TEXTD",BDM("VERSION")="2.0 (Patch 6)"
...
TEXTD ;EP
 ...
 ;;**   2013 Diabetes Audit Report Menu  **
 ;;****************************************
 ;;QUIT
PAGE ;
