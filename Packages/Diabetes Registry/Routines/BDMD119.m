BDMD119 ; IHS/CMI/LAB - 2011 DIABETES AUDIT ; 21 Jan 2014  10:53 AM
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**4,5,6,7,8,9,10**;JUN 14, 2007;Build 12
 ;
 ;
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2011 Audit. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BDMD119",XBNS="",XBRX="XIT^BDMD119"
 D ^XBDBQUE
 D XIT
 Q
...
GUICHK ;EP
 ...
 W !!,"In order for the 2011 DM AUDIT Report to find all necessary data, several",!,"taxonomies must be established.  The following taxonomies are missing or have",!,"no entries:"
...
LASTHF(P,C,BDATE,EDATE,F) ;EP - get last factor in category C for patient P
 ...
 Q 1
 ;;
BANNER ;EP - banner for 2011 audit menu
...
TEXTD ;EP
 ...
 ;;**   2011 Diabetes Audit Report Menu  **
 ;;****************************************
 ;;QUIT
PAGE ;
