BDMD419 ; IHS/CMI/LAB - 2012 DIABETES AUDIT ; 21 Jan 2014  10:54 AM
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**5,6,7,8,9,10**;JUN 14, 2007;Build 12
 ;
 ;
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2012 Audit. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BDMD419",XBNS="",XBRX="XIT^BDMD419"
 D ^XBDBQUE
 D XIT
 Q
...
GUICHK ;EP
 ...
 W !!,"In order for the 2012 DM AUDIT Report to find all necessary data, several",!,"taxonomies must be established.  The following taxonomies are missing or have",!,"no entries:"
...
TEXTD ;EP
 ...
 ;;**   2012 Diabetes Audit Report Menu  **
 ;;****************************************
 ;;QUIT
PAGE ;
