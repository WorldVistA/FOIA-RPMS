BDMD91E ; IHS/CMI/LAB - IHS Diabetes Audit 2009 ;
...
REGASK ;
 ...
 W !!,"This option is used to run the 2009 Electronic Diabetes Audit for a"
...
COMM ;get gpra community taxonomy
 ...
 S B=$P($G(^BGPSITE($S($G(BDMDUZ2):BDMDUZ2,1:DUZ(2)),0)),U,5) I B S DIC("B")=$P(^ATXAX(B,0),U)
 D ^DIC K DIC
 I Y=-1 Q
 S BDMTAXI=+Y
COM1 S X=0
...
ZIS ;
 I BDMPREP'=2 S XBRP="^BDMD91P",XBRC="EAUDIT^BDMD910",XBRX="XIT^BDMD91",XBNS="BDM"
 I BDMPREP=2 S XBRP="",XBRC="EAUDIT^BDMD910",XBRX="XIT^BDMD91",XBNS="BDM"
 D ^XBDBQUE
 D XIT
 Q
P ;
...
BDMG(BDMJOB,BDMBTH,BDMDMRG,BDMADAT,BDMTYPE,BDMSTMP,BDMPCP,BDMCOM,BDMRAND,BDMRCNT,BDMCMS,BDMSTAT,BDMPREP,BDMFILE,BDMDSP,BDMGIEN,BDMSDPI,BDMSDPG,BDMDUZ2) ;PEP - gui call
 ...
 N BDMOPT  ;maw
 S BDMOPT="Run the 2009 Audit w/predefined set of Pts"  ;maw
 D NOW^%DTC
 S BDMNOW=$G(%)
 K DD,D0,DIC
 S X=BDMJOB_"."_BDMBTH
 ...
 S ZTIO="",ZTDTH=$$NOW^XLFDT,ZTRTN="GUIEP^BDMD91E",ZTDESC="GUI DM AUDIT" D ^%ZTLOAD
 D XIT
 Q
