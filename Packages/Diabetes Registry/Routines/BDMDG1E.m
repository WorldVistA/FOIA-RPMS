BDMDG1E ; IHS/CMI/LAB - IHS Diabetes Audit 2019 ;
...
ZIS ;
 ...
 I BDMPREP'=2 S XBRP="^BDMDG1P",XBRC="EAUDIT^BDMDG10",XBRX="XIT^BDMDG1",XBNS="BDM"
 I BDMPREP=2 S XBRP="",XBRC="EAUDIT^BDMDG10",XBRX="XIT^BDMDG1",XBNS="BDM"
 D ^XBDBQUE
 D XIT
 Q
P ;
...
BDMG(BDMJOB,BDMBTH,BDMDMRG,BDMADAT,BDMTYPE,BDMSTMP,BDMPDP,BDMCOM,BDMRAND,BDMRCNT,BDMCMS,BDMSTAT,BDMPREP,BDMFILE,BDMDSP,BDMGIEN,BDMSDPI,BDMSDPG,BDMDUZ2,BDMDEMO,BDMDQ) ;PEP - gui call
 ...
 N BDMOPT  ;maw
 S BDMOPT="Run the 2019 Audit w/predefined set of Pts"  ;maw
 D NOW^%DTC
 S BDMNOW=$G(%)
 K DD,D0,DIC
 S X=DUZ_"."_BDMBTH
 ...
 S ZTIO="",ZTDTH=$$NOW^XLFDT,ZTRTN="GUIEP^BDMDG1E",ZTDESC="GUI DM AUDIT" D ^%ZTLOAD
 D XIT
 Q
...
TEST ;
 ...
 F X=1:1:10 S ^XTMP("BDMDM19",BDMJOB,BDMBTH,"PATS",X)=""
 D BDMG^BDMDG1(BDMJOB,BDMBTH,1,DT,"P","","","","","","","",4,"TESTEPI",.BDMIEN)
 Q
