BDMD81 ; IHS/CMI/LAB - IHS Diabetes Audit 2008 ;
...
DEMO ;
 ...
 I BDMDEMO=-1 G IF
 I BDMPREP'=2 S XBRP="^BDMD81P",XBRC="^BDMD810",XBRX="XIT^BDMD81",XBNS="BDM"
 I BDMPREP=2 S XBRP="",XBRC="^BDMD810",XBRX="XIT^BDMD81",XBNS="BDM"
 D ^XBDBQUE
 D XIT
 Q
P ;
...
BDMG(BDMJOB,BDMBTH,BDMDMRG,BDMADAT,BDMTYPE,BDMSTMP,BDMPCP,BDMCOM,BDMRAND,BDMRCNT,BDMCMS,BDMSTAT,BDMPREP,BDMFILE,BDMDSP,BDMGIEN,BDMSDPI,BDMSDPG,BDMPPN) ;PEP - gui call
 ...
 N BDMOPT  ;maw
 S BDMOPT="2008 Diabetes Program Audit"
 D NOW^%DTC
 S BDMNOW=$G(%)
 K DD,D0,DIC
 S X=BDMJOB_"."_BDMBTH
 ...
 S ZTIO="",ZTDTH=$$NOW^XLFDT,ZTRTN="GUIEP^BDMD81",ZTDESC="GUI DM AUDIT" D ^%ZTLOAD
 D XIT
 Q
