...
DMA16(RETVAL,BDMSTR) ;-- dm audit 2016
 ...
 .. Q:$P(BDMPATS,R,I)=""
 .. S ^XTMP("BDMDMDATA",BDMJ,BDMH,"PATS",$P(BDMPATS,R,I))=""
 ...
 .. S ^XTMP("BDMDMDATA",BDMJ,BDMH,"PATS",BDMDA)=""
 ...
 .. S ^XTMP("BDMDMDATA",BDMJ,BDMH,"PATS",BDMRPAT)=""
 ...
 . K ^XTMP("BDMDMDATA",BDMJ,BDMH,"PATS")
 . S (X,BDMCNT)=0 F  S X=$O(^TMP($J,"PATS",X)) Q:X'=+X  S BDMCNT=BDMCNT+1
 . S C=0 F N=1:1:BDMCNT Q:C=BDMRCNT  S I=$R(BDMCNT) I I,$D(^TMP($J,"PATS",I)) S X=$O(^TMP($J,"PATS",I,0)),^XTMP("BDMDMDATA",BDMJ,BDMH,"PATS",X)="",C=C+1 K ^TMP($J,"PATS",I,X)
 . K ^TMP($J,"PATS")
...
NOWDMO16 ;EP - return the output to the screen
 ...
 S BDMDA=0 F  S BDMDA=$O(^TMP($J,"BDMDMDATA",BDMDA)) Q:'BDMDA  D
 . S BDMI=BDMI+1
 . S ^BDMTMP($J,BDMI)=$G(^TMP($J,"BDMDMDATA",BDMDA))_$C(30)
