BDMDA19 ; IHS/CMI/LAB - 2013 DIABETES AUDIT ;
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**6,9,10,11**;JUN 14, 2007;Build 30
 ;
 ;
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2013 Audit. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BDMDA19",XBNS="",XBRX="XIT^BDMDA19"
 D ^XBDBQUE
 D XIT
 Q
...
GUICHK ;EP
 ...
 W !!,"In order for the 2013 DM AUDIT Report to find all necessary data, several",!,"taxonomies must be established.  The following taxonomies are missing or have",!,"no entries:"
...
LASTHF(P,C,BDATE,EDATE,F) ;EP - get last factor in category C for patient P
 ...
 Q 1
 ;;
BANNER ;EP - banner for 2013 audit menu
