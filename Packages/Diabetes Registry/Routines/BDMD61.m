BDMD61 ; IHS/CMI/LAB - IHS Diabetes Audit 2006 ;
...
DEMO ;
 ...
 I BDMDEMO=-1 G IF
 I BDMPREP'=2 S XBRP="^BDMD61P",XBRC="^BDMD610",XBRX="XIT^BDMD61",XBNS="BDM"
 I BDMPREP=2 S XBRP="",XBRC="^BDMD610",XBRX="XIT^BDMD61",XBNS="BDM"
 D ^XBDBQUE
 D XIT
 Q
P ;
...
BDMG(BDMJOB,BDMBTH,BDMDMRG,BDMADAT,BDMTYPE,BDMSTMP,BDMPCP,BDMCOM,BDMRAND,BDMRCNT,BDMCMS,BDMSTAT,BDMPREP,BDMFILE,BDMDSP,BDMGIEN,BDMSDPI,BDMSDPG) ;PEP - gui call
 ...
 N BDMOPT  ;maw
 S BDMOPT="2006 Diabetes Program Audit"
 D NOW^%DTC
 S BDMNOW=$G(%)
 K DD,D0,DIC
 S X=BDMJOB_"."_BDMBTH
 ...
 S ZTIO="",ZTDTH=$$NOW^XLFDT,ZTRTN="GUIEP^BDMD61",ZTDESC="GUI DM AUDIT" D ^%ZTLOAD
 D XIT
 Q
