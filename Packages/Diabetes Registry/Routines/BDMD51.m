...
DEMO ;
 ...
 I BDMDEMO=-1 G IF
 I BDMPREP'=2 S XBRP="^BDMD51P",XBRC="^BDMD510",XBRX="XIT^BDMD51",XBNS="BDM"
 I BDMPREP=2 S XBRP="",XBRC="^BDMD510",XBRX="XIT^BDMD51",XBNS="BDM"
 D ^XBDBQUE
 D XIT
 Q
P ;
...
BDMG(BDMJOB,BDMBTH,BDMDMRG,BDMADAT,BDMTYPE,BDMSTMP,BDMPCP,BDMCOM,BDMRAND,BDMRCNT,BDMCMS,BDMSTAT,BDMPREP,BDMFILE,BDMDSP,BDMGIEN,BDMSDPI,BDMSDPG) ;PEP - gui call
 ...
 N BDMOPT  ;maw
 S BDMOPT="2005 Diabetes Program Audit"
 D NOW^%DTC
 S BDMNOW=$G(%)
 K DD,D0,DIC
 S X=BDMJOB_"."_BDMBTH
 ...
 S ZTIO="",ZTDTH=$$NOW^XLFDT,ZTRTN="GUIEP^BDMD51",ZTDESC="GUI DM AUDIT" D ^%ZTLOAD
 D XIT
 Q
