BDMD41E ; IHS/CMI/LAB - IHS Diabetes Audit 2012 ;
...
REGASK ;
 ...
 W !!,"This option is used to run the 2012 Electronic Diabetes Audit for a"
...
ZIS ;
 ...
 I BDMPREP'=2 S XBRP="^BDMD41P",XBRC="EAUDIT^BDMD410",XBRX="XIT^BDMD41",XBNS="BDM"
 I BDMPREP=2 S XBRP="",XBRC="EAUDIT^BDMD410",XBRX="XIT^BDMD41",XBNS="BDM"
 D ^XBDBQUE
 D XIT
 Q
P ;
...
BDMG(BDMJOB,BDMBTH,BDMDMRG,BDMADAT,BDMTYPE,BDMSTMP,BDMPCP,BDMCOM,BDMRAND,BDMRCNT,BDMCMS,BDMSTAT,BDMPREP,BDMFILE,BDMDSP,BDMGIEN,BDMSDPI,BDMSDPG,BDMDUZ2,BDMDEMO) ;PEP - gui call
 ...
 N BDMOPT  ;maw
 S BDMOPT="Run the 2012 Audit w/predefined set of Pts"  ;maw
 D NOW^%DTC
 S BDMNOW=$G(%)
 K DD,D0,DIC
 S X=DUZ_"."_BDMBTH
 ...
 S ZTIO="",ZTDTH=$$NOW^XLFDT,ZTRTN="GUIEP^BDMD41E",ZTDESC="GUI DM AUDIT" D ^%ZTLOAD
 D XIT
 Q
...
TEST ;
 ...
 D BDMG^BDMD41(BDMJOB,BDMBTH,1,DT,"P","","","","","","","",4,"TESTEPI",.BDMIEN)
 Q
