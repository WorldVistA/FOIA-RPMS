BDMDF1P ; IHS/CMI/LAB - 2018 DIABETES AUDIT PRINT 15 Dec 2016 3:05 PM ; 
 ...
 S BDMPD=0,BDMGUIC=0 F  S BDMPD=$O(^XTMP("BDMDM18",BDMJOB,BDMBTH,"AUDIT",BDMPD)) Q:BDMPD'=+BDMPD!(BDMQUIT)  D
 .I $G(BDMGUI),BDMGUIC W !,"ZZZZZZZ",!  ;maw
 .S BDMGUIC=1
 .W:$D(IOF) @IOF
 .S BDMPG=BDMPG+1 W:$G(BDMGUI) !! W $$CTR("ASSESSMENT OF DIABETES CARE, 2018       DATE AUDIT RUN: "_$$FMTE^XLFDT(DT)_"  Page: "_BDMPG,80)
 ...
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 .W !,"ENDS use status:  " S Y=$P($$I(33),U,1) W $S(Y=1:"1  Current user",Y=2:"2  Not a current user",Y=3:"3  Not Documented",1:"")," ",$P($$I(33),U,3)
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 .W !!,"Visit Statistics"
 .S X=$$I(30)
 .W !!,"HEIGHT (last ever): ",X  ;$J($P(X," "),2,0)_" "_$P(X," ",2,99)  ;ROUND HT KS 1208 2 DECIMALS THROUGHOUT 2018 PER K SHEFF
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 .S %=$P($$I(32)," ",1) I %]"" S %=$$STRIP^XLFSTR($J(%,4,0)," ")
 .W !,"Last WEIGHT in audit period: ",%," ",$P($$I(32)," ",2,99),"     BMI: ",$$I(112)
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 .W !!,"HTN (documented diagnosis ever): ",$$I(34)
 ...
 .W !?3,$$I(98),?6,"4 Repaglinide (Prandin) or Nateglinide (Starlix)"
 ...
 .W !,"CVD: Cardiovascular disease diagnosed ever: ",?40,$$I(116)
 .I $Y>(BDMIOSL-6) D PAGE Q:BDMQUIT
 .W !!,"TB Testing"
 .I $Y>(BDMIOSL-2) D PAGE Q:BDMQUIT
 .W !,"TB test done ever: ",$P($$I(70),"||",1)
 .I $Y>(BDMIOSL-2) D PAGE Q:BDMQUIT
 .W !,"TB test result: ",$P($$I(70),"||",2)
 .I $Y>(BDMIOSL-2) D PAGE Q:BDMQUIT
 .W !?4,"If test positive, isoniazid treatment complete: ",?33,$P($$I(72),U),"  ",$P($$I(72),U,2)
 .I $Y>(BDMIOSL-2) D PAGE Q:BDMQUIT
 .W !?4,"If test negative, test date: ",?33,$$DATE^BDMS9B1($$I(114))
 .I $Y>(BDMIOSL-7) D PAGE Q:BDMQUIT
 .W !!,"Hepatitis C"
 .W !,"Diagnosed with HCV ever: ",$$I(222)
 .I $E($$I(222))'=1 W !,"If born 1945-1965, screened at least once ever? ",$$I(223)
 .I $Y>(BDMIOSL-3) D PAGE Q:BDMQUIT
 .W !!,"Retinopathy"
 .W !,"Retinopathy diagnosed ever: ",$$I(224)
 .I $Y>(BDMIOSL-6) D PAGE Q:BDMQUIT
 .W !!,"Immunizations"
 ...
 .I $$AGE^AUPNPAT(BDMPD,BDMADAT)<40!($E($G(^XTMP("BDMDM18",BDMJOB,BDMBTH,"AUDIT",BDMPD,300)))=3) W !?5,"This is only calculated for patients 40 years of age and older without,",!,"a statin allegry or intolerance." I 1
...
N1 .W !!,"Local Questions: ",$$LOCN^BDMDF10(BDMPD,BDMDMRG)
 .W !!,"Extended Local Option question: ",$$LOCT^BDMDF10(BDMPD,BDMDMRG)
 .I $E(IOST,1,2)'="P-" W !! S DIR(0)="E" D ^DIR K DIR
CUML ;
 I BDMPREP=4!(BDMPREP=3) D CUML^BDMDF14
 I BDMPREP=5 D SDPI^BDMDF1Q
 I BDMPREP=6 D SDPI16^BDMDF1U
 I BDMPREP=7 D QUALCHK^BDMDF1V
DONE ;
 K ^TMP($J)
 ...
 Q
I(I) ;
 Q $G(^XTMP("BDMDM18",BDMJOB,BDMBTH,"AUDIT",BDMPD,I))
 ;
PAGE ;
 Q:$G(BDMDSP)
 ...
 I $G(BDMGUI) W !!
 S BDMPG=BDMPG+1
 W $$CTR("ASSESSMENT OF DIABETES CARE, 2018         DATE AUDIT RUN: "_$$FMTE^XLFDT(DT)_"  Page: "_BDMPG,80)
