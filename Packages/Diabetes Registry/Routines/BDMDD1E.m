BDMDD1E ; IHS/CMI/LAB - IHS Diabetes Audit 2016 ;
...
REGASK ;
 ...
 W !!,"This option is used to run the 2016 Electronic Diabetes Audit for a"
...
ZIS ;
 ...
 I BDMPREP'=2 S XBRP="^BDMDD1P",XBRC="EAUDIT^BDMDD10",XBRX="XIT^BDMDD1",XBNS="BDM"
 I BDMPREP=2 S XBRP="",XBRC="EAUDIT^BDMDD10",XBRX="XIT^BDMDD1",XBNS="BDM"
 D ^XBDBQUE
 D XIT
 Q
P ;
...
WRITEF ;EP write flat file
 D WRITEF^BDMDD1
 Q
BDMG(BDMJOB,BDMBTH,BDMDMRG,BDMADAT,BDMTYPE,BDMSTMP,BDMPDP,BDMCOM,BDMRAND,BDMRCNT,BDMCMS,BDMSTAT,BDMPREP,BDMFILE,BDMDSP,BDMGIEN,BDMSDPI,BDMSDPG,BDMDUZ2,BDMDEMO) ;PEP - gui call
 ...
 N BDMOPT  ;maw
 S BDMOPT="Run the 2016 Audit w/predefined set of Pts"  ;maw
 D NOW^%DTC
 S BDMNOW=$G(%)
 K DD,D0,DIC
 S X=DUZ_"."_BDMBTH
 ...
 S ZTIO="",ZTDTH=$$NOW^XLFDT,ZTRTN="GUIEP^BDMDD1E",ZTDESC="GUI DM AUDIT" D ^%ZTLOAD
 D XIT
 Q
...
TEST ;
 ...
 F X=1:1:10 S ^XTMP("BDMDM16",BDMJOB,BDMBTH,"PATS",X)=""
 D BDMG^BDMDD1(BDMJOB,BDMBTH,1,DT,"P","","","","","","","",4,"TESTEPI",.BDMIEN)
 Q
