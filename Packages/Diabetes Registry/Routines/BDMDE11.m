...
IMM ;
 ...
 ;TDAP EVER
 S V=$G(^XTMP("BDMDMDATA",BDMJOB,BDMBTH,"AUDIT",BDMPD,216))
...
QUAN ;
 ...
 S Q=$G(^XTMP("BDMDMDATA",BDMJOB,BDMBTH,"AUDIT",BDMPD,92))
 S V=$E($G(^XTMP("BDMDMDATA",BDMJOB,BDMBTH,"AUDIT",BDMPD,92)))  ;test done?
 ...
 S G=$P($G(^XTMP("BDMDMDATA",BDMJOB,BDMBTH,"AUDIT",BDMPD,79)),U,2)  ;egfr value
 S H=0
...
GFR ;
 ...
 S V=$G(^XTMP("BDMDMDATA",BDMJOB,BDMBTH,"AUDIT",BDMPD,79))
...
ACE ;110 title^total pts^total pts with protein^# of those on ace^# with htn^# of those on ace"
 ...
 S P=$G(^XTMP("BDMDMDATA",BDMJOB,BDMBTH,"AUDIT",BDMPD,92))  ;URINE PROTEIN VALUE
 S H=$E($G(^XTMP("BDMDMDATA",BDMJOB,BDMBTH,"AUDIT",BDMPD,34)))
 S A=$E($G(^XTMP("BDMDMDATA",BDMJOB,BDMBTH,"AUDIT",BDMPD,60)))
...
CVD ;USE 250
 ...
 S V=$G(^XTMP("BDMDMDATA",BDMJOB,BDMBTH,"AUDIT",BDMPD,116))
...
COMBINED ;USE 260
 ...
 I $E($G(^XTMP("BDMDMDATA",BDMJOB,BDMBTH,"AUDIT",BDMPD,300)))=3 G E  ;statin allergy
 S V=$G(^XTMP("BDMDMDATA",BDMJOB,BDMBTH,"AUDIT",BDMPD,118))
