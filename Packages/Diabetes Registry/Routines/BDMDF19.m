BDMDF19 ; IHS/CMI/LAB - 2018 DIABETES AUDIT ;
 ...
 ;
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2018 Audit. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BDMDF19",XBNS="",XBRX="XIT^BDMDF19"
 D ^XBDBQUE
 D XIT
 Q
...
GUICHK ;EP
 ...
 W !!,"In order for the 2018 DM AUDIT Report to find all necessary data, several",!,"taxonomies must be established.  The following taxonomies are missing or have",!,"no entries:"
