BDMD01 ; IHS/CMI/LAB - IHS Diabetes Audit 2010 ;
...
DEMO ;
 ...
 I BDMPREP'=2 S XBRP="^BDMD01P",XBRC="^BDMD010",XBRX="XIT^BDMD01",XBNS="BDM"
 I BDMPREP=2 S XBRP="",XBRC="^BDMD010",XBRX="XIT^BDMD01",XBNS="BDM"
 D ^XBDBQUE
 D XIT
 Q
IAEP ;EP
...
BDMG(BDMJOB,BDMBTH,BDMDMRG,BDMADAT,BDMTYPE,BDMSTMP,BDMPCP,BDMCOM,BDMRAND,BDMRCNT,BDMCMS,BDMSTAT,BDMPREP,BDMFILE,BDMDSP,BDMGIEN,BDMSDPI,BDMSDPG,BDMPPN,BDMDUZ2) ;PEP - gui call
 ...
 N BDMOPT  ;maw
 S BDMOPT="2010 Diabetes Program Audit"
 D NOW^%DTC
 S BDMNOW=$G(%)
 K DD,D0,DIC
 S X=BDMJOB_"."_BDMBTH
 ...
 S ZTIO="",ZTDTH=$$NOW^XLFDT,ZTRTN="GUIEP^BDMD01",ZTDESC="GUI DM AUDIT" D ^%ZTLOAD
 D XIT
 Q
