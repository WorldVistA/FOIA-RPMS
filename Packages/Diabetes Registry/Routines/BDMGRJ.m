BDMGRJ ; IHS/CMI/LAB - BDM DMS GUI Reports ; 14 Nov 2017  9:56 AM
...
DEBUG(BDMRET,BDMSTR) ;-- debugger
 ...
 Q
 ;
DMA19(RETVAL,BDMSTR) ;-- dm audit 2019
 N P,R
 ...
 .. Q:$P(BDMPATS,R,I)=""
 .. S ^XTMP("BDMDM19",BDMJ,BDMH,"PATS",$P(BDMPATS,R,I))=""
 .. I BDMCALL="DM Audit P 19" D
 ... S ^XTMP("BDMPG1",BDMJ,BDMH,"PATS",$P(BDMPATS,R,I))=""
 I BDMTYP="S" D
 ...
 .. S ^XTMP("BDMDM19",BDMJ,BDMH,"PATS",BDMDA)=""
 .. S ^TMP($J,"PATS",BDMCNT,BDMDA)=""
 .. I BDMCALL="DM Audit P 19" D
 ... S ^XTMP("BDMPG1",BDMJ,BDMH,"PATS",BDMDA)=""
 I BDMTYP="C" D
 ...
 .. I BDMPREG="E" Q:$$PREG^BDMDG1B(BDMRPAT,BDMBD,BDMDAT,1,1)
 .. S ^XTMP("BDMDM19",BDMJ,BDMH,"PATS",BDMRPAT)=""
 ...
 .. I BDMCALL="DM Audit P 19" D
 ... S ^XTMP("BDMPG1",BDMJ,BDMH,"PATS",BDMRPAT)=""
 I BDMRAND="Y" D
 . N X
 ...
 I BDMCALL="DM Audit 2019" D
 . D BDMG^BDMDG1(BDMJ,BDMH,BDMRG,BDMDAT,BDMTYP,$G(BDMSTMP),BDMPCP,BDMCOM,$G(BDMRAND),$G(BDMRCNT),$G(BDMCMS),$G(BDMSTAT),BDMPREP,$G(BDMFILE),$G(BDMDSP),.BDMIEN,BDMSDPI,BDMSDPIN,BDMPNA,BDMDZ2,BDMDEMO,BDMBEN,$G(BDMDQ),$G(BDMEAUDA))
 I BDMCALL="DM Audit P 19" D
 . D BDMG^BDMPG1(BDMJ,BDMH,BDMRG,BDMDAT,BDMTYP,$G(BDMSTMP),BDMPCP,BDMCOM,$G(BDMRAND),$G(BDMRCNT),$G(BDMCMS),$G(BDMSTAT),BDMPREP,$G(BDMFILE),$G(BDMDSP),.BDMIEN,BDMSDPI,BDMSDPIN,BDMPNA,BDMDZ2,BDMDEMO,BDMBEN,$G(BDMDQ))
 I BDMCALL="DM Audit E 19" D
 . D BDMG^BDMDG1E(BDMJ,BDMH,BDMRG,BDMDAT,BDMTYP,$G(BDMSTMP),BDMPCP,BDMCOM,$G(BDMRAND),$G(BDMRCNT),$G(BDMCMS),$G(BDMSTAT),BDMPREP,$G(BDMFILE),$G(BDMDSP),.BDMIEN,BDMSDPI,BDMSDPIN,BDMDZ2,BDMDEMO,$G(BDMDQ))
 I BDMCALL="DMQ" D
 . D BDMG^BDMDG1Y(BDMJ,BDMH,BDMRG,BDMDAT,BDMTYP,$G(BDMSTMP),BDMPCP,BDMCOM,$G(BDMRAND),$G(BDMRCNT),$G(BDMCMS),$G(BDMSTAT),BDMPREP,$G(BDMFILE),$G(BDMDSP),.BDMIEN,BDMSDPI,BDMSDPIN,BDMPNA,BDMDZ2,BDMDEMO,BDMBEN,$G(BDMDQ),$G(BDMEAUDA))
 I $G(BDMDSP) S BDMIEN=1 D NOWDMO19 Q
 I '$G(BDMIEN) S BDMERR="Error Queueing DM Audit"
 I '$G(BDMDSP) S ^BDMTMP($J,2)=$C(31)_$G(BDMERR)
 D EN^XBVK("BDM")
 Q
 ;
DMA19P(BDMRET,BDMSTR) ;-- dm audit 2019
 N P,R
 N BDMRG,BDMDAT,BDMTYP,BDMSTMP,BDMPCP,BDMLCOM,BDMRAND,BDMRCNT,BDMDSP,BDMPNA
 N BDMCMS,BDMRGI,BDMSTAT,BDMPREP,BDMFILE,BDMPATS,BDMSTMPE,BDMCMSE,BDMH,BDMJ
 N BDMDZ2,BDMDEMO,BDMBEN,BDMPREG,BDMBD,BDMDQ
 ...
 .. S ^XTMP("BDMDM19",BDMJ,BDMH,"PATS",BDMRPAT)=""
 I '$G(BDMDSP) S ^BDMTMP($J,1)="T00010REPORTIEN"_$C(30)
 D BDMG^BDMDG1(BDMJ,BDMH,BDMRG,BDMDAT,BDMTYP,$G(BDMSTMP),BDMPCP,BDMCOM,$G(BDMRAND),$G(BDMRCNT),$G(BDMCMS),$G(BDMSTAT),BDMPREP,$G(BDMFILE),$G(BDMDSP),.BDMIEN,BDMSDPI,BDMSDPIN,BDMPNA,BDMDZ2,BDMDEMO,BDMBEN,$G(BDMDQ))
 I $G(BDMDSP) S BDMIEN=1 D NOWDMO19 Q
 I '$G(BDMIEN) S BDMERR="Error Queueing DM Audit"
 I '$G(BDMDSP) S ^BDMTMP($J,2)=$C(31)_$G(BDMERR)
 Q
 ;
NOWDMO19 ;EP - return the output to the screen
 N BDMI,BDMDA
 S BDMI=0
 S ^BDMTMP($J,BDMI)="T00250DATA"_$C(30)
 S BDMDA=0 F  S BDMDA=$O(^TMP($J,"BDMDM19",BDMDA)) Q:'BDMDA  D
 . S BDMI=BDMI+1
 . S ^BDMTMP($J,BDMI)=$G(^TMP($J,"BDMDM19",BDMDA))_$C(30)
