...
REGASK ;
 ...
 W !!,"This option is used to run the 2017 Electronic Diabetes Audit for a"
...
ZIS ;
 ...
 I BDMPREP'=2 S XBRP="^BDMDE1P",XBRC="EAUDIT^BDMDE10",XBRX="XIT^BDMDE1",XBNS="BDM"
 I BDMPREP=2 S XBRP="",XBRC="EAUDIT^BDMDE10",XBRX="XIT^BDMDE1",XBNS="BDM"
 D ^XBDBQUE
 D XIT
 Q
P ;
...
BDMG(BDMJOB,BDMBTH,BDMDMRG,BDMADAT,BDMTYPE,BDMSTMP,BDMPDP,BDMCOM,BDMRAND,BDMRCNT,BDMCMS,BDMSTAT,BDMPREP,BDMFILE,BDMDSP,BDMGIEN,BDMSDPI,BDMSDPG,BDMDUZ2,BDMDEMO) ;PEP - gui call
 ...
 N BDMOPT  ;maw
 S BDMOPT="Run the 2017 Audit w/predefined set of Pts"  ;maw
 D NOW^%DTC
 S BDMNOW=$G(%)
 K DD,D0,DIC
 S X=DUZ_"."_BDMBTH
 ...
 S ZTIO="",ZTDTH=$$NOW^XLFDT,ZTRTN="GUIEP^BDMDE1E",ZTDESC="GUI DM AUDIT" D ^%ZTLOAD
 D XIT
 Q
