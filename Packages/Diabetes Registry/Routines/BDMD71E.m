...
ZIS ;
 I BDMPREP'=2 S XBRP="^BDMD71P",XBRC="EAUDIT^BDMD710",XBRX="XIT^BDMD71",XBNS="BDM"
 I BDMPREP=2 S XBRP="",XBRC="EAUDIT^BDMD710",XBRX="XIT^BDMD71",XBNS="BDM"
 D ^XBDBQUE
 D XIT
 Q
P ;
...
BDMG(BDMJOB,BDMBTH,BDMDMRG,BDMADAT,BDMTYPE,BDMSTMP,BDMPCP,BDMCOM,BDMRAND,BDMRCNT,BDMCMS,BDMSTAT,BDMPREP,BDMFILE,BDMDSP,BDMGIEN,BDMSDPI,BDMSDPG) ;PEP - gui call
 ...
 N BDMOPT  ;maw
 S BDMOPT="Run the 2007 Audit w/predefined set of Pts"  ;maw
 D NOW^%DTC
 S BDMNOW=$G(%)
 K DD,D0,DIC
 S X=BDMJOB_"."_BDMBTH
 ...
 S ZTIO="",ZTDTH=$$NOW^XLFDT,ZTRTN="GUIEP^BDMD71E",ZTDESC="GUI DM AUDIT" D ^%ZTLOAD
 D XIT
 Q
