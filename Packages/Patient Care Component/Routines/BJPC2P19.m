BJPC2P19 ; IHS/CMI/LAB - PCC Suite v2.0 P15 ; 31 Jan 2017  11:18 AM
 ;;2.0;IHS PCC SUITE;**20**;MAY 14, 2009;Build 5
 ;
 ;
 ...
 I '$$INSTALLD("BJPC*2.0*18") D MES^XPDUTL($$CJ^XLFSTR("Requires bjpc V2.0 patch 18.  Not installed.",80)) D SORRY(2)
 Q
 ;
PRE ;
 Q
