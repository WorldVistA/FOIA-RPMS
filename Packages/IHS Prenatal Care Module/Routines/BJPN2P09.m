BJPN2P09 ;GDIT/HS/BEE-Prenatal Care Module 2.0 Patch 9 Post Install ; 08 May 2012  12:00 PM
 ;;2.0;PRENATAL CARE MODULE;**9**;Feb 24, 2015;Build 12
 ;
ENV ;EP - Environmental Checking Routine
 ;
 N VERSION,EXEC,BMWDT
 ;
 ;Check for BJPN*2.0*8
 I '$$INSTALLD("BJPN*2.0*8") D BMES^XPDUTL("Version 2.0 Patch 8 of BJPN is required!") S XPDQUIT=2 Q
 ;
 ;Check for EHRp23
 I '$$INSTALLD("BGO*1.1*23") D BMES^XPDUTL("Version 1.1 Patch 23 of EHR is required!") S XPDQUIT=2 Q
 ;
 ;Check for BJPCp20
 I '$$INSTALLD("BJPC*2.0*20") D BMES^XPDUTL("Version 2.0 Patch 20 of BJPC is required!") S XPDQUIT=2 Q
 ;
 Q
 ;
PST ;EP - Prenatal 2.0 Patch 9 Post Installation Code
 ;
...
OBJ ;;
 ;;FILE:BEHPOVCVG.DLL;BEHPovCvg;1.0.6527.19754;BEHPovCvg.dll;;;;0;1;0;0;1;0;0;0;;0;;;;;;
 ;;IHS.PN.EHR.PRENATALPROBLEMLIST.PIPCOMPONENT;Pregnancy Issues and Problems List;2.0.9.7;IHS.PN.EHR.PrenatalProblemList.dll;;;IHS.PN.EHR.PrenatalProblemList.chm;0;1;0;0;0;0;0;0;;1;;;;{B5416178-ECD8-4515-A700-2980BCAA6CAA};300;640
 ;;END;
 ;;
 ;
INSTALLD(BJPNSTAL) ;EP - Determine if patch BJPNSTAL was installed, where
 ;BJPNSTAL is the name of the INSTALL.  E.g "BJPN*2.0*9".
 ;
 NEW DIC,X,Y,D
 S X=$P(BJPNSTAL,"*",1)
