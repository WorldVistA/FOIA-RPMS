BJPN2P10 ;GDIT/HS/BEE-Prenatal Care Module 2.0 Patch 10 Post Install ; 08 May 2012  12:00 PM
 ;;2.0;PRENATAL CARE MODULE;**10**;Feb 24, 2015;Build 4
 ;
ENV ;EP - Environmental Checking Routine
 ;
 N VERSION,EXEC,BMWDT
 ;
 ;Check for BJPN*2.0*9
 I '$$INSTALLD("BJPN*2.0*9") D BMES^XPDUTL("Version 2.0 Patch 9 of BJPN is required!") S XPDQUIT=2 Q
 ;
 Q
 ;
PST ;EP - Prenatal 2.0 Patch 10 Post Installation Code
 ;
 ...
 . ;
 . ;MD5 CHECKSUM
 . I $P(TEXT,";")["IHS.PN.EHR.PRENATALPROBLEMLIST.PIPCOMPONENT" S OBJUPD(19930.2,OIEN_",",7)="A9FE119AF2498DFE3F46BF9ED454B9A4"
 . ;
 . ;Update entry
...
OBJ ;;
 ...
 ;;IHS.PN.EHR.PRENATALPROBLEMLIST.PIPCOMPONENT;Pregnancy Issues and Problems List;2.0.10.0;IHS.PN.EHR.PrenatalProblemList.dll;;;IHS.PN.EHR.PrenatalProblemList.chm;0;1;0;0;0;0;0;0;;1;;;;{B5416178-ECD8-4515-A700-2980BCAA6CAA};300;640;
 ;;END;
 ;;
 ;
