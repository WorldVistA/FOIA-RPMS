AGMCRP3 ; IHS/ASDS/EFG - PRINT ALPHA LIST OF MEDICARE/RAILROAD HOLDERS ;   
...
PRINT ;Print a Patient's MEDICARE/RAILROAD file.
 ;this is to make sure they are Part B somewhere
 S (I,AGCFLAG)=""
 F  S I=$O(^AUPNMCR(DFN,11,I)) Q:I=""  D
 .S AGCOV=$P($G(^AUPNMCR(DFN,11,I,0)),U,3)
 .I AGCOV="B" S AGCFLAG=1
 Q:AGCFLAG'=1
...
HDR S AGPGPG=AGPGPG+1
 ...
 W !?17,"REGISTERED PATIENTS - MEDICARE/RAILROAD ACCOUNTS"
 W !,AGUCI,!,AGTIME
 W !!?17,"REPORT CONTAINS "_$S(AGPTS="B":"ALL BENEFICIARIES",AGPTS="A":"ATIENTS ONLY",AGPTS="D":"DECEASED AND INACTIVE PATIENTS ONLY")
 W !!,"        NAME",?36,"CHART #",?49,"NUMBER",!,"(TYPE)",?14,"ELIG DATE END DATE",?64,"DATE OF BIRTH"
 W !,AG("="),!
 Q
