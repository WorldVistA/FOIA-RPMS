...
TABLE ; EP
 ...
 ;;267;;Meningococcal B, OMV (Bexsero)^Men-B,Bex^163^^^^0^0^16^^^32,103,108,114,136,147,148,162,163,164,167^3160809^^^0^1^.5
 ;;267a;;Bexsero^^MENING^^^^^^^^^^^Meningococcal B vaccine, recombinant, OMV, adjuvanted (Bexsero)
 ;;268;;Meningococcal B, unspecified^Men-B,NOS^164^^^^0^0^16^^^32,103,108,114,136,147,148,162,163,164,167^^^^0^1^.5
 ...
 ;;276a;;^^^^^^^^^^^^^Cholera, WC-rBS
 ;;277;;Cholera, BivWC^CholeraBWC^173^^^^1^0^12^^^26,172,173,174^^^^0^0
 ;;277a;;^^^^^^^^^^^^^Cholera, BivWC
 ;;278;;Cholera, live attenuated^Cholera LA^174^^^^1^0^12^^^26,172,173,174^^^^0^0
 ;;278a;;^^^^^^^^^^^^^Cholera, live attenuated
 ;;279;;Rabies - IM Diploid cell culture^Rabies ImD^175^^^^1^0^12^^^18,40,90,175,176^^^^^1
 ;;279a;;^^^^^^^^^^^^^Human Rabies vaccine from human diploid cell culture
 ;;280;;Rabies - IM fibroblast culture^Rabies ImF^176^^^^1^0^12^^^18,40,90,175,176^^^^^1
 ;;280a;;^^^^^^^^^^^^^Human rabies vaccine from Chicken fibroblast culture
 ;;281;;PCV10^PCV10^177^^^^1^0^11
 ;;281a;;^^^^^^^^^^^^^pneumococcal conjugate vaccine, 10 valent
 ;;282;;OPV, monovalent, unspecified^OPV-mono^179^^^^1^0^2
 ;;282a;;^^^^^^^^^^^^^Non-US monovalent oral polio vaccine, unspecified formulation
 ;;283;;OPV bivalent^OPV-bi^178^^^^1^0^2
 ;;283a;;^^^^^^^^^^^^^Non-US bivalent oral polio vaccine (types 1 and 3)
 ;;284;;OPV, Unspecified^OPV-unspf^182^^^^1^0^2
 ;;284a;;^^^^^^^^^^^^^Oral Polio Vaccine, Unspecified formulation
 ;;285;;Anthrax immune globulin^Anthrax IG^181^^^^1^0^12
 ;;285a;;^^^^^^^^^^^^^anthrax immune globulin
 ;;286;;Tetanus immune globulin^Tetanus IG^180^^^^1^0^1
 ;;286a;;^^^^^^^^^^^^^tetanus immune globulin
 ;;287;;Yellow fever vaccine alternative formulation^YFever,alt^183^^^^1^^12^^^37,183,184^^^^^1^.5
