BLRPRE40 ; IHS/MSC/MKK - RPMS Lab Patch LR*5.2*1040 Pre/Install/Post Routine ; 15-Nov-2016 08:22 ; MKK
 ;;5.2;IHS LABORATORY;**1040**;NOV 01, 1997;Build 5
 ;
ENVICHEK ; EP - Environment Checker
 ...
 ;
 D NEEDIT^BLRKIDS2(CP,"LR","5.2",1039,.ERRARRAY),BLANK  ; Lab Pre-Requisite
 ;
...
ADDOPTS ; EP - Add new options
 D ADDOPTS^BLRKIDS2("BLRMENU","BLR DOB ONLY PARAM EDIT","DOBP")
 D ADDOPTS^BLRKIDS2("BLRMENU","BLR EDIT LR RES CHNG MGRP","RESC")
 D ADDOPTS^BLRKIDS2("BLRMENU","BLR Lab Res Chng Parm Edit","LCRP")
