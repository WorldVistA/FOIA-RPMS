APCMBAN ; IHS/CMI/LAB - Banner routine for Management RPTS ; 28 Jun 2017  12:44 PM
 ;;1.0;IHS MU PERFORMANCE REPORTS;**2,4,5,6,7,8,9,10**;MAR 26, 2012;Build 31
V ; GET VERSION
 S APCM("VERSION")="1.0 (Patch 10)"  ;,APCM("VERSION")=$O(^DIC(9.4,"C","BJPC",APCM("VERSION"))),APCM("VERSION")=^DIC(9.4,APCM("VERSION"),"VERSION")
...
SITE G XIT:'$D(DUZ(2)) G:'DUZ(2) XIT S APCM("SITE")=$P(^DIC(4,DUZ(2),0),"^") W !?80-$L(APCM("SITE"))\2,APCM("SITE")
 I APCMTEXT="TEXTM" W !!,"Current 2015-2018 Meaningful Use (MU) Modified (Mod) Stage 2 (S2) ",!,"Performance Reports"
XIT ;
