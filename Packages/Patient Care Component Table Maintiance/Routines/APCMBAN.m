APCMBAN ; IHS/CMI/LAB - Banner routine for Management RPTS ; 28 Jun 2017  12:44 PM
 ;;1.0;IHS MU PERFORMANCE REPORTS;**2,4,5,6,7,8,9**;MAR 26, 2012;Build 25
V ; GET VERSION
 S APCM("VERSION")="1.0 (Patch 9)"  ;,APCM("VERSION")=$O(^DIC(9.4,"C","BJPC",APCM("VERSION"))),APCM("VERSION")=^DIC(9.4,APCM("VERSION"),"VERSION")
