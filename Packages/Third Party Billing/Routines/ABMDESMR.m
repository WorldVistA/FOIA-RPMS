...
MEDH S ABMS(ABMS("I"))=ABMX("SUB")
 ...
 S $P(ABMS(ABMS("I")),U,8)=$P(ABMS(ABMS("I")),U,8)_$S('$P(ABMX(0),U,7)&'$P(ABMX(0),U,8):"",$P(ABMX(0),U,7):$P(^PS(52.6,$P(ABMX(0),U,7),0),U),1:$P(^PS(52.7,$P(ABMX(0),U,8),0),U))  ;abm*2.6*21 IHS/SD/SDR HEAT168435
 ;I ABMP("EXP")=27 S $P(ABMS(ABMS("I")),U,8)="N4"_$P(ABMS(ABMS("I")),U,8)  ;abm*2.6*13 export mode 35
 ;I ABMP("EXP")=27!(ABMP("EXP")=35) S $P(ABMS(ABMS("I")),U,8)="N4"_$P(ABMS(ABMS("I")),U,8)  ;abm*2.6*13 export mode 35  ;abm*2.6*21 IHS/SD/SDR HEAT168435
 ;start new abm*2.6*21 IHS/SD/SDR HEAT168435
 I ABMP("EXP")=27!(ABMP("EXP")=35) D
 .S $P(ABMS(ABMS("I")),U,8)="N4"_$TR($P($P(ABMS(ABMS("I")),U,8)," "),"-")  ;abm*2.6*13 export mode 35  ;N4 with NDC (dashes removed)
