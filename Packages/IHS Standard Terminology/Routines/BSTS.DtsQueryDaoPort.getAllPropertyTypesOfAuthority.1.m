 ;BSTS.DtsQueryDaoPort.getAllPropertyTypesOfAuthority.1
 ;(C)InterSystems, generated for class BSTS.DtsQueryDaoPort.getAllPropertyTypesOfAuthority.  Do NOT edit. 08/21/2017 07:46:17PM
 ;;33674A46;BSTS.DtsQueryDaoPort.getAllPropertyTypesOfAuthority
 ;
...
zInvoke(%Client,%Action,authorityId) public {
 ...
 Do %Client.InvokeClient($this,"getAllPropertyTypesOfAuthority",%Action)
 Quit ..%Result }
zReset() public {
 Quit }
zXMLDTD(top,format,input,dtdlist)
 Quit ##class(%XML.Implementation).XMLDTD("BSTS.DtsQueryDaoPort.getAllPropertyTypesOfAuthority",.top,.format,.input,.dtdlist)
zXMLExportInternal()
 ...
 If group Quit $$Error^%apiOBJ(6386,"BSTS.DtsQueryDaoPort.getAllPropertyTypesOfAuthority")
 ...
 If 'nocycle {
   If $data(oreflist($this)) Quit $$Error^%apiOBJ(6296,"BSTS.DtsQueryDaoPort.getAllPropertyTypesOfAuthority")
   Set oreflist($this)=""
 }
 Set tag=$get(topArg)
 Set tmpi=(($get(typeAttr)'="")&&(typeAttr'="BSTS.DtsQueryDaoPort.getAllPropertyTypesOfAuthority"))
 If $IsObject(namespaces) {
   ...
   If tag="" Set tag="getAllPropertyTypesOfAuthority"
   ...
   If tag="" Set tag=typesPrefix_"getAllPropertyTypesOfAuthority"
   Set xsitype=0
 }
 Set local=+$get(local),savelocal=local
 Set endprefix="</"_beginprefix,beginprefix="<"_beginprefix
 If tmpi Set temp=temp_" "_xsiPrefix_"type="""_typesPrefix_"getAllPropertyTypesOfAuthority"""_xsiAttrs,xsiAttrs=""
...
zXMLGetSchemaImports(imports,classes)
 Quit ##class(%XML.Implementation).XMLGetSchemaImports("BSTS.DtsQueryDaoPort.getAllPropertyTypesOfAuthority",.imports,.classes)
...
zXMLImportInternal()
 ...
 If bareProjection Quit $$Error^%apiOBJ(6386,"BSTS.DtsQueryDaoPort.getAllPropertyTypesOfAuthority")
...
zXMLNew(document,node,containerOref="")
	Quit (##class(BSTS.DtsQueryDaoPort.getAllPropertyTypesOfAuthority).%New())
zXMLSchema(top="",format="",namespacePrefix="",input=0,refOnly=0,schema)
 Quit ##class(%XML.Implementation).XMLSchema("BSTS.DtsQueryDaoPort.getAllPropertyTypesOfAuthority",top,format,namespacePrefix,input,refOnly,.schema)
