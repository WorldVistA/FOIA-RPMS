 ;BSTS.DtsQueryDaoPort.getSubConcepts.1
 ;(C)InterSystems, generated for class BSTS.DtsQueryDaoPort.getSubConcepts.  Do NOT edit. 08/21/2017 07:46:18PM
 ;;4C4C6841;BSTS.DtsQueryDaoPort.getSubConcepts
 ;
...
exit	Quit sc }
zInvoke(%Client,%Action,concept,asd) public {
 Set ..concept=$get(concept),..asd=$get(asd)
 Do %Client.InvokeClient($this,"getSubConcepts",%Action)
 Quit ..%Result }
zReset() public {
 Quit }
zXMLDTD(top,format,input,dtdlist)
 Quit ##class(%XML.Implementation).XMLDTD("BSTS.DtsQueryDaoPort.getSubConcepts",.top,.format,.input,.dtdlist)
zXMLExportInternal()
 ...
 If group Quit $$Error^%apiOBJ(6386,"BSTS.DtsQueryDaoPort.getSubConcepts")
 ...
 If 'nocycle {
   If $data(oreflist($this)) Quit $$Error^%apiOBJ(6296,"BSTS.DtsQueryDaoPort.getSubConcepts")
   Set oreflist($this)=""
 }
 Set tag=$get(topArg)
 Set tmpi=(($get(typeAttr)'="")&&(typeAttr'="BSTS.DtsQueryDaoPort.getSubConcepts"))
 If $IsObject(namespaces) {
   ...
   If tag="" Set tag=typesPrefix_"getSubConcepts"
   Set xsitype=0
 }
 Set local=+$get(local),savelocal=local
 Set endprefix="</"_beginprefix,beginprefix="<"_beginprefix
 If tmpi Set temp=temp_" "_xsiPrefix_"type="""_typesPrefix_"getSubConcepts"""_xsiAttrs,xsiAttrs=""
...
zXMLGetSchemaImports(imports,classes)
 Quit ##class(%XML.Implementation).XMLGetSchemaImports("BSTS.DtsQueryDaoPort.getSubConcepts",.imports,.classes)
...
zXMLImportInternal()
 ...
 If bareProjection Quit $$Error^%apiOBJ(6386,"BSTS.DtsQueryDaoPort.getSubConcepts")
...
zXMLNew(document,node,containerOref="")
	Quit (##class(BSTS.DtsQueryDaoPort.getSubConcepts).%New())
zXMLSchema(top="",format="",namespacePrefix="",input=0,refOnly=0,schema)
 Quit ##class(%XML.Implementation).XMLSchema("BSTS.DtsQueryDaoPort.getSubConcepts",top,format,namespacePrefix,input,refOnly,.schema)
