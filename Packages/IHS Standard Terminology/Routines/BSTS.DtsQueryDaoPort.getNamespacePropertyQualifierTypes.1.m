 ;BSTS.DtsQueryDaoPort.getNamespacePropertyQualifierTypes.1
 ;(C)InterSystems, generated for class BSTS.DtsQueryDaoPort.getNamespacePropertyQualifierTypes.  Do NOT edit. 08/21/2017 07:46:17PM
 ;;4A43492B;BSTS.DtsQueryDaoPort.getNamespacePropertyQualifierTypes
 ;
...
zXMLDTD(top,format,input,dtdlist)
 Quit ##class(%XML.Implementation).XMLDTD("BSTS.DtsQueryDaoPort.getNamespacePropertyQualifierTypes",.top,.format,.input,.dtdlist)
zXMLExportInternal()
 ...
 If group Quit $$Error^%apiOBJ(6386,"BSTS.DtsQueryDaoPort.getNamespacePropertyQualifierTypes")
 ...
 If 'nocycle {
   If $data(oreflist($this)) Quit $$Error^%apiOBJ(6296,"BSTS.DtsQueryDaoPort.getNamespacePropertyQualifierTypes")
   Set oreflist($this)=""
 }
 Set tag=$get(topArg)
 Set tmpi=(($get(typeAttr)'="")&&(typeAttr'="BSTS.DtsQueryDaoPort.getNamespacePropertyQualifierTypes"))
...
zXMLGetSchemaImports(imports,classes)
 Quit ##class(%XML.Implementation).XMLGetSchemaImports("BSTS.DtsQueryDaoPort.getNamespacePropertyQualifierTypes",.imports,.classes)
...
zXMLImportInternal()
 ...
 If bareProjection Quit $$Error^%apiOBJ(6386,"BSTS.DtsQueryDaoPort.getNamespacePropertyQualifierTypes")
...
zXMLNew(document,node,containerOref="")
	Quit (##class(BSTS.DtsQueryDaoPort.getNamespacePropertyQualifierTypes).%New())
zXMLSchema(top="",format="",namespacePrefix="",input=0,refOnly=0,schema)
 Quit ##class(%XML.Implementation).XMLSchema("BSTS.DtsQueryDaoPort.getNamespacePropertyQualifierTypes",top,format,namespacePrefix,input,refOnly,.schema)
