 ;BSTS.DtsDaoPort.getConceptPropertyQualifierTypes.1
 ;(C)InterSystems, generated for class BSTS.DtsDaoPort.getConceptPropertyQualifierTypes.  Do NOT edit. 08/21/2017 07:46:12PM
 ;;334F414B;BSTS.DtsDaoPort.getConceptPropertyQualifierTypes
 ;
...
zInvoke(%Client,%Action,namespaceId) public {
 ...
 Do %Client.InvokeClient($this,"getConceptPropertyQualifierTypes",%Action)
 Quit ..%Result }
zReset() public {
 Quit }
zXMLDTD(top,format,input,dtdlist)
 Quit ##class(%XML.Implementation).XMLDTD("BSTS.DtsDaoPort.getConceptPropertyQualifierTypes",.top,.format,.input,.dtdlist)
zXMLExportInternal()
 ...
 If group Quit $$Error^%apiOBJ(6386,"BSTS.DtsDaoPort.getConceptPropertyQualifierTypes")
 ...
 If 'nocycle {
   If $data(oreflist($this)) Quit $$Error^%apiOBJ(6296,"BSTS.DtsDaoPort.getConceptPropertyQualifierTypes")
   Set oreflist($this)=""
 }
 Set tag=$get(topArg)
 Set tmpi=(($get(typeAttr)'="")&&(typeAttr'="BSTS.DtsDaoPort.getConceptPropertyQualifierTypes"))
 If $IsObject(namespaces) {
   ...
   If tag="" Set tag="getConceptPropertyQualifierTypes"
   ...
   If tag="" Set tag=typesPrefix_"getConceptPropertyQualifierTypes"
   Set xsitype=0
 }
 Set local=+$get(local),savelocal=local
 Set endprefix="</"_beginprefix,beginprefix="<"_beginprefix
 If tmpi Set temp=temp_" "_xsiPrefix_"type="""_typesPrefix_"getConceptPropertyQualifierTypes"""_xsiAttrs,xsiAttrs=""
...
zXMLGetSchemaImports(imports,classes)
 Quit ##class(%XML.Implementation).XMLGetSchemaImports("BSTS.DtsDaoPort.getConceptPropertyQualifierTypes",.imports,.classes)
...
zXMLImportInternal()
 ...
 If bareProjection Quit $$Error^%apiOBJ(6386,"BSTS.DtsDaoPort.getConceptPropertyQualifierTypes")
...
zXMLNew(document,node,containerOref="")
	Quit (##class(BSTS.DtsDaoPort.getConceptPropertyQualifierTypes).%New())
zXMLSchema(top="",format="",namespacePrefix="",input=0,refOnly=0,schema)
 Quit ##class(%XML.Implementation).XMLSchema("BSTS.DtsDaoPort.getConceptPropertyQualifierTypes",top,format,namespacePrefix,input,refOnly,.schema)
