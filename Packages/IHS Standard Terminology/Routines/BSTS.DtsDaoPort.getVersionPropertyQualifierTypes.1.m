 ;BSTS.DtsDaoPort.getVersionPropertyQualifierTypes.1
 ;(C)InterSystems, generated for class BSTS.DtsDaoPort.getVersionPropertyQualifierTypes.  Do NOT edit. 08/21/2017 07:46:12PM
 ;;73563378;BSTS.DtsDaoPort.getVersionPropertyQualifierTypes
 ;
...
zInvoke(%Client,%Action,namespaceId) public {
 ...
 Do %Client.InvokeClient($this,"getVersionPropertyQualifierTypes",%Action)
 Quit ..%Result }
zReset() public {
 Quit }
zXMLDTD(top,format,input,dtdlist)
 Quit ##class(%XML.Implementation).XMLDTD("BSTS.DtsDaoPort.getVersionPropertyQualifierTypes",.top,.format,.input,.dtdlist)
zXMLExportInternal()
 ...
 If group Quit $$Error^%apiOBJ(6386,"BSTS.DtsDaoPort.getVersionPropertyQualifierTypes")
 ...
 If 'nocycle {
   If $data(oreflist($this)) Quit $$Error^%apiOBJ(6296,"BSTS.DtsDaoPort.getVersionPropertyQualifierTypes")
   Set oreflist($this)=""
 }
 Set tag=$get(topArg)
 Set tmpi=(($get(typeAttr)'="")&&(typeAttr'="BSTS.DtsDaoPort.getVersionPropertyQualifierTypes"))
 If $IsObject(namespaces) {
   ...
   If tag="" Set tag="getVersionPropertyQualifierTypes"
   ...
   If tag="" Set tag=typesPrefix_"getVersionPropertyQualifierTypes"
   Set xsitype=0
 }
 Set local=+$get(local),savelocal=local
 Set endprefix="</"_beginprefix,beginprefix="<"_beginprefix
 If tmpi Set temp=temp_" "_xsiPrefix_"type="""_typesPrefix_"getVersionPropertyQualifierTypes"""_xsiAttrs,xsiAttrs=""
...
zXMLGetSchemaImports(imports,classes)
 Quit ##class(%XML.Implementation).XMLGetSchemaImports("BSTS.DtsDaoPort.getVersionPropertyQualifierTypes",.imports,.classes)
...
zXMLImportInternal()
 ...
 If bareProjection Quit $$Error^%apiOBJ(6386,"BSTS.DtsDaoPort.getVersionPropertyQualifierTypes")
...
zXMLNew(document,node,containerOref="")
	Quit (##class(BSTS.DtsDaoPort.getVersionPropertyQualifierTypes).%New())
zXMLSchema(top="",format="",namespacePrefix="",input=0,refOnly=0,schema)
 Quit ##class(%XML.Implementation).XMLSchema("BSTS.DtsDaoPort.getVersionPropertyQualifierTypes",top,format,namespacePrefix,input,refOnly,.schema)
