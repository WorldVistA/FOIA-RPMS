 ;BSTS.DtsQueryDaoPort.getConceptPropertyQualifierTypes.1
 ;(C)InterSystems, generated for class BSTS.DtsQueryDaoPort.getConceptPropertyQualifierTypes.  Do NOT edit. 08/21/2017 07:46:17PM
 ;;374B6B4D;BSTS.DtsQueryDaoPort.getConceptPropertyQualifierTypes
 ;
...
zXMLDTD(top,format,input,dtdlist)
 Quit ##class(%XML.Implementation).XMLDTD("BSTS.DtsQueryDaoPort.getConceptPropertyQualifierTypes",.top,.format,.input,.dtdlist)
zXMLExportInternal()
 ...
 If group Quit $$Error^%apiOBJ(6386,"BSTS.DtsQueryDaoPort.getConceptPropertyQualifierTypes")
 ...
 If 'nocycle {
   If $data(oreflist($this)) Quit $$Error^%apiOBJ(6296,"BSTS.DtsQueryDaoPort.getConceptPropertyQualifierTypes")
   Set oreflist($this)=""
 }
 Set tag=$get(topArg)
 Set tmpi=(($get(typeAttr)'="")&&(typeAttr'="BSTS.DtsQueryDaoPort.getConceptPropertyQualifierTypes"))
...
zXMLGetSchemaImports(imports,classes)
 Quit ##class(%XML.Implementation).XMLGetSchemaImports("BSTS.DtsQueryDaoPort.getConceptPropertyQualifierTypes",.imports,.classes)
...
zXMLImportInternal()
 ...
 If bareProjection Quit $$Error^%apiOBJ(6386,"BSTS.DtsQueryDaoPort.getConceptPropertyQualifierTypes")
...
zXMLNew(document,node,containerOref="")
	Quit (##class(BSTS.DtsQueryDaoPort.getConceptPropertyQualifierTypes).%New())
zXMLSchema(top="",format="",namespacePrefix="",input=0,refOnly=0,schema)
 Quit ##class(%XML.Implementation).XMLSchema("BSTS.DtsQueryDaoPort.getConceptPropertyQualifierTypes",top,format,namespacePrefix,input,refOnly,.schema)
