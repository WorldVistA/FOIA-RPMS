 ;BSTS.DtsDaoPort.getAllSubsetQualifierTypes.1
 ;(C)InterSystems, generated for class BSTS.DtsDaoPort.getAllSubsetQualifierTypes.  Do NOT edit. 08/21/2017 07:46:11PM
 ;;45654553;BSTS.DtsDaoPort.getAllSubsetQualifierTypes
 ;
...
zInvoke(%Client,%Action,subsetId) public {
 ...
 Do %Client.InvokeClient($this,"getAllSubsetQualifierTypes",%Action)
 Quit ..%Result }
zReset() public {
 Quit }
zXMLDTD(top,format,input,dtdlist)
 Quit ##class(%XML.Implementation).XMLDTD("BSTS.DtsDaoPort.getAllSubsetQualifierTypes",.top,.format,.input,.dtdlist)
zXMLExportInternal()
 ...
 If group Quit $$Error^%apiOBJ(6386,"BSTS.DtsDaoPort.getAllSubsetQualifierTypes")
 ...
 If 'nocycle {
   If $data(oreflist($this)) Quit $$Error^%apiOBJ(6296,"BSTS.DtsDaoPort.getAllSubsetQualifierTypes")
   Set oreflist($this)=""
 }
 Set tag=$get(topArg)
 Set tmpi=(($get(typeAttr)'="")&&(typeAttr'="BSTS.DtsDaoPort.getAllSubsetQualifierTypes"))
 If $IsObject(namespaces) {
   ...
   If tag="" Set tag="getAllSubsetQualifierTypes"
   ...
   If tag="" Set tag=typesPrefix_"getAllSubsetQualifierTypes"
   Set xsitype=0
 }
 Set local=+$get(local),savelocal=local
 Set endprefix="</"_beginprefix,beginprefix="<"_beginprefix
 If tmpi Set temp=temp_" "_xsiPrefix_"type="""_typesPrefix_"getAllSubsetQualifierTypes"""_xsiAttrs,xsiAttrs=""
...
zXMLGetSchemaImports(imports,classes)
 Quit ##class(%XML.Implementation).XMLGetSchemaImports("BSTS.DtsDaoPort.getAllSubsetQualifierTypes",.imports,.classes)
...
zXMLImportInternal()
 ...
 If bareProjection Quit $$Error^%apiOBJ(6386,"BSTS.DtsDaoPort.getAllSubsetQualifierTypes")
...
zXMLNew(document,node,containerOref="")
	Quit (##class(BSTS.DtsDaoPort.getAllSubsetQualifierTypes).%New())
zXMLSchema(top="",format="",namespacePrefix="",input=0,refOnly=0,schema)
 Quit ##class(%XML.Implementation).XMLSchema("BSTS.DtsDaoPort.getAllSubsetQualifierTypes",top,format,namespacePrefix,input,refOnly,.schema)
