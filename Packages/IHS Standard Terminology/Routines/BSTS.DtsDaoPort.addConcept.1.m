 ;BSTS.DtsDaoPort.addConcept.1
 ;(C)InterSystems, generated for class BSTS.DtsDaoPort.addConcept.  Do NOT edit. 08/21/2017 07:46:09PM
 ;;4F70626F;BSTS.DtsDaoPort.addConcept
 ;
...
exit	Quit sc }
zInvoke(%Client,%Action,concept) public {
 Set ..concept=$get(concept)
 Do %Client.InvokeClient($this,"addConcept",%Action)
 Quit ..%Result }
zNeedsAdjustment(ResultName) public {
 Set ResultName="addConceptResult"
 Quit 1 }
zReset() public {
 Quit }
zXMLDTD(top,format,input,dtdlist)
 Quit ##class(%XML.Implementation).XMLDTD("BSTS.DtsDaoPort.addConcept",.top,.format,.input,.dtdlist)
zXMLExportInternal()
 ...
 If group Quit $$Error^%apiOBJ(6386,"BSTS.DtsDaoPort.addConcept")
 ...
 If 'nocycle {
   If $data(oreflist($this)) Quit $$Error^%apiOBJ(6296,"BSTS.DtsDaoPort.addConcept")
   Set oreflist($this)=""
 }
 Set tag=$get(topArg)
 Set tmpi=(($get(typeAttr)'="")&&(typeAttr'="BSTS.DtsDaoPort.addConcept"))
 If $IsObject(namespaces) {
   ...
   If tag="" Set tag=typesPrefix_"addConcept"
   Set xsitype=0
 }
 Set local=+$get(local),savelocal=local
 Set endprefix="</"_beginprefix,beginprefix="<"_beginprefix
 If tmpi Set temp=temp_" "_xsiPrefix_"type="""_typesPrefix_"addConcept"""_xsiAttrs,xsiAttrs=""
...
zXMLGetSchemaImports(imports,classes)
 Quit ##class(%XML.Implementation).XMLGetSchemaImports("BSTS.DtsDaoPort.addConcept",.imports,.classes)
...
zXMLImportInternal()
 ...
 If bareProjection Quit $$Error^%apiOBJ(6386,"BSTS.DtsDaoPort.addConcept")
...
zXMLNew(document,node,containerOref="")
	Quit (##class(BSTS.DtsDaoPort.addConcept).%New())
zXMLSchema(top="",format="",namespacePrefix="",input=0,refOnly=0,schema)
 Quit ##class(%XML.Implementation).XMLSchema("BSTS.DtsDaoPort.addConcept",top,format,namespacePrefix,input,refOnly,.schema)
