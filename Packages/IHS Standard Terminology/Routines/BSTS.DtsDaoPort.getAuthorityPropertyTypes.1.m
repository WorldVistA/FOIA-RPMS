 ;BSTS.DtsDaoPort.getAuthorityPropertyTypes.1
 ;(C)InterSystems, generated for class BSTS.DtsDaoPort.getAuthorityPropertyTypes.  Do NOT edit. 08/21/2017 07:46:12PM
 ;;776E7A63;BSTS.DtsDaoPort.getAuthorityPropertyTypes
 ;
...
zInvoke(%Client,%Action,authorityId) public {
 ...
 Do %Client.InvokeClient($this,"getAuthorityPropertyTypes",%Action)
 Quit ..%Result }
zReset() public {
 Quit }
zXMLDTD(top,format,input,dtdlist)
 Quit ##class(%XML.Implementation).XMLDTD("BSTS.DtsDaoPort.getAuthorityPropertyTypes",.top,.format,.input,.dtdlist)
zXMLExportInternal()
 ...
 If group Quit $$Error^%apiOBJ(6386,"BSTS.DtsDaoPort.getAuthorityPropertyTypes")
 ...
 If 'nocycle {
   If $data(oreflist($this)) Quit $$Error^%apiOBJ(6296,"BSTS.DtsDaoPort.getAuthorityPropertyTypes")
   Set oreflist($this)=""
 }
 Set tag=$get(topArg)
 Set tmpi=(($get(typeAttr)'="")&&(typeAttr'="BSTS.DtsDaoPort.getAuthorityPropertyTypes"))
 If $IsObject(namespaces) {
   ...
   If tag="" Set tag="getAuthorityPropertyTypes"
   ...
   If tag="" Set tag=typesPrefix_"getAuthorityPropertyTypes"
   Set xsitype=0
 }
 Set local=+$get(local),savelocal=local
 Set endprefix="</"_beginprefix,beginprefix="<"_beginprefix
 If tmpi Set temp=temp_" "_xsiPrefix_"type="""_typesPrefix_"getAuthorityPropertyTypes"""_xsiAttrs,xsiAttrs=""
...
zXMLGetSchemaImports(imports,classes)
 Quit ##class(%XML.Implementation).XMLGetSchemaImports("BSTS.DtsDaoPort.getAuthorityPropertyTypes",.imports,.classes)
...
zXMLImportInternal()
 ...
 If bareProjection Quit $$Error^%apiOBJ(6386,"BSTS.DtsDaoPort.getAuthorityPropertyTypes")
...
zXMLNew(document,node,containerOref="")
	Quit (##class(BSTS.DtsDaoPort.getAuthorityPropertyTypes).%New())
zXMLSchema(top="",format="",namespacePrefix="",input=0,refOnly=0,schema)
 Quit ##class(%XML.Implementation).XMLSchema("BSTS.DtsDaoPort.getAuthorityPropertyTypes",top,format,namespacePrefix,input,refOnly,.schema)
