 ...
 ;(C)InterSystems, generated for class BSTS.SOAP.WebFunctions.  Do NOT edit. 08/21/2017 07:45:57PM
 ;;6F634847;BSTS.SOAP.WebFunctions
 ;
...
zGetVersions(pParams) public {
	...
	Quit tStatus }
zLogEntry(pParams="",pResult) public {
...
zLogHistory(pParams="",pResult) public {
	...
	//End Here - instead of parsing
	Quit 1_"^^"_..GetElapsedTime(tStartTime,$now()) }
zSearchCounts(pParams="",pResult) public {
	//BSTS*1.0*1;Return search counts
	// Data needed passed by BSTSWS array required for call
	Set tDebug=$Get(pParams("DEBUG"))
	Set tWebServiceTimeout=$Get(pParams("TIMEOUT"))
