 ;BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeById.1
 ;(C)InterSystems, generated for class BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeById.  Do NOT edit. 08/21/2017 07:46:15PM
 ;;31505864;BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeById
 ;
...
zXMLDTD(top,format,input,dtdlist)
 Quit ##class(%XML.Implementation).XMLDTD("BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeById",.top,.format,.input,.dtdlist)
zXMLExportInternal()
 ...
 If group Quit $$Error^%apiOBJ(6386,"BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeById")
 ...
 If 'nocycle {
   If $data(oreflist($this)) Quit $$Error^%apiOBJ(6296,"BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeById")
   Set oreflist($this)=""
 }
 Set tag=$get(topArg)
 Set tmpi=(($get(typeAttr)'="")&&(typeAttr'="BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeById"))
...
zXMLGetSchemaImports(imports,classes)
 Quit ##class(%XML.Implementation).XMLGetSchemaImports("BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeById",.imports,.classes)
...
zXMLImportInternal()
 ...
 If bareProjection Quit $$Error^%apiOBJ(6386,"BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeById")
...
zXMLNew(document,node,containerOref="")
	Quit (##class(BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeById).%New())
zXMLSchema(top="",format="",namespacePrefix="",input=0,refOnly=0,schema)
 Quit ##class(%XML.Implementation).XMLSchema("BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeById",top,format,namespacePrefix,input,refOnly,.schema)
