 ;BSTS.DtsQueryDaoPort.updateNamespaceProperty.1
 ;(C)InterSystems, generated for class BSTS.DtsQueryDaoPort.updateNamespaceProperty.  Do NOT edit. 08/21/2017 07:46:20PM
 ;;337A4C77;BSTS.DtsQueryDaoPort.updateNamespaceProperty
 ;
...
exit	Quit sc }
zInvoke(%Client,%Action,namespace,oldProp,newProp) public {
 Set ..namespace=$get(namespace),..oldProp=$get(oldProp),..newProp=$get(newProp)
...
zXMLDTD(top,format,input,dtdlist)
 Quit ##class(%XML.Implementation).XMLDTD("BSTS.DtsQueryDaoPort.updateNamespaceProperty",.top,.format,.input,.dtdlist)
zXMLExportInternal()
 ...
 If group Quit $$Error^%apiOBJ(6386,"BSTS.DtsQueryDaoPort.updateNamespaceProperty")
 ...
 If 'nocycle {
   If $data(oreflist($this)) Quit $$Error^%apiOBJ(6296,"BSTS.DtsQueryDaoPort.updateNamespaceProperty")
   Set oreflist($this)=""
 }
 Set tag=$get(topArg)
 Set tmpi=(($get(typeAttr)'="")&&(typeAttr'="BSTS.DtsQueryDaoPort.updateNamespaceProperty"))
...
zXMLGetSchemaImports(imports,classes)
 Quit ##class(%XML.Implementation).XMLGetSchemaImports("BSTS.DtsQueryDaoPort.updateNamespaceProperty",.imports,.classes)
...
zXMLImportInternal()
 ...
 If bareProjection Quit $$Error^%apiOBJ(6386,"BSTS.DtsQueryDaoPort.updateNamespaceProperty")
...
zXMLNew(document,node,containerOref="")
	Quit (##class(BSTS.DtsQueryDaoPort.updateNamespaceProperty).%New())
zXMLSchema(top="",format="",namespacePrefix="",input=0,refOnly=0,schema)
 Quit ##class(%XML.Implementation).XMLSchema("BSTS.DtsQueryDaoPort.updateNamespaceProperty",top,format,namespacePrefix,input,refOnly,.schema)
