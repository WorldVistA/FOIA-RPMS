 ;BSTS.DtsDaoPort.getAllNamespaceQualifierTypes.1
 ;(C)InterSystems, generated for class BSTS.DtsDaoPort.getAllNamespaceQualifierTypes.  Do NOT edit. 08/21/2017 07:46:11PM
 ;;63656952;BSTS.DtsDaoPort.getAllNamespaceQualifierTypes
 ;
...
zInvoke(%Client,%Action,namespaceId) public {
 ...
 Do %Client.InvokeClient($this,"getAllNamespaceQualifierTypes",%Action)
 Quit ..%Result }
zReset() public {
 Quit }
zXMLDTD(top,format,input,dtdlist)
 Quit ##class(%XML.Implementation).XMLDTD("BSTS.DtsDaoPort.getAllNamespaceQualifierTypes",.top,.format,.input,.dtdlist)
zXMLExportInternal()
 ...
 If group Quit $$Error^%apiOBJ(6386,"BSTS.DtsDaoPort.getAllNamespaceQualifierTypes")
 ...
 If 'nocycle {
   If $data(oreflist($this)) Quit $$Error^%apiOBJ(6296,"BSTS.DtsDaoPort.getAllNamespaceQualifierTypes")
   Set oreflist($this)=""
 }
 Set tag=$get(topArg)
 Set tmpi=(($get(typeAttr)'="")&&(typeAttr'="BSTS.DtsDaoPort.getAllNamespaceQualifierTypes"))
 If $IsObject(namespaces) {
   ...
   If tag="" Set tag="getAllNamespaceQualifierTypes"
   ...
   If tag="" Set tag=typesPrefix_"getAllNamespaceQualifierTypes"
   Set xsitype=0
 }
 Set local=+$get(local),savelocal=local
 Set endprefix="</"_beginprefix,beginprefix="<"_beginprefix
 If tmpi Set temp=temp_" "_xsiPrefix_"type="""_typesPrefix_"getAllNamespaceQualifierTypes"""_xsiAttrs,xsiAttrs=""
...
zXMLGetSchemaImports(imports,classes)
 Quit ##class(%XML.Implementation).XMLGetSchemaImports("BSTS.DtsDaoPort.getAllNamespaceQualifierTypes",.imports,.classes)
...
zXMLImportInternal()
 ...
 If bareProjection Quit $$Error^%apiOBJ(6386,"BSTS.DtsDaoPort.getAllNamespaceQualifierTypes")
...
zXMLNew(document,node,containerOref="")
	Quit (##class(BSTS.DtsDaoPort.getAllNamespaceQualifierTypes).%New())
zXMLSchema(top="",format="",namespacePrefix="",input=0,refOnly=0,schema)
 Quit ##class(%XML.Implementation).XMLSchema("BSTS.DtsDaoPort.getAllNamespaceQualifierTypes",top,format,namespacePrefix,input,refOnly,.schema)
