 ;BSTS.DtsDaoPort.getConceptChildRoots.1
 ;(C)InterSystems, generated for class BSTS.DtsDaoPort.getConceptChildRoots.  Do NOT edit. 08/21/2017 07:46:12PM
 ;;70594856;BSTS.DtsDaoPort.getConceptChildRoots
 ;
...
%ValidateObject(force=0) public {
	...
	Quit sc }
zInvoke(%Client,%Action,attributeSetDescriptor,namespaceId) public {
 Set ..attributeSetDescriptor=$get(attributeSetDescriptor),..namespaceId=$get(namespaceId)
 Do %Client.InvokeClient($this,"getConceptChildRoots",%Action)
 Quit ..%Result }
zReset() public {
 Quit }
zXMLDTD(top,format,input,dtdlist)
 Quit ##class(%XML.Implementation).XMLDTD("BSTS.DtsDaoPort.getConceptChildRoots",.top,.format,.input,.dtdlist)
zXMLExportInternal()
 ...
 If group Quit $$Error^%apiOBJ(6386,"BSTS.DtsDaoPort.getConceptChildRoots")
 ...
 If 'nocycle {
   If $data(oreflist($this)) Quit $$Error^%apiOBJ(6296,"BSTS.DtsDaoPort.getConceptChildRoots")
   Set oreflist($this)=""
 }
 Set tag=$get(topArg)
 Set tmpi=(($get(typeAttr)'="")&&(typeAttr'="BSTS.DtsDaoPort.getConceptChildRoots"))
...
zXMLGetSchemaImports(imports,classes)
 Quit ##class(%XML.Implementation).XMLGetSchemaImports("BSTS.DtsDaoPort.getConceptChildRoots",.imports,.classes)
...
zXMLImportInternal()
 ...
 If bareProjection Quit $$Error^%apiOBJ(6386,"BSTS.DtsDaoPort.getConceptChildRoots")
...
zXMLNew(document,node,containerOref="")
	Quit (##class(BSTS.DtsDaoPort.getConceptChildRoots).%New())
zXMLSchema(top="",format="",namespacePrefix="",input=0,refOnly=0,schema)
 Quit ##class(%XML.Implementation).XMLSchema("BSTS.DtsDaoPort.getConceptChildRoots",top,format,namespacePrefix,input,refOnly,.schema)
