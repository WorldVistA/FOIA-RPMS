 ;BSTS.DtsQueryDaoPort.getNavParentContext.1
 ;(C)InterSystems, generated for class BSTS.DtsQueryDaoPort.getNavParentContext.  Do NOT edit. 08/21/2017 07:46:18PM
 ;;32525476;BSTS.DtsQueryDaoPort.getNavParentContext
 ;
...
exit	Quit sc }
zInvoke(%Client,%Action,focusConcept,focusConceptASD) public {
 Set ..focusConcept=$get(focusConcept),..focusConceptASD=$get(focusConceptASD)
...
zXMLDTD(top,format,input,dtdlist)
 Quit ##class(%XML.Implementation).XMLDTD("BSTS.DtsQueryDaoPort.getNavParentContext",.top,.format,.input,.dtdlist)
zXMLExportInternal()
 ...
 If group Quit $$Error^%apiOBJ(6386,"BSTS.DtsQueryDaoPort.getNavParentContext")
 ...
 If 'nocycle {
   If $data(oreflist($this)) Quit $$Error^%apiOBJ(6296,"BSTS.DtsQueryDaoPort.getNavParentContext")
   Set oreflist($this)=""
 }
 Set tag=$get(topArg)
 Set tmpi=(($get(typeAttr)'="")&&(typeAttr'="BSTS.DtsQueryDaoPort.getNavParentContext"))
...
zXMLGetSchemaImports(imports,classes)
 Quit ##class(%XML.Implementation).XMLGetSchemaImports("BSTS.DtsQueryDaoPort.getNavParentContext",.imports,.classes)
...
zXMLImportInternal()
 ...
 If bareProjection Quit $$Error^%apiOBJ(6386,"BSTS.DtsQueryDaoPort.getNavParentContext")
...
zXMLNew(document,node,containerOref="")
	Quit (##class(BSTS.DtsQueryDaoPort.getNavParentContext).%New())
zXMLSchema(top="",format="",namespacePrefix="",input=0,refOnly=0,schema)
 Quit ##class(%XML.Implementation).XMLSchema("BSTS.DtsQueryDaoPort.getNavParentContext",top,format,namespacePrefix,input,refOnly,.schema)
