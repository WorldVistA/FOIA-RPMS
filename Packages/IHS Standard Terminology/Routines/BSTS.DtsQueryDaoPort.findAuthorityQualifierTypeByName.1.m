 ;BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeByName.1
 ;(C)InterSystems, generated for class BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeByName.  Do NOT edit. 08/21/2017 07:46:15PM
 ;;77614F67;BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeByName
 ;
...
zXMLDTD(top,format,input,dtdlist)
 Quit ##class(%XML.Implementation).XMLDTD("BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeByName",.top,.format,.input,.dtdlist)
zXMLExportInternal()
 ...
 If group Quit $$Error^%apiOBJ(6386,"BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeByName")
 ...
 If 'nocycle {
   If $data(oreflist($this)) Quit $$Error^%apiOBJ(6296,"BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeByName")
   Set oreflist($this)=""
 }
 Set tag=$get(topArg)
 Set tmpi=(($get(typeAttr)'="")&&(typeAttr'="BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeByName"))
...
zXMLGetSchemaImports(imports,classes)
 Quit ##class(%XML.Implementation).XMLGetSchemaImports("BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeByName",.imports,.classes)
...
zXMLImportInternal()
 ...
 If bareProjection Quit $$Error^%apiOBJ(6386,"BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeByName")
...
zXMLNew(document,node,containerOref="")
	Quit (##class(BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeByName).%New())
zXMLSchema(top="",format="",namespacePrefix="",input=0,refOnly=0,schema)
 Quit ##class(%XML.Implementation).XMLSchema("BSTS.DtsQueryDaoPort.findAuthorityQualifierTypeByName",top,format,namespacePrefix,input,refOnly,.schema)
