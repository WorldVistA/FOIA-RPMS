 ;BSTS.DtsQueryDaoPort.findAuthorityPropertyTypeByName.1
 ;(C)InterSystems, generated for class BSTS.DtsQueryDaoPort.findAuthorityPropertyTypeByName.  Do NOT edit. 08/21/2017 07:46:15PM
 ;;6B534247;BSTS.DtsQueryDaoPort.findAuthorityPropertyTypeByName
 ;
...
zXMLDTD(top,format,input,dtdlist)
 Quit ##class(%XML.Implementation).XMLDTD("BSTS.DtsQueryDaoPort.findAuthorityPropertyTypeByName",.top,.format,.input,.dtdlist)
zXMLExportInternal()
 ...
 If group Quit $$Error^%apiOBJ(6386,"BSTS.DtsQueryDaoPort.findAuthorityPropertyTypeByName")
 ...
 If 'nocycle {
   If $data(oreflist($this)) Quit $$Error^%apiOBJ(6296,"BSTS.DtsQueryDaoPort.findAuthorityPropertyTypeByName")
   Set oreflist($this)=""
 }
 Set tag=$get(topArg)
 Set tmpi=(($get(typeAttr)'="")&&(typeAttr'="BSTS.DtsQueryDaoPort.findAuthorityPropertyTypeByName"))
...
zXMLGetSchemaImports(imports,classes)
 Quit ##class(%XML.Implementation).XMLGetSchemaImports("BSTS.DtsQueryDaoPort.findAuthorityPropertyTypeByName",.imports,.classes)
...
zXMLImportInternal()
 ...
 If bareProjection Quit $$Error^%apiOBJ(6386,"BSTS.DtsQueryDaoPort.findAuthorityPropertyTypeByName")
...
zXMLNew(document,node,containerOref="")
	Quit (##class(BSTS.DtsQueryDaoPort.findAuthorityPropertyTypeByName).%New())
zXMLSchema(top="",format="",namespacePrefix="",input=0,refOnly=0,schema)
 Quit ##class(%XML.Implementation).XMLSchema("BSTS.DtsQueryDaoPort.findAuthorityPropertyTypeByName",top,format,namespacePrefix,input,refOnly,.schema)
