 ;BSTS.DtsQueryDaoPort.getAssociationNavParentContext.1
 ;(C)InterSystems, generated for class BSTS.DtsQueryDaoPort.getAssociationNavParentContext.  Do NOT edit. 08/21/2017 07:46:17PM
 ;;456E5974;BSTS.DtsQueryDaoPort.getAssociationNavParentContext
 ;
...
exit	Quit sc }
zInvoke(%Client,%Action,focusConcept,focusConceptASD,associationType) public {
 Set ..focusConcept=$get(focusConcept),..focusConceptASD=$get(focusConceptASD),..associationType=$get(associationType)
...
zXMLDTD(top,format,input,dtdlist)
 Quit ##class(%XML.Implementation).XMLDTD("BSTS.DtsQueryDaoPort.getAssociationNavParentContext",.top,.format,.input,.dtdlist)
zXMLExportInternal()
 ...
 If group Quit $$Error^%apiOBJ(6386,"BSTS.DtsQueryDaoPort.getAssociationNavParentContext")
 ...
 If 'nocycle {
   If $data(oreflist($this)) Quit $$Error^%apiOBJ(6296,"BSTS.DtsQueryDaoPort.getAssociationNavParentContext")
   Set oreflist($this)=""
 }
 Set tag=$get(topArg)
 Set tmpi=(($get(typeAttr)'="")&&(typeAttr'="BSTS.DtsQueryDaoPort.getAssociationNavParentContext"))
...
zXMLGetSchemaImports(imports,classes)
 Quit ##class(%XML.Implementation).XMLGetSchemaImports("BSTS.DtsQueryDaoPort.getAssociationNavParentContext",.imports,.classes)
...
zXMLImportInternal()
 ...
 If bareProjection Quit $$Error^%apiOBJ(6386,"BSTS.DtsQueryDaoPort.getAssociationNavParentContext")
...
zXMLNew(document,node,containerOref="")
	Quit (##class(BSTS.DtsQueryDaoPort.getAssociationNavParentContext).%New())
zXMLSchema(top="",format="",namespacePrefix="",input=0,refOnly=0,schema)
 Quit ##class(%XML.Implementation).XMLSchema("BSTS.DtsQueryDaoPort.getAssociationNavParentContext",top,format,namespacePrefix,input,refOnly,.schema)
