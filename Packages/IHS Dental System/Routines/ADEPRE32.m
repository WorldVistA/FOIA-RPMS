ADEPRE32 ; IHS/OIT/GAB - ADE6.0 PATCH 32 ENVIRONMENT CHECK [ 10/12/2017 13:42 PM ]
 ;;6.0;ADE*6.0*32;;March 25, 1999;Build 42
 ;IHS/OIT/GAB 10/2017 Patch 32 ADA-CDT code updates for 2018
 ;
 S X="ADEPRE31" X ^%ZOSF("TEST")
 I '$T S ADEMSG="Dental ADE v6.0 Patch 'ade_0600.31k' MUST be installed!" D GETUP(ADEMSG,1)
