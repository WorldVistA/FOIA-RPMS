ADEPRE33 ; IHS/OIT/GAB - ADE6.0 PATCH 33 ENVIRONMENT CHECK [ 10/12/2018 13:42 PM ]
 ;;6.0;ADE*6.0*33;;March 25, 1999;Build 53
 ;IHS/OIT/GAB 10/2013 Patch 33 ADA-CDT code updates for 2019
 ;
 S X="ADEPRE33" X ^%ZOSF("TEST")
 I '$T S ADEMSG="Dental ADE v6.0 Patch 'ade_0600.32k' MUST be installed!" D GETUP(ADEMSG,1)
