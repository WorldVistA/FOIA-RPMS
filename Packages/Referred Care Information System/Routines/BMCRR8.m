BMCRR8 ; IHS/PHXAO/TMJ - list patients for which medical and/or cost data has not been received ;
 ...
 ;
START ;
 ;BMC*4.0*9 REMOVED REF TO ICD9
 W:$D(IOF) @IOF W !!,"This report will list potentially high cost cases.  To determine whether a ",!,"case is potentially high cost, a taxonomy of ICD Diagnosis codes is used."
...
BD ;get beginning date
 ...
 K DIR
ED ;get ending date
 ;BMC*4.0*8 REMOVED "P" FR DIR PAR
 W ! S DIR(0)="D^"_BMCBD_"::E",DIR("A")="Enter ending Referral Date"  D ^DIR K DIR S:$D(DUOUT) DIRUT=1
 I $D(DIRUT) G BD
 S BMCED=Y
