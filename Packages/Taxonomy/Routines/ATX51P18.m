ATX51P18 ; IHS/CMI/LAB - PCC Suite v5.1 patch 18 environment check 
 ;;5.1;TAXONOMY;**18**;FEB 04, 1997;Build 31
 ;
 ;
 ...
 I '$$INSTALLD("ATX*5.1*17") D SORRY(2)
...
PRE ;
 Q
POST ;
 S DA=$O(^ATXAX("B","APCL DIABETES REG NEW CASE",0))
 I DA S DIE="^ATXAX(",DR=".23///1" D ^DIE K DA,DIE,DR
 Q
