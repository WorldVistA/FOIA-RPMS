ATX51P24 ; IHS/CMI/LAB - PCC Suite v5.1 patch 24 environment check ;
 ...
 I '$$INSTALLD("ATX*5.1*23") D SORRY(2)
 I +$$VERSION^XPDUTL("AUM")<18 D MES^XPDUTL($$CJ^XLFSTR("Version 18.0 of AUM is required.  Not installed",80)) D SORRY(2) I 1
 E  D MES^XPDUTL($$CJ^XLFSTR("Requires AUM V18.0....Present.",80))
 ;
 Q
 ;
PRE ;
